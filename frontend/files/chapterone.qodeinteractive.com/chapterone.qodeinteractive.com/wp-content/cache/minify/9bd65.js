...
! function(e, t) {
    ...
    e.fn.extend({
        ...
        getRSVersion: function(e) {
            var t, i, r = window.SliderRevolutionVersion;
            if (!e) {
        ...
        revremoveslide: function(t) {
            return this.each(function() {
                var r = this.id;
                if (!(t < 0 || t > i[r].slideamount) && i[r] && i[r].slides.length > 0 && (t > 0 || t <= i[r].slides.length)) {
                    var a = i.gA(i[r].slides[t], "key");
                    i[r].slideamount = i[r].slideamount - 1, i[r].realslideamount = i[r].realslideamount - 1, s("rs-bullet", a, r), s("rs-tab", a, r), s("rs-thumb", a, r), e(i[r].slides[t]).remove(), i[r].slides = o(i[r].slides, t), i[r].carousel && i[r].carousel.slides && (i[r].carousel.slides = o(i[r].carousel.slides, t)), i[r].thumbs = o(i[r].thumbs, t), i.updateNavIndexes && i.updateNavIndexes(r), t <= i[r].pr_active_key && (i[r].pr_active_key = i[r].pr_active_key - 1)
                }
            })
        },
        ...
        revkill: function() {
            return this.each(function() {
                var r = this.id;
                punchgs.TweenMax.killDelayedCallsTo(i.showHideNavElements), i[r].c.data("conthover", 1), i[r].c.data("conthoverchanged", 1), i[r].c.trigger("revolution.slide.onpause");
                var a = i[r].cpar.find("rs-progress");
                i[r].c[0].opt;
                i[r].tonpause = !0, i[r].c.trigger("stoptimer"), i[r].sliderisrunning = !1;
                var o = "resize.revslider-" + i[r].c.attr("id");
                e(window).unbind(o), punchgs.TweenMax.killTweensOf(i[r].c.find("*"), !1), punchgs.TweenMax.killTweensOf(i[r].c, !1), i[r].c.unbind("hover, mouseover, mouseenter,mouseleave, resize"), o = "resize.revslider-" + i[r].c.attr("id"), e(window).off(o), i[r].c.find("*").each(function() {
                    var i = e(this);
                    i.unbind("on, hover, mouseenter,mouseleave,mouseover, resize,restarttimer, stoptimer"), i.off("on, hover, mouseenter,mouseleave,mouseover, resize"), i.data("mySplitText", null), i.data("ctl", null), i.data("tween") != t && i.data("tween").kill(), i.data("pztl") != t && i.data("pztl").kill(), i.data("timeline_out") != t && i.data("timeline_out").kill(), i.data("timeline") != t && i.data("timeline").kill(), i.remove(), i.empty(), i = null
                }), punchgs.TweenMax.killTweensOf(i[r].c.find("*"), !1), punchgs.TweenMax.killTweensOf(i[r].c, !1), a.remove();
                try {
                    i[r].c.closest("rs-fullwidth-wrap").remove()
                } catch (e) {}
                try {
                    i[r].c.closest("rs-module-wrap").remove()
                } catch (e) {}
                try {
                    i[r].c.remove()
                } catch (e) {}
                i[r].c.empty(), i[r].c.html(), i[r].c = null
            })
        },
        revpause: function() {
            return this.each(function() {
                var r = e(this);
                r != t && r.length > 0 && e("body").find("#" + r.attr("id")).length > 0 && (r.data("conthover", 1), r.data("conthoverchanged", 1), r.trigger("revolution.slide.onpause"), i[this.id].tonpause = !0, r.trigger("stoptimer"))
            })
        },
        revresume: function() {
            return this.each(function() {
                if (i[this.id] !== t) {
                    var r = e(this);
                    r.data("conthover", 0), r.data("conthoverchanged", 1), r.trigger("revolution.slide.onresume"), i[this.id].tonpause = !1, r.trigger("starttimer")
                }
            })
        },
        revmodal: function(r) {
            var a = this instanceof e ? this[0] : this,
                o = a.id;
            i[a.id] !== t && i.revModal(o, r)
        },
        revstart: function() {
            var r = this instanceof e ? this[0] : this;
            return i[r.id] === t ? (console.log("Slider is Not Existing"), !1) : i[r.id].sliderisrunning ? (console.log("Slider Is Running Already"), !1) : (i[r.id].c = e(r), i[r.id].canvas = i[r.id].c.find("rs-slides"), h(r.id), !0)
        },
        revnext: function() {
            return this.each(function() {
        ...
        gA: function(e, i, r) {
            return e.hasAttribute && e.hasAttribute("data-" + i) && e.getAttribute("data-" + i) !== t && null !== e.getAttribute("data-" + i) ? e.getAttribute("data-" + i) : r !== t ? r : t
        },
        ...
        revModal: function(r, a) {
            if (r !== t && i[r] !== t) switch (a.mode) {
                case "show":
                    a.slide = a.slide === t ? "to0" : a.slide, i[r].modal.bodyclass !== t && i[r].modal.bodyclass.length >= 0 && document.body.classList.add(i[r].modal.bodyclass), punchgs.TweenMax.to(i[r].modal.bg, 2, {
                        display: "block",
                        opacity: 1,
                        ease: punchgs.Power3.easeInOut
                    }), punchgs.TweenMax.set(i[r].modal.c, {
                        display: "auto" === i[r].sliderLayout ? "inline-block" : "block",
                        opacity: 0
                    }), punchgs.TweenMax.set(i[r].cpar, {
                        display: "block",
                        opacity: 1
                    }), punchgs.TweenMax.fromTo([i[r].modal.c], .01, {
                        opacity: 0
                    }, {
                        opacity: 1,
                        ease: punchgs.Power3.easeInOut,
                        onComplete: function() {
                            i[r].sliderisrunning ? i.callingNewSlide(r, a.slide) : ("to0" !== a.slide && (i[r].startWithSlideKey = a.slide), h(r))
                        }
                    }), window.overscrollhistory = document.body.style.overflow, document.body.style.overflow = "hidden";
                    break;
                case "close":
                    O(r), document.body.style.overflow = window.overscrollhistory, i[r].modal.bodyclass !== t && i[r].modal.bodyclass.length >= 0 && document.body.classList.remove(i[r].modal.bodyclass), punchgs.TweenMax.to(i[r].modal.bg, 2, {
                        display: "none",
                        opacity: 0,
                        ease: punchgs.Power3.easeInOut
                    }), punchgs.TweenMax.to(i[r].modal.c, .3, {
                        display: "none",
                        delay: .5,
                        opacity: 0,
                        onComplete: function() {
                    ...
                    break;
                case "init":
                    if (window.RS_60_MODALS = window.RS_60_MODALS === t ? [] : window.RS_60_MODALS, -1 === e.inArray(i[r].modal.alias, window.RS_60_MODALS) && window.RS_60_MODALS.push(i[r].modal.alias), i[r].modal.listener === t) {
                        i[r].modal.c = e("#" + r + "_modal"), i[r].modal.bg = e('<rs-modal-cover data-rid="' + r + '" id="' + r + '_modal_bg"></rs-modal-cover>'), "auto" === i[r].sliderLayout && i[r].modal.cover ? e("body").append(i[r].modal.bg) : i[r].modal.c.append(i[r].modal.bg), i[r].modal.c[0].className += "rs-modal-" + i[r].sliderLayout;
                        var o = {
                            left: "auto" === i[r].sliderLayout ? "center" === i[r].modal.horizontal ? "50%" : "left" === i[r].modal.horizontal ? "0px" : "auto" : "0px",
                            right: "auto" === i[r].sliderLayout ? "center" === i[r].modal.horizontal ? "auto" : "left" === i[r].modal.horizontal ? "auto" : "0px" : "0px",
                            top: "auto" === i[r].sliderLayout || "fullwidth" === i[r].sliderLayout ? "middle" === i[r].modal.vertical ? "50%" : "top" === i[r].modal.vertical ? "0px" : "auto" : "0px",
                            bottom: "auto" === i[r].sliderLayout || "fullwidth" === i[r].sliderLayout ? "middle" === i[r].modal.vertical ? "auto" : "top" === i[r].modal.vertical ? "auto" : "0px" : "0px",
                            y: ("auto" === i[r].sliderLayout || "fullwidth" === i[r].sliderLayout) && "middle" === i[r].modal.vertical ? "-50%" : 0,
                            x: "auto" === i[r].sliderLayout && "center" === i[r].modal.horizontal ? "-50%" : 0
                        };
                        punchgs.TweenMax.set(i[r].modal.c, "auto" === i[r].sliderLayout || "fullscreen" === i[r].sliderLayout ? e.extend(!0, o, {
                            opacity: 0,
                            display: "none"
                        }) : {
                            opacity: 0,
                            display: "none"
                        }), "fullwidth" === i[r].sliderLayout && punchgs.TweenMax.set(i[r].modal.c.find("rs-module-wrap"), o), !1 !== i[r].modal.cover && "false" !== i[r].modal.cover || (i[r].modal.coverColor = "transparent"), punchgs.TweenMax.set(i[r].modal.bg, {
                            display: "none",
                            background: i[r].modal.coverColor,
                            opacity: 0
                        }), e(document).on("RS_OPENMODAL_" + i[r].modal.alias, function(e, t) {
                            i.revModal(r, {
                                mode: "show",
                                slide: t
                            })
        ...
        smartConvertDivs: function(e) {
            ...
            if ("string" == typeof e && e.indexOf("#") >= 0) {
                var i = e.split(","),
                    r = i.length - 1;
                for (var a in i) t = "string" == typeof i[a] && "#" === i[a][0] ? t + i[a][1] / i[a][3] * 100 + "%" + (a < r ? "," : "") : t + i[a] + (a < r ? "," : "")
            } else t = e;
            return t
        },
        revToResp: function(e, i, r, a) {
            if ((e = e === t ? r : e) !== t) {
                if (a = a === t ? "," : a, "boolean" != typeof e && ("object" != typeof e || Array.isArray(e))) {
                    try {
        ...
        updateVisibleArea: function(r) {
            for (var a in i[r].viewPort.visible_area = i.revToResp(i[r].viewPort.visible_area, i[r].rle, "200px"), i[r].viewPort.vaType = new Array(4), i[r].viewPort.visible_area) i[r].viewPort.visible_area.hasOwnProperty(a) && (e.isNumeric(i[r].viewPort.visible_area[a]) && (i[r].viewPort.visible_area[a] += "%"), i[r].viewPort.visible_area[a] !== t && (i[r].viewPort.vaType[a] = i[r].viewPort.visible_area[a].indexOf("%") >= 0 ? "%" : "px"), i[r].viewPort.visible_area[a] = parseInt(i[r].viewPort.visible_area[a], 0), i[r].viewPort.visible_area[a] = "%" == i[r].viewPort.vaType[a] ? i[r].viewPort.visible_area[a] / 100 : i[r].viewPort.visible_area[a])
        },
        ...
        simp: function(e, t, i) {
            var r = Math.abs(e) - Math.floor(Math.abs(e / t)) * t;
            return i ? r : e < 0 ? -1 * r : r
        },
        iOSVersion: function() {
        ...
        isIE: function(t, i) {
            ...
            r.html("\x3c!--[if " + (i || "") + " IE " + (t || "") + "]><a>&nbsp;</a><![endif]--\x3e");
            var a = r.find("a").length;
            return r.remove(), a
        },
        is_mobile: function() {
        ...
        callBackHandling: function(t, r, a) {
            i[t].callBackArray && e.each(i[t].callBackArray, function(e, t) {
                t && t.inmodule && t.inmodule === r && t.atposition && t.atposition === a && t.callback && t.callback.call()
            })
        },
        ...
        get_browser_version: function() {
            var e, t = navigator.appName,
                ...
                r = i.match(/(edge|opera|chrome|safari|firefox|msie)\/?\s*(\.?\d+(\.\d+)*)/i);
            return r && null != (e = i.match(/version\/([\.\d]+)/i)) && (r[2] = e[1]), (r = r ? [r[1], r[2]] : [t, navigator.appVersion, "-?"])[1]
        },
        ...
        getHorizontalOffset: function(e, t) {
            var i = d(e, ".outer-left"),
                r = d(e, ".outer-right");
            return "left" == t ? i : "right" == t ? r : i + r
        },
        getComingSlide: function(r, a) {
            var o = i[r].pr_next_key !== t ? i[r].pr_next_key : i[r].pr_processing_key !== t ? i[r].pr_processing_key : i[r].pr_active_key,
                s = 0;
            if (s = 0, i[r].pr_active_slide !== t && i[r].pr_active_slide.hasClass("not-in-nav") && (o = i[r].pr_lastshown_key), a !== t && e.isNumeric(a) || a !== t && a.match(/to/g)) s = 1 === a || -1 === a ? parseInt(o, 0) + a < 0 ? i[r].slideamount - 1 : parseInt(o, 0) + a >= i[r].slideamount ? 0 : parseInt(o, 0) + a : (a = e.isNumeric(a) ? a : parseInt(a.split("to")[1], 0)) < 0 ? 0 : a > i[r].slideamount - 1 ? i[r].slideamount - 1 : a;
            else if (a)
                for (var n in i[r].slides) i[r].slides.hasOwnProperty(n) && (s = i[r].slides && i[r].slides[n] && i.gA(i[r].slides[n], "key") === a ? n : s);
            return {
                nindex: s,
                aindex: o
            }
        ...
        callingNewSlide: function(e, t, r) {
            var a = i.getComingSlide(e, t);
            i[e].pr_next_key = a.nindex, i[e].sdir = i[e].pr_next_key < i[e].pr_active_key ? 1 : 0, i[e].ctNavElement ? i[e].ctNavElement = !1 : i[e].c.trigger("revolution.nextslide.waiting"), (a.aindex === i[e].pr_next_key && a.aindex === i[e].pr_lastshown_key || i[e].pr_next_key !== a.aindex && -1 != i[e].pr_next_key) && C(e, r)
        },
        ...
        setSize: function(r, a) {
            var o, s = parseInt(i[r].top_outer || 0) + parseInt(i[r].bottom_outer || 0),
                n = "carousel" == i[r].sliderType ? parseInt(i[r].carousel.padding_top || 0, 0) : 0,
                l = "carousel" == i[r].sliderType ? parseInt(i[r].carousel.padding_bottom || 0, 0) : 0,
                d = 0,
                c = 0,
                p = 0,
                u = i[r].pr_processing_key || i[r].pr_active_key || 0,
                h = i[r].pr_active_key || 0;
            if (i[r].minHeight = i[r].minHeight === t ? 0 : i[r].minHeight || 0, i[r].paddings = i[r].paddings === t ? {
                    top: parseInt(i[r].cpar.css("paddingTop"), 0) || 0,
                    bottom: parseInt(i[r].cpar.css("paddingBottom"), 0) || 0
                } : i[r].paddings, i[r].rowzones && i[r].rowzones.length > 0) {
                if (i[r].rowzones[u] !== t)
                    for (o = 0; o < i[r].rowzones[u].length; o++) d += i[r].rowzones[u][o][0].offsetHeight;
                if (h !== u)
                    for (o = 0; o < i[r].rowzones[h].length; o++) c += i[r].rowzones[h][o][0].offsetHeight
            }
            if (i[r].srowzones && i[r].srowzones.length > 0)
                for (o = 0; o < i[r].srowzones.length; o++) p += i[r].srowzones[o][0].offsetHeight;
            d = d < p ? p : d;
            var g = Math.max(Math.max(i[r].minHeight, i[r].gridheight[i[r].level]), d);
            if (g = 0 !== i[r].maxHeight ? Math.min(i[r].maxHeight, g) : g, "fullwidth" != i[r].sliderLayout || i[r].autoHeight || punchgs.TweenMax.set(i[r].c, {
                    maxHeight: g + "px"
                }), i[r].c.css({
                    marginTop: n,
                    marginBottom: l
                }), i[r].width = i[r].canvas.width(), i[r].height = i[r].canvas.height(), "fullscreen" == i[r].sliderLayout || i[r].infullscreenmode) {
                var f = e(window).height();
                if (i[r].fullScreenOffsetContainer != t) {
                    var m = ("" + i[r].fullScreenOffsetContainer).split(",");
                    for (var v in m) m.hasOwnProperty(v) && (f -= e(m[v]).outerHeight(!0) || 0)
                }
                i[r].fullScreenOffset != t && !e.isNumeric(i[r].fullScreenOffset) && i[r].fullScreenOffset.split("%").length > 1 ? f -= e(window).height() * parseInt(i[r].fullScreenOffset, 0) / 100 : i[r].fullScreenOffset != t && i[r].fullScreenOffset.length > 0 && e.isNumeric(parseInt(i[r].fullScreenOffset, 0)) && (f -= parseInt(i[r].fullScreenOffset, 0)), i[r].height = Math.max(d, Math.max(f - s, i[r].minHeight)), h !== u && (i[r].currentSlideHeight = Math.max(c, Math.max(f - s, i[r].minHeight)), i[r].slides[h].style.maxHeight = i[r].currentSlideHeight !== i[r].height ? i[r].currentSlideHeight + "px" : "none"), i[r].cpar.height(i[r].height), i[r].c.css({
                    height: "100%"
                })
            } else i[r].height = Math.round(i[r].gridheight[i[r].level] * (i[r].keepBPHeight ? 1 : i[r].width / i[r].gridwidth[i[r].level])), i[r].height = Math.max(d, Math.max(i[r].autoHeight ? i[r].height : Math.min(i[r].height, i[r].gridheight[i[r].level]), i[r].minHeight)), !1 !== a && i[r].c.height(i[r].height);
            var b = n + l + s + i[r].height + i[r].paddings.top + i[r].paddings.bottom,
                w = {
                    height: b
                };
            if (!1 !== a && (i[r].c.closest("rs-fullwidth-wrap").find("rs-fw-forcer").css(w), i[r].c.closest("rs-module-wrap").css(w)), i[r].sbtimeline.set && i[r].sbtimeline.fixed && (i[r].curheight = b, i[r].sbtimeline.extended === t && i.updateFixedScrollTimes(r), punchgs.TweenMax.set(i[r].forcer, {
                    height: 2 * b + i[r].sbtimeline.extended
                })), i[r].middleZones && i[r].middleZones.length > 0 && i[r].middleZones[u] !== t)
                for (o = 0; o < i[r].middleZones[u].length; o++) i[r].middleZones[u][o].style.top = Math.round(b / 2 - i[r].middleZones[u][o].offsetHeight / 2) + "px";
            if (i[r].smiddleZones && i[r].smiddleZones.length > 0)
                for (o = 0; o < i[r].smiddleZones.length; o++) i[r].smiddleZones[o].style.top = Math.round(b / 2 - i[r].smiddleZones[o].offsetHeight / 2) + "px";
            y(r)
        },
        enterInViewPort: function(r) {
            i[r].waitForCountDown && (Q(r), i[r].waitForCountDown = !1), i[r].waitForFirstSlide && (C(r), i[r].waitForFirstSlide = !1, setTimeout(function() {
                i[r].c.removeClass("tp-waitforfirststart")
            }, 500)), "playing" != i[r].sliderlaststatus && i[r].sliderlaststatus != t || i[r].c.trigger("starttimer"), i[r].lastplayedvideos != t && i[r].lastplayedvideos.length > 0 && e.each(i[r].lastplayedvideos, function(e, t) {
                i.playVideo(t, r)
            })
        },
        leaveViewPort: function(r) {
            i[r].sliderlaststatus = i[r].sliderstatus, i[r].c.trigger("stoptimer"), i[r].playingvideos != t && i[r].playingvideos.length > 0 && (i[r].lastplayedvideos = e.extend(!0, [], i[r].playingvideos), i[r].playingvideos && e.each(i[r].playingvideos, function(e, t) {
                i[r].leaveViewPortBasedStop = !0, i.stopVideo && i.stopVideo(t, r)
            }))
        },
        ...
        swaptoggleState: function(e) {
            if (e != t && e.length > 0)
                for (var r = 0; r < e.length; r++) {
                    var a = document.getElementById(e[r]);
                    if (i.gA(a, "toggletimestamp") !== t && (new Date).getTime() - i.gA(a, "toggletimestamp") < 250) return;
                    i.sA(a, "toggletimestamp", (new Date).getTime()), null !== a && (a.className.indexOf("rs-tc-active") >= 0 ? a.classList.remove("rs-tc-active") : a.classList.add("rs-tc-active"))
                }
        },
        lastToggleState: function(e) {
            ...
            if (e !== t)
                for (var r = 0; r < e.length; r++) {
                    var a = document.getElementById(e[r]);
                    i = !0 === i || null !== a && a.className.indexOf("rs-tc-active") >= 0 || i
                }
            return i
        },
        revCheckIDS: function(r, a) {
            if (i.gA(a, "idcheck") === t) {
                for (; - 1 != e.inArray(a.id, i[r].anyid);) console.log("Warning !! Double Id in Slider " + r + ": " + a.id), a.id = a.id + "_" + Math.round(9999 * Math.random());
                i[r].anyid.push(a.id)
            }
            i.sA(a, "idcheck", !0)
        }
    ...
    var r = i.is_mobile(),
        a = (i.is_android(), function(e) {
            ...
            var r = Math.max(i[e].minHeight, i[e].gridheight[i[e].level] * i[e].bw);
            i[e].editorheight !== t && (r = Math.max(r, i[e].editorheight[i[e].level] * i[e].bw)), punchgs.TweenMax.set(i[e].c, {
                height: r
            })
        }),
        o = function(t, i) {
        ...
        s = function(t, r, a) {
            i[a].c.find(t).each(function() {
                var t = e(this);
                t.data("key") === r && t.remove()
            })
        },
        n = function(e) {
        ...
        l = function(t, r) {
            var a = 9999,
                ...
                s = 0,
                n = e(window).width(),
                l = r && 9999 == i[t].responsiveLevels ? i[t].visibilityLevels : i[t].responsiveLevels;
            l && l.length && e.each(l, function(e, r) {
                n < r && (0 == o || o > parseInt(r)) && (a = parseInt(r), i[t].level = e, o = parseInt(r)), n > r && o < r && (o = parseInt(r), s = e)
            }), o < a && (i[t].level = s), i[t].levelForced = i[t].level
        },
        d = function(t, i) {
            var r = 0;
        ...
        c = function(a) {
            ...
            var o = e.fn.jquery.split("."),
                s = parseFloat(o[0]),
                n = parseFloat(o[1]);
            1 == s && n < 7 && i[a].c.html('<div style="text-align:center; padding:40px 0px; font-size:20px; color:#992222;"> The Current Version of jQuery:' + o + " <br>Please update your jQuery Version to min. 1.7 in Case you wish to use the Revolution Slider Plugin</div>"), s > 1 && (window._rs_ie = !1), i[a].cpar !== t && i[a].cpar.data("aimg") != t && ("enabled" == i[a].cpar.data("aie8") && i.isIE(8) || "enabled" == i[a].cpar.data("amobile") && r) && i[a].c.html('<img class="tp-slider-alternative-image" src="' + i[a].cpar.data("aimg") + '">'), i[a].realslideamount = i[a].slideamount = 0;
            var l = i[a].canvas[0].getElementsByTagName("rs-slide");
            for (var d in l) l.hasOwnProperty(d) && ("on" == i.gA(l[d], "hsom") && r ? l[d].classList.add("removeslidenow") : (i.gA(l[d], "invisible") || 1 == i.gA(l[d], "invisible") ? l[d].classList.add("not-in-nav") : i[a].slideamount++, i[a].realslideamount++, i.sA(l[d], "originalindex", i[a].realslideamount), i.sA(l[d], "origindex", i[a].realslideamount - 1)));
            i[a].canvas.find(".removeslidenow").each(function() {
                e(this).remove()
            }), i[a].canvas.find(".not-in-nav").each(function() {
                e(this).appendTo(i[a].canvas)
            }), i[a].canvas.css({
                visibility: "visible"
            }), i[a].slayers = i[a].c.find("rs-static-layers"), i[a].slayers.length > 0 && i.sA(i[a].slayers[0], "key", "staticlayers"), !0 === i[a].modal.useAsModal && (i[a].cpar.wrap('<rs-modal id="' + i[a].c[0].id + '_modal"></rs-modal>'), i[a].modal.c = i[a].cpar.closest("rs-modal"), i[a].modal.c.appendTo(e("body")), i[a].modal !== t && i[a].modal.alias !== t && i.revModal(a, {
                mode: "init"
            })), 1 != i[a].waitForInit && 1 != i[a].modal.useAsModal && h(a)
        },
        p = function() {
        ...
        u = function(e, r, a) {
            return i.gA(e, "lazyload") !== t ? i.gA(e, "lazyload") : i[a].lazyloaddata !== t && i[a].lazyloaddata.length > 0 && i.gA(e, i[a].lazyloaddata) !== t ? i.gA(e, i[a].lazyloaddata) : i.gA(e, "lazy-src") !== t ? i.gA(e, "lazy-src") : i.gA(e, "lazy-wpfc-original-src") !== t ? i.gA(e, "lazy-wpfc-original-src") : i.gA(e, "lazy") !== t ? i.gA(e, "lazy") : r
        },
        h = function(a) {
            if (i[a] !== t) {
                if (i[a].sliderisrunning = !0, e(document).on("revolution.all.resize", function() {
                        i[a].sliderisrunning && m(a)
                    }), i[a].shuffle) {
                    for (var o = i[a].canvas.find("rs-slide:first-child"), s = i.gA(o[0], "firstanim"), n = 0; n < i[a].slideamount; n++) i[a].canvas.find("rs-slide:eq(" + Math.round(Math.random() * i[a].slideamount) + ")").prependTo(i[a].canvas);
                    i.sA(i[a].canvas.find("rs-slide:first-child")[0], "firstanim", s)
                }
                for (var d in i[a].slides = i[a].canvas[0].getElementsByTagName("rs-slide"), i[a].thumbs = new Array(i[a].slides.length), i[a].slots = 4, i[a].firststart = 1, i[a].loadqueue = [], i[a].syncload = 0, i.updateDimensions(a), i[a].slides)
                    if (i[a].slides.hasOwnProperty(d) && "length" !== d) {
                        var c = i[a].slides[d],
                        ...
                        var v = {
                            params: Array(12),
                            id: i.gA(c, "key"),
                            src: i.gA(c, "thumb") !== t ? i.gA(c, "thumb") : u(h, h.src, a)
                        };
                        ...
                        if (i[a].thumbs[d] = v, i.gA(c, "link") != t || i.gA(c, "linktoslide") !== t) {
                            var w = i.gA(c, "link") !== t ? i.gA(c, "link") : "slide",
                                _ = "slide" != w ? "no" : i.gA(c, "linktoslide"),
                                x = i.gA(c, "seoz");
                            if (_ != t && "no" != _ && "next" != _ && "prev" != _)
                                for (var k in i[a].slides) i[a].slides.hasOwnProperty(k) && parseInt(i.gA(i[a].slides[k], "origindex"), 0) + 1 == i.gA(c, "linktoslide") && (_ = i.gA(i[a].slides[k], "key"));
                ...
                if (i[a].simplifyAll && (i.isIE(8) || i.iOSVersion()) && (i[a].c.find(".rs-layer").each(function() {
                        var t = e(this);
                        t.removeClass("customin customout").addClass("fadein fadeout"), t.data("splitin", ""), t.data("speed", 400)
                    }), i[a].slides.each(function() {
                        var t = e(this);
                        t.data("transition", "fade"), t.data("masterspeed", 500), t.data("slotamount", 1), (t.find(".rev-slidebg") || t.find(">img").first()).data("panzoom", null)
                    })), window._rs_desktop = window._rs_desktop === t ? !navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|mobi|tablet|opera mini|nexus 7)/i) : window._rs_desktop, i[a].autoHeight = "fullscreen" == i[a].sliderLayout || i[a].autoHeight, "fullwidth" != i[a].sliderLayout || i[a].autoHeight || i[a].c.css({
                        maxHeight: i[a].gridheight[i[a].level] + "px"
                    }), "auto" == i[a].sliderLayout || 0 != i[a].c.closest("rs-fullwidth-wrap").length || "fullscreen" === i[a].sliderLayout && 1 == i[a].disableForceFullWidth) i[a].topc = i[a].cpar;
                else {
                    var T = i[a].cpar[0].style.marginTop,
                        L = i[a].cpar[0].style.marginBottom;
                    T = T === t || "" === T ? "" : "margin-top:" + T + ";", L = L === t || "" === L ? "" : "margin-bottom:" + L + ";", i[a].topc = e('<rs-fullwidth-wrap id="' + i[a].c[0].id + '_forcefullwidth" style="' + T + L + '"></rs-fullwidth-wrap>'), i[a].forcer = e('<rs-fw-forcer style="height:' + i[a].cpar.height() + 'px"></rs-fw-forcer>'), i[a].topc.append(i[a].forcer), i[a].topc.insertBefore(i[a].cpar), i[a].cpar.detach(), i[a].cpar.css({
                        marginTop: "0px",
                        marginBottom: "0px",
                        position: "absolute"
                    }), i[a].cpar.prependTo(i[a].topc)
                }
                if (i[a].forceOverflow && i[a].topc[0].classList.add("rs-forceoverflow"), "carousel" === i[a].sliderType && i[a].c.css({
                        overflow: "visible"
                    }), 0 !== i[a].maxHeight && punchgs.TweenMax.set([i[a].cpar, i[a].c, i[a].topc], {
                        maxHeight: i[a].maxHeight + "px"
                    }), i[a].fixedOnTop && punchgs.TweenMax.set(i[a].topc, {
                        position: "fixed",
                        top: "0px",
                        left: "0px",
                        pointerEvents: "none",
                        zIndex: 5e3
                    }), i[a].shadow !== t && i[a].shadow > 0 && i[a].cpar.addClass("tp-shadow" + i[a].shadow).append('<div class="tp-shadowcover" style="background-color:' + i[a].cpar.css("backgroundColor") + ";background-image:" + i[a].cpar.css("backgroundImage") + '"></div>'), l(a), !i[a].c.hasClass("revslider-initialised")) {
                    i[a].c[0].classList.add("revslider-initialised"), i[a].c[0].id = i[a].c[0].id === t ? "revslider-" + Math.round(1e3 * Math.random() + 5) : i[a].c[0].id, i.revCheckIDS(a, i[a].c[0]), i[a].origcd = parseInt(i[a].duration, 0), i[a].scrolleffect._L = [], i[a].sbas = i[a].sbas === t ? {} : i[a].sbas, i[a].layers = i[a].layers || {}, i[a].sortedLayers = i[a].sortedLayers || {}, i[a].c.detach(), i[a].c.find("rs-layer, rs-row, rs-column, rs-group,  rs-bgvideo, .rs-layer").each(function() {
                        var r, o, s = e(this),
                            n = s.data();
                        if (n.startclasses = this.className, n.startclasses = n.startclasses === t || null === n.startclasses ? "" : n.startclasses, n.animationonscroll = !!i[a].sbtimeline.set && i[a].sbtimeline.layers, n.animationonscroll = !0 === n.animationonscroll || "true" == n.animationonscroll, n.filteronscroll = !!i[a].scrolleffect.set && i[a].scrolleffect.layers, n.pxundermask = n.startclasses.indexOf("rs-pxmask") >= 0 && "off" !== i[a].parallax.type && n.startclasses.indexOf("rs-pxl-") >= 0, n.noPevents = n.startclasses.indexOf("rs-noevents") >= 0, n.sba)
                            for (var l in r = n.sba.split(";")) r.hasOwnProperty(l) && ("t" == (o = r[l].split(":"))[0] && (n.animationonscroll = o[1], "false" == o[1] && (n.animOnScrollForceDisable = !0)), "e" == o[0] && (n.filteronscroll = o[1]), "so" == o[0] && (n.scrollBasedOffset = parseInt(o[1]) / 1e3));
                        if ("true" != n.animationonscroll && 1 != n.animationonscroll || (n.startclasses += " rs-sba", s[0].className += " rs-sba"), n.startclasses.indexOf("rs-layer-static") >= 0 && i.handleStaticLayers && i.handleStaticLayers(s, a), "RS-BGVIDEO" !== s[0].tagName) {
                            if (s[0].classList.add("rs-layer"), "column" === n.type && (n.columnwidth = "33.33%", n.verticalalign = "top", n.column !== t))
                                for (var d in r = n.column.split(";")) r.hasOwnProperty(d) && ("w" === (o = r[d].split(":"))[0] && (n.columnwidth = o[1]), "a" === o[0] && (n.verticalalign = o[1]));
                            ...
                            s.wrap("<" + g + " " + m + ' class="rs-parallax-wrap ' + h + '" style="' + p + " " + c + u + f + v + '"><rs-loop-wrap style="' + c + u + f + '"><rs-mask-wrap style="' + c + u + f + '">' + (n.pxundermask ? "<rs-px-mask></rs-px-mask>" : "") + "</rs-mask-wrap></rs-loop-wrap></" + g + ">"), !0 !== n.filteronscroll && "true" != n.filteronscroll || i[a].scrolleffect._L.push(s.parent()), s[0].id = s[0].id === t ? "layer-" + Math.round(999999999 * Math.random()) : s[0].id, i.revCheckIDS(a, s[0]), "column" === n.type && s.closest(".rs-parallax-wrap").append('<rs-cbg-mask-wrap><rs-column-bg id="' + s[0].id + '_rs_cbg"></rs-column-bg></rs-cbg-mask-wrap>'), "text" === n.type && s[0].getElementsByTagName("iframe").length > 0 && s[0].classList.add("rs-ii-o"), punchgs.TweenMax.set(s, {
                                visibility: "hidden"
                            }), i[a].BUG_safari_clipPath && s[0].classList.add("rs-pelock")
                        }
                        i.gA(s[0], "actions") && i.checkActions && i.checkActions(s, a, i[a]), !i.checkVideoApis || window.rs_addedvim && window.rs_addedyt || i[a].youtubeapineeded && i[a].vimeoapineeded || i.checkVideoApis(s, a)
                    }), i.checkActions && i.checkActions(t, a), i[a].c.prependTo(i[a].cpar), i[a].c[0].addEventListener("mouseenter", function() {
                        i[a].c.trigger("tp-mouseenter"), i[a].overcontainer = !0
                    }, {
                        passive: !0
                    }), i[a].c[0].addEventListener("mouseover", function() {
                        i[a].c.trigger("tp-mouseover"), i[a].overcontainer = !0
                    }, {
                        passive: !0
                    }), i[a].c[0].addEventListener("mouseleave", function() {
                        i[a].c.trigger("tp-mouseleft"), i[a].overcontainer = !1
                    }, {
                        passive: !0
                    }), i[a].c.find(".rs-layer video").each(function(t) {
                        var i = e(this);
                        i.removeClass("video-js vjs-default-skin"), i.attr("preload", ""), i.css({
                            display: "none"
                        })
                    }), "standard" !== i[a].sliderType && (i[a].lazyType = "all"), i[a].rs_static_layer = i[a].c[0].getElementsByTagName("rs-static-layers"), i[a].rs_static_layer.length > 0 && (I(i[a].rs_static_layer[0], a, 0, !0), z(i[a].rs_static_layer[0], a, function() {
                        i[a] !== t && i[a].c.find("rs-static-layers img").each(function() {
                            this.src = A(a, i.gA(this, "src") != t ? i.gA(this, "src") : this.src).src
                        })
                    })), i[a].rowzones = [], i[a].middleZones = [];
                    var R = B("#")[0];
                    if (R.length < 9 && R.split("slide").length > 1 && -1 == R.indexOf("slider")) {
                        var S = parseInt(R.split("slide")[1], 0);
                        e.isNumeric(parseInt(S, 0)) && ((S = parseInt(S, 0)) < 1 && (S = 1), S > i[a].slideamount && (S = i[a].slideamount), i[a].startWithSlide = S - 1)
                    }
                    var M = parseInt(i[a].spinner.replace("spinner", ""), 10);
                    if (isNaN(M) || M < 6) i[a].loader = e('<rs-loader class="' + i[a].spinner + '"><div class="dot1"></div><div class="dot2"></div><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></rs-loader>');
                    else {
                        var O, P = i[a].spinnerclr || "#ffffff",
                            j = '<div class="rs-spinner-inner"';
                        if (7 === M) - 1 !== P.search("#") ? (O = P.replace("#", ""), O = "rgba(" + parseInt(O.substring(0, 2), 16) + ", " + parseInt(O.substring(2, 4), 16) + ", " + parseInt(O.substring(4, 6), 16) + ", ") : -1 !== P.search("rgb") && (O = P.substring(P.indexOf("(") + 1, P.lastIndexOf(")")).split(",")).length > 2 && (O = "rgba(" + O[0].trim() + ", " + O[1].trim() + ", " + O[2].trim() + ", "), O && "string" == typeof O && (j += ' style="border-top-color: ' + O + "0.65); border-bottom-color: " + O + "0.15); border-left-color: " + O + "0.65); border-right-color: " + O + '0.15)"');
                        else 12 === M && (j += ' style="background:' + P + '"');
                        j += ">";
                        for (var H = [10, 0, 4, 2, 5, 9, 0, 4, 4, 2][M - 6], N = 0; N < H; N++) N > 0 && (j += " "), j += '<span style="background:' + P + '"></span>';
                        j += "</div>", i[a].loader = e('<rs-loader class="' + i[a].spinner + '">' + j + "</div></rs-loader>")
                    }
                    i[a].c.append(i[a].loader), 0 === i[a].c.find("rs-progress").length && i[a].c.append('<rs-progress style="visibility:hidden"></rs-progress>'), i[a].c.find("rs-progress").css({
                        width: "0%"
                    }), i[a].canvas.css({
                        display: "block"
                    }), b(a), i[a].slides = i[a].canvas.find("rs-slide").not(".rs-not-in-nav"), i[a].inli = i[a].canvas.find("rs-slide.rs-not-in-nav"), ("off" !== i[a].parallax.type || i[a].scrolleffect.set || i[a].sbtimeline.set) && i.checkForParallax && i.checkForParallax(a), i.setSize(a, !1), "hero" !== i[a].sliderType && i.createNavigation && i[a].navigation.use && i.createNavigation(a), i.resizeThumbsTabs && i.resizeThumbsTabs && i[a].navigation.use && i.resizeThumbsTabs(a), g(a);
                    var W = i[a].viewPort;
                    i[a].inviewport = !1, W != t && W.enable && i.scrollTicker && i.scrollTicker(a), i[a].slides.each(function(t) {
                        var r = e(this);
                        i[a].rowzones[t] = [], i[a].middleZones[t] = [], r.find("rs-zone").each(function() {
                            i[a].rowzones[t].push(e(this)), this.className.indexOf("rev_row_zone_middle") >= 0 && i[a].middleZones[t].push(this)
                        }), ((W.enable && i[a].inviewport || !W.enable) && "all" == i[a].lazyType || "smart" == i[a].lazyType && (0 == t || 1 == t || t == i[a].slideamount || t == i[a].slideamount - 1)) && (I(r[0], a, t), z(r[0], a, function() {}))
                    }), i[a].srowzones = [], i[a].smiddleZones = [], i[a].slayers.find("rs-zone").each(function() {
                        i[a].srowzones.push(e(this)), this.className.indexOf("rev_row_zone_middle") >= 0 && i[a].smiddleZones.push(this)
                    }), "carousel" === i[a].sliderType && i.prepareCarousel && (punchgs.TweenMax.set(i[a].canvas, {
                        scale: 1,
                        perspective: 1200,
                        transformStyle: "flat",
                        opacity: 0
                    }), i.prepareCarousel(a, new punchgs.TimelineLite, t, 0), i[a].onlyPreparedSlide = !0), setTimeout(function() {
                        !W.enable || W.enable && i[a].inviewport || W.enable && !i[a].inviewport && "wait" !== W.outof ? C(a) : (i[a].c.addClass("tp-waitforfirststart"), i[a].waitForFirstSlide = !0, W.presize && (i[a].pr_next_slide = e(i[a].slides[0]), I(i[a].pr_next_slide[0], a, 0, !0), z(i[a].pr_next_slide.find(".tp-layers"), a, function() {
                            i.animateTheLayers && i.animateTheLayers({
                                slide: i[a].pr_next_key,
                                id: a,
                                mode: "preset"
                            })
                        }))), i.manageNavigation && i[a].navigation.use && i.manageNavigation(a), i[a].slideamount > 1 && (!W.enable || W.enable && i[a].inviewport ? Q(a) : i[a].waitForCountDown = !0), setTimeout(function() {
                            i[a] !== t && i[a].c.trigger("revolution.slide.onloaded")
                        }, 50)
                    }, i[a].startDelay), i[a].startDelay = 0, e("body").data("rs-fullScreenMode", !1), window.addEventListener("fullscreenchange", p, {
                        passive: !0
                    ...
                    var V = "resize.revslider-" + i[a].c.attr("id");
                    e(window).on(V, function() {
                        if (i[a] !== t) {
                            if (i[a].c == t) return !1;
                            0 != e("body").find(i[a].c) && (l(a), g(a));
                            var o = !1;
                            if ("fullscreen" == i[a].sliderLayout) {
                                var s = e(window).height();
                                "mobile" == i[a].fallbacks.ignoreHeightChanges && r || "always" == i[a].fallbacks.ignoreHeightChanges ? (i[a].fallbacks.ignoreHeightChangesSize = i[a].fallbacks.ignoreHeightChangesSize == t ? 0 : i[a].fallbacks.ignoreHeightChangesSize, o = s != i[a].lastwindowheight && Math.abs(s - i[a].lastwindowheight) > i[a].fallbacks.ignoreHeightChangesSize) : o = s != i[a].lastwindowheight
                            }(i[a].c.outerWidth(!0) != i[a].width || i[a].c.is(":hidden") || o) && (i[a].lastwindowheight = e(window).height(), m(a))
                        }
                    }), f(a), g(a), i[a].fallbacks.disableFocusListener || "true" == i[a].fallbacks.disableFocusListener || !0 === i[a].fallbacks.disableFocusListener || (i[a].c.addClass("rev_redraw_on_blurfocus"), D())
                }
            }
        },
        g = function(r) {
            var a = i.getHorizontalOffset(i[r].c, "left");
            if ("auto" === i[r].sliderLayout || "fullscreen" === i[r].sliderLayout && !0 === i[r].disableForceFullWidth ? "fullscreen" == i[r].sliderLayout && 1 == i[r].disableForceFullWidth ? punchgs.TweenMax.set(i[r].cpar, {
                    left: 0,
                    width: "auto"
                }) : punchgs.TweenMax.set(i[r].canvas, {
                    left: "carousel" === i[r].sliderType ? 0 : a,
                    width: i[r].c.width() - i.getHorizontalOffset(i[r].c, "both")
                }) : punchgs.TweenMax.set(i[r].cpar, {
                    left: 0 - Math.ceil(i[r].c.closest("rs-fullwidth-wrap").offset().left - a) + "px",
                    width: e(window).width() - i.getHorizontalOffset(i[r].c, "both")
                }), "auto" === i[r].sliderLayout && i[r].modal !== t && i[r].modal.useAsModal) {
                var o = Math.min(i[r].gridwidth[i[r].level], window.innerWidth);
                punchgs.TweenMax.set([i[r].modal.c, i[r].canvas], {
                    width: o
                })
            }
            i[r].slayers && "fullwidth" != i[r].sliderLayout && "fullscreen" != i[r].sliderLayout && punchgs.TweenMax.set(i[r].slayers, {
                left: a
            })
        },
        f = function(r, a) {
            e(window).width() < i[r].hideSliderAtLimit ? (i[r].c.trigger("stoptimer"), i.sA(i[r].cpar[0], "displaycache", "none" != i[r].cpar.css("display") ? i[r].cpar.css("display") : i.gA(i[r].cpar[0], "displaycache")), i[r].cpar.css({
                display: "none"
            })) : i[r].c.is(":hidden") && a && (i.gA(i[r].cpar[0], "displaycache") != t && "none" != i.gA(i[r].cpar[0], "displaycache") ? i[r].cpar.css({
                display: i.gA(i[r].cpar[0], "displaycache")
            }) : i[r].cpar.css({
                display: "block"
            }), i[r].c.trigger("restarttimer"), setTimeout(function() {
                m(r)
            }, 150)), i.hideUnHideNav && i[r].navigation.use && i.hideUnHideNav(r)
        },
        m = function(a) {
            if (i[a].c === t) return !1;
            i[a].c.trigger("revolution.slide.beforeredraw"), 1 == i[a].infullscreenmode && (i[a].minHeight = e(window).height()), r && (i[a].lastMobileHeight = window.innerHeight), l(a), i.resizeThumbsTabs && !0 !== i.resizeThumbsTabs(a) || (f(a, !0), g(a), "carousel" == i[a].sliderType && i.prepareCarousel(a, !0), i.setSize(a), i.updateDimensions(a), "standard" === i[a].sliderType && i[a].mtl !== t && i.animateSlide({
                recall: !0,
                id: a
        ...
        v = function(e, r) {
            r && r.data("panzoom") !== t && i.startPanZoom(r, e, r.data("pztl") !== t ? r.data("pztl").progress() : 0)
        },
        y = function(e) {
        ...
        b = function(r) {
            i[r].autoHeight && punchgs.TweenMax.set([i[r].c, i[r].cpar], {
                maxHeight: "none"
            }), punchgs.TweenMax.set(i[r].canvas, {
                overflow: "hidden",
                width: "100%",
                height: "100%",
                maxHeight: i[r].autoHeight ? "none" : i[r].cpar.css("maxHeight")
            }), "carousel" === i[r].sliderType && (i[r].canvas.css({
                overflow: "visible"
            }).wrap("<rs-carousel-wrap></rs-carousel-wrap>"), i[r].cpar.prepend("<rs-carousel-space></rs-carousel-space>").append("<rs-carousel-space></rs-carousel-space>"), i.prepareCarousel(r)), i[r].startWithSlide = i[r].startWithSlide === t ? t : "carousel" === i[r].type ? parseInt(i[r].startWithSlide) : parseInt(i[r].startWithSlide) + 1, i[r].cpar.css({
                overflow: "visible"
            }), i[r].scrolleffect.bgs = [];
            for (var a = 0; a < i[r].slides.length; a++) {
                var o = e(i[r].slides[a]),
                    s = o.find(">img"),
                    n = o.find("rs-bgvideo");
                s.detach(), n.detach(), (i[r].startWithSlide != t && i.gA(i[r].slides[a], "originalindex") == i[r].startWithSlide || i[r].startWithSlide === t && 0 == a) && (i[r].pr_next_key = o.index()), punchgs.TweenMax.set(o, {
                    width: "100%",
                    height: "100%",
                    overflow: "hidden"
                ...
                var l = s.closest("rs-sbg-wrap"),
                    ...
                    c = w(s.data(), r, s[0].style.backgroundColor),
                ...
                c.src = s[0].src, c.lazyload = u(s[0], t, r), c.slidebgimage = !0, d = "none" === d || d === t ? "" : d, n.length > 0 && (n.addClass("defaultvid").css({
                    zIndex: 30
                ...
                i.sA(o[0], "scroll-based", !!i[r].sbtimeline.set && (m.s !== t && m.s)), i[r].scrolleffect.set ? (i[r].scrolleffect.bgs.push({
                    fade: m.f !== t ? m.f : !!i[r].scrolleffect.slide && i[r].scrolleffect.fade,
                    blur: m.b !== t ? m.b : !!i[r].scrolleffect.slide && i[r].scrolleffect.blur,
                    grayscale: m.g !== t ? m.g : !!i[r].scrolleffect.slide && i[r].scrolleffect.grayscale,
        ...
        w = function(a, o, s) {
            ...
            return i[o].fallbacks.panZoomDisableOnMobile && r && (l.panzoom = null, l.bgfit = "cover"), e.extend(!0, a, l)
        },
        _ = function(e, t) {
        ...
        T = function(e, t) {
            var i = e.split("/"),
                r = t.split("/");
            i.pop();
            for (var a = 0; a < r.length; a++) "." != r[a] && (".." == r[a] ? i.pop() : i.push(r[a]));
            return i.join("/")
        },
        L = function(e, r, a) {
            if (i[r] !== t) {
                for (var o in i[r].syncload--, i[r].loadqueue)
                    if (i[r].loadqueue.hasOwnProperty(o) && "loaded" !== i[r].loadqueue[o].progress) {
                        var s = i[r].loadqueue[o].src !== t ? i[r].loadqueue[o].src.replace(/\.\.\/\.\.\//gi, "") : i[r].loadqueue[o].src;
                        (s === e.src || k(s) === k(e.src) || x(document.location.protocol + s) === x(decodeURIComponent(e.src)) || x(document.location.origin + s) === x(decodeURIComponent(e.src)) || x(self.location.href.substring(0, self.location.href.length - 1) + s) === x(decodeURIComponent(e.src)) || x(T(self.location.href, i[r].loadqueue[o].src)) === x(decodeURIComponent(e.src)) || x(document.location.origin + "/" + s) === x(decodeURIComponent(e.src)) || x(self.location.href.substring(0, self.location.href.length - 1) + "/" + s) === x(decodeURIComponent(e.src)) || x(i[r].loadqueue[o].src) === x(decodeURIComponent(e.src)) || "file://" === window.location.origin && x(e.src).match(new RegExp(s))) && (i[r].loadqueue[o].progress = a, i[r].loadqueue[o].width = e.width, i[r].loadqueue[o].height = e.height)
                    }
                R(r)
            }
        },
        R = function(t) {
            4 != i[t].syncload && i[t].loadqueue && e.each(i[t].loadqueue, function(r, a) {
                if ("prepared" == a.progress && i[t].syncload <= 4) {
                    if (i[t].syncload++, "img" == a.type) {
                        var o = new Image;
                        o.onload = function() {
                            L(this, t, "loaded"), a.error = !1
                        }, o.onerror = function() {
                            L(this, t, "failed"), a.error = !0
                        }, o.src = a.src, a.starttoload = e.now()
                    } else e.get(a.src, function(e) {
                        a.innerHTML = (new XMLSerializer).serializeToString(e.documentElement), a.progress = "loaded", i[t].syncload--, R(t)
                    }).fail(function() {
                        a.progress = "failed", i[t].syncload--, R(t)
                    });
                    a.progress = "inload"
                }
            })
        ...
        A = function(e, r) {
            var a = i[e].loadqueue.filter(function(e) {
                return e.src === r
            })[0];
            return a === t ? {
                src: r
        ...
        z = function(a, o, s) {
            if (a !== t && 0 !== a.length && i[o] !== t) {
                var n = !1,
                    l = a.querySelectorAll("img, rs-sbg, .rs-svg");
                for (var d in l)
                    if (l.hasOwnProperty(d) && "length" !== d && !(l[d].className.indexOf("rs-pzimg") >= 0)) {
                        ...
                        if (c.loaded === t && g !== t && g.progress && "loaded" == g.progress) {
                            if (l[d].src = g.src, "img" == g.type) {
                                if (c.slidebgimage) {
                                    -1 == g.src.indexOf("images/transparent.png") && -1 == g.src.indexOf("assets/transparent.png") || c.bgcolor === t ? l[d].style.backgroundImage = 'url("' + g.src + '")' : c.bgcolor !== t && (l[d].style.background = c.bgcolor), i.sA(a, "owidth", g.width), i.sA(a, "oheight", g.height);
                                    var f = a.getElementsByTagName("rs-sbg-wrap");
                                    f.length > 0 && (i.sA(f[0], "owidth", g.width), i.sA(f[0], "oheight", g.height))
                                }
                            } else "svg" == g.type && "loaded" == g.progress && (l[d].innerHTML = g.innerHTML);
                            c.loaded = !0
                        }
                        g && g.progress && g.progress.match(/inprogress|inload|prepared/g) && (!g.error && e.now() - g.starttoload < 3e3 ? n = !0 : (g.progress = "failed", g.reported_img || (g.reported_img = !0, console.log(h + "  Could not be loaded !")))), 1 != i[o].youtubeapineeded || window.YT && YT.Player != t || (n = M("youtube", o)), 1 != i[o].vimeoapineeded || window.Vimeo || (n = M("vimeo", o))
                    }!r && i[o].audioqueue && i[o].audioqueue.length > 0 && e.each(i[o].audioqueue, function(t, i) {
                ...
                }), n ? punchgs.TweenMax.delayedCall(.18, z, [a, o, s]) : punchgs.TweenMax.delayedCall(.18, s)
            }
        },
        S = function(e, t) {
        ...
        M = function(t, r) {
            if (e.now() - i[r][t + "starttime"] > 5e3 && 1 != i[r][t + "warning"]) {
                i[r][t + "warning"] = !0;
                var a = t + " Api Could not be loaded !";
                "https:" === location.protocol && (a += " Please Check and Renew SSL Certificate !"), console.error(a), i[r].c.append('<div style="position:absolute;top:50%;width:100%;color:#e74c3c;  font-size:16px; text-align:center; padding:15px;background:#000; display:block;"><strong>' + a + "</strong></div>")
            }
            return !0
        },
        O = function(r) {
            i[r] !== t && (i[r].pr_active_slide = e(i[r].slides[i[r].pr_active_key]), i[r].pr_next_slide = e(i[r].slides[i[r].pr_processing_key]), i[r].pr_active_bg = i[r].pr_active_slide.find("rs-sbg-wrap"), i[r].pr_next_bg = i[r].pr_next_slide.find("rs-sbg-wrap"), punchgs.TweenMax.to([i[r].pr_active_bg, i[r].pr_next_bg], .5, {
                opacity: 0
                ...
                autoAlpha: 0,
                zIndex: 20
            }), i[r].tonpause = !1, i.removeTheLayers && i[r].pr_active_key !== t && i.removeTheLayers(i[r].pr_active_slide, r, !0), i[r].firststart = 1, setTimeout(function() {
                delete i[r].pr_active_key, delete i[r].pr_processing_key
            }, 200))
        },
        C = function(r, a) {
            if (i[r] !== t)
                if (clearTimeout(i[r].waitWithSwapSlide), i[r].pr_processing_key === t) {
                    if (i[r].startWithSlideKey !== t && (i[r].pr_next_key = i.getComingSlide(r, i[r].startWithSlideKey).nindex, delete i[r].startWithSlideKey), i[r].pr_active_slide = e(i[r].slides[i[r].pr_active_key]), i[r].pr_next_slide = e(i[r].slides[i[r].pr_next_key]), i[r].pr_next_key == i[r].pr_active_key && !0 !== i[r].onlyPreparedSlide) return delete i[r].pr_next_key;
                    !0 === i[r].onlyPreparedSlide && (i[r].onlyPreparedSlide = !1), i[r].pr_processing_key = i[r].pr_next_key, delete i[r].pr_next_key, i[r].pr_next_slide !== t && i[r].pr_next_slide[0] !== t && i.gA(i[r].pr_next_slide[0], "hal") !== t && i.sA(i[r].pr_next_slide[0], "sofacounter", i.gA(i[r].pr_next_slide[0], "sofacounter") === t ? 1 : parseInt(i.gA(i[r].pr_next_slide[0], "sofacounter"), 0) + 1), i[r].stopLoop && i[r].pr_processing_key == i[r].lastslidetoshow - 1 && (i[r].c.find("rs-progress").css({
                        visibility: "hidden"
                    }), i[r].c.trigger("revolution.slide.onstop"), i[r].noloopanymore = 1), i[r].pr_next_slide.index() === i[r].slideamount - 1 && i[r].looptogo > 0 && "disabled" !== i[r].looptogo && (i[r].looptogo--, i[r].looptogo <= 0 && (i[r].stopLoop = !0)), i[r].tonpause = !0, i[r].c.trigger("stoptimer"), "off" === i[r].spinner && (i[r].loader !== t ? i[r].loader.css({
                        display: "none"
                    }) : i[r].loadertimer = setTimeout(function() {
                        i[r].loader !== t && i[r].loader.css({
                            display: "block"
                        })
                    }, 18)), I(i[r].pr_next_slide[0], r, 1), i.preLoadAudio && i.preLoadAudio(i[r].pr_next_slide, r, 1), z(i[r].pr_next_slide[0], r, function() {
                        i[r] !== t && (i[r].pr_next_slide.find("rs-bgvideo").each(function() {
                            var t = e(this);
                            t.hasClass("HasListener") || (t.data("bgvideo", 1), i.manageVideoLayer && i.manageVideoLayer(t, r)), 0 == t.find(".rs-fullvideo-cover").length && t.append('<div class="rs-fullvideo-cover"></div>')
                        }), P(i[r].pr_next_slide.find("rs-sbg"), r, a))
                    }), g(r)
                } else i[r].waitWithSwapSlide = setTimeout(function() {
                    C(r, a)
                }, 18)
        },
        P = function(r, a, o) {
            if (i[a] !== t) {
                if (i[a].pr_active_slide = e(i[a].slides[i[a].pr_active_key]), i[a].pr_next_slide = e(i[a].slides[i[a].pr_processing_key]), i[a].pr_active_bg = i[a].pr_active_slide.find("rs-sbg-wrap"), i[a].pr_next_bg = i[a].pr_next_slide.find("rs-sbg-wrap"), i[a].tonpause = !1, clearTimeout(i[a].loadertimer), i[a].loader !== t && i[a].loader.css({
                        display: "none"
                    }), i.setSize(a), i.manageNavigation && i[a].navigation.use && i.manageNavigation(a, !1), i[a].c.trigger("revolution.slide.onbeforeswap", {
                        slider: a,
                        slideIndex: parseInt(i[a].pr_active_key, 0) + 1,
                        slideLIIndex: i[a].pr_active_key,
                        nextSlideIndex: parseInt(i[a].pr_processing_key, 0) + 1,
                        nextSlideLIIndex: i[a].pr_processing_key,
                        nextslide: i[a].pr_next_slide,
                        slide: i[a].pr_active_slide,
                        currentslide: i[a].pr_active_slide,
                        prevslide: i[a].pr_lastshown_key !== t ? i[a].slides[i[a].pr_lastshown_key] : ""
                    }), i[a].transition = 1, i[a].stopByVideo = !1, i[a].pr_next_slide[0] !== t && i.gA(i[a].pr_next_slide[0], "duration") != t && "" != i.gA(i[a].pr_next_slide[0], "duration") ? i[a].duration = parseInt(i.gA(i[a].pr_next_slide[0], "duration"), 0) : i[a].duration = i[a].origcd, i[a].pr_next_slide[0] === t || "true" != i.gA(i[a].pr_next_slide[0], "ssop") && !0 !== i.gA(i[a].pr_next_slide[0], "ssop") ? i[a].ssop = !1 : i[a].ssop = !0, i[a].sbtimeline.set && i[a].sbtimeline.fixed && i.updateFixedScrollTimes(a), i[a].c.trigger("nulltimer"), i[a].sdir = i[a].pr_processing_key < i[a].pr_active_key ? 1 : 0, "arrow" == i[a].sc_indicator && (0 == i[a].pr_active_key && i[a].pr_processing_key == i[a].slideamount - 1 && (i[a].sdir = 1), i[a].pr_active_key == i[a].slideamount - 1 && 0 == i[a].pr_processing_key && (i[a].sdir = 0)), i[a].lsdir = i[a].sdir, i[a].pr_active_key != i[a].pr_processing_key && 1 != i[a].firststart && "carousel" !== i[a].sliderType && i.removeTheLayers && i.removeTheLayers(i[a].pr_active_slide, a), i[a].pr_next_slide.hasClass("rs-pause-timer-once") || i[a].pr_next_slide.hasClass("rs-pause-timer-always") ? i[a].stopByVideo = !0 : i[a].c.trigger("restarttimer"), i[a].pr_next_slide.removeClass("rs-pause-timer-once"), i[a].pr_next_slide[0] !== t && i.sA(i[a].c[0], "slideactive", i.gA(i[a].pr_next_slide[0], "key")), "carousel" == i[a].sliderType) i[a].mtl = new punchgs.TimelineLite, i.prepareCarousel(a, i[a].mtl), j(a), i[a].transition = 0;
                else {
                    i[a].mtl = new punchgs.TimelineLite({
                        onComplete: function() {
                            j(a)
                        }
                    }), i[a].mtl.add(punchgs.TweenMax.set(i[a].pr_next_bg.find("rs-sbg"), {
                        opacity: 0
                    })), i[a].mtl.pause(), i.animateTheLayers && (i[a].pr_next_key !== t ? i.animateTheLayers({
                        slide: i[a].pr_next_key,
                        id: a,
                        mode: "preset"
                    }) : i[a].pr_processing_key !== t ? i.animateTheLayers({
                        slide: i[a].pr_processing_key,
                        id: a,
                        mode: "preset"
                    }) : i[a].pr_active_key !== t && i.animateTheLayers({
                        ...
                        id: a,
                        mode: "preset"
                    })), 1 == i[a].firststart && (punchgs.TweenMax.set(i[a].pr_active_slide, {
                        autoAlpha: 0
                    }), i[a].firststart = 0), punchgs.TweenMax.set(i[a].pr_active_slide, {
                        zIndex: 18
                    }), punchgs.TweenMax.set(i[a].pr_next_slide, {
                        autoAlpha: 0,
                        zIndex: 20
                    }), "prepared" == i.gA(i[a].pr_next_slide[0], "differentissplayed") && (i.sA(i[a].pr_next_slide[0], "differentissplayed", "done"), i.sA(i[a].pr_next_slide[0], "anim", i.gA(i[a].pr_next_slide[0], "savedanim"))), i.gA(i[a].pr_next_slide[0], "firstanim") != t && "done" != i.gA(i[a].pr_next_slide[0], "differentissplayed") && (i.sA(i[a].pr_next_slide[0], "savedanim", i.gA(i[a].pr_next_slide[0], "anim")), i.sA(i[a].pr_next_slide[0], "anim", i.gA(i[a].pr_next_slide[0], "firstanim")), i.sA(i[a].pr_next_slide[0], "differentissplayed", "prepared"));
                    var s = function(e) {
                        ...
                        return r
                    }(i.gA(i[a].pr_next_slide[0], "anim"));
                    i.sA(i[a].pr_next_slide[0], "ntrid", "on" == i.gA(i[a].pr_next_slide[0], "rndtrans") ? Math.round(80 * Math.random()) : parseInt(i.gA(i[a].pr_next_slide[0], "ntrid"), 0) + 1 || 0), i.sA(i[a].pr_next_slide[0], "ntrid", s.transition === t || i.gA(i[a].pr_next_slide[0], "ntrid") == s.transition.length ? 0 : i.gA(i[a].pr_next_slide[0], "ntrid")), i.animateSlide({
                        animation: s,
                        ntrid: i.gA(i[a].pr_next_slide[0], "ntrid"),
                        id: a
                    }), i[a].pr_next_bg.data("panzoom") !== t && (i.startPanZoom(i[a].pr_next_bg, a), i[a].mtl.add(punchgs.TweenMax.set(i[a].pr_next_bg, {
                        autoAlpha: 0
                    }))), i[a].mtl.pause()
                }
                i.scrollHandling && i[a].mtl !== t && (i.scrollHandling(a, !0, 0), i[a].mtl.eventCallback("onUpdate", function() {
                    i.scrollHandling(a, !0, 0, !0)
                })), "off" != i[a].parallax.type && i[a].parallax.firstgo == t && i.scrollHandling && (i[a].parallax.firstgo = !0, i[a].lastscrolltop = -999, i.scrollHandling(a, !0, 0), setTimeout(function() {
                    i[a] !== t && (i[a].lastscrolltop = -999, i.scrollHandling(a, !0, 0))
                }, 70), setTimeout(function() {
                    i[a] !== t && (i[a].lastscrolltop = -999, i.scrollHandling(a, !0, 0))
                }, 100)), i.animateTheLayers ? "carousel" === i[a].sliderType ? i[a].carousel.showLayersAllTime ? (e.each(i[a].slides, function(e) {
                    i[a].carousel.allLayersStarted ? i.animateTheLayers({
                        slide: e,
                        id: a,
                        mode: "rebuild"
                    }) : i.animateTheLayers({
                ...
                }), i[a].carousel.allLayersStarted = !0) : (0 !== i[a].firststart ? i.animateTheLayers({
                    slide: 0,
                    id: a,
                    mode: "start"
                }) : !0 !== o && i.animateTheLayers({
                    slide: i[a].pr_next_key !== t ? i[a].pr_next_key : i[a].pr_processing_key !== t ? i[a].pr_processing_key : i[a].pr_active_key,
                    id: a,
                    mode: "start"
                }), i[a].firststart = 0) : i.animateTheLayers({
                    slide: i[a].pr_next_key !== t ? i[a].pr_next_key : i[a].pr_processing_key !== t ? i[a].pr_processing_key : i[a].pr_active_key,
                    id: a,
                    mode: "start"
                }) : i[a].mtl != t && setTimeout(function() {
                    i[a].mtl.resume()
                }, 18), punchgs.TweenMax.to(i[a].pr_next_slide, .001, {
                    autoAlpha: 1
                })
            }
        };
    var j = function(a) {
            if (i[a] !== t && (i[a].firstSlideAvailable === t && (i[a].firstSlideAvailable = !0, i.showFirstTime !== t && i.showFirstTime(a)), "carousel" === i[a].sliderType || (punchgs.TweenMax.to(i[a].pr_next_bg.find("rs-sbg"), .001, {
                    zIndex: 20,
                    autoAlpha: 1,
                    onComplete: function() {
                        _(a, i[a].pr_next_slide)
                    }
                }), i[a].pr_next_slide.index() != i[a].pr_active_slide.index() && punchgs.TweenMax.to(i[a].pr_active_slide, .2, {
                    zIndex: 18,
                    autoAlpha: 0,
                    onComplete: function() {
                        _(a, i[a].pr_active_slide)
                    }
                })), i[a].pr_active_key = i[a].pr_processing_key !== t ? i[a].pr_processing_key : i[a].pr_active_key, delete i[a].pr_processing_key, "scroll" != i[a].parallax.type && "scroll+mouse" != i[a].parallax.type && "mouse+scroll" != i[a].parallax.type || (i[a].lastscrolltop = -999, i.scrollHandling(a)), i[a].mtldiff = i[a].mtl.time(), delete i[a].mtl, i[a].pr_active_key !== t)) {
                i.gA(i[a].slides[i[a].pr_active_key], "sloop") !== t && function(e) {
                    if (i[e] !== t) {
                        i[e].sloops = i[e].sloops === t ? {} : i[e].sloops;
                        var r = i.gA(i[e].slides[i[e].pr_active_key], "key"),
                            a = i[e].sloops[r];
                        if (a === t) {
                            a = {
                                s: 2500,
                            ...
                            for (var s in o)
                                if (o.hasOwnProperty(s)) {
                                    ...
                                    switch (n[0]) {
                                        case "s":
                                            a.s = parseInt(n[1], 0) / 1e3;
                                            break;
                                        case "e":
                                            a.e = parseInt(n[1], 0) / 1e3;
                                            break;
                                        case "r":
                                            a.r = n[1]
                                    }
                                }
                            a.r = "unlimited" === a.r ? -1 : parseInt(a.r, 0), i[e].sloops[r] = a, a.key = r
                        }
                        a.ct = {
                            time: a.s
                        }, a.tl = new punchgs.TimelineMax({}), a.timer = punchgs.TweenMax.fromTo(a.ct, a.e - a.s, {
                            time: a.s
                        }, {
                            time: a.e,
                            ease: punchgs.Linear.easeNone,
                            onRepeat: function() {
                                for (var r in i[e].layers[a.key]) i[e].layers[a.key].hasOwnProperty(r) && i[e]._L[r].timeline.play(a.s);
                                var o = i[e].c.find("rs-progress");
                                o !== t && o[0] !== t && o[0].tween !== t && o[0].tween.time(a.s)
                            },
                            onUpdate: function() {},
                            onComplete: function() {}
                        }).repeat(a.r), a.tl.add(a.timer, a.s), a.tl.time(i[e].mtldiff)
                    }
                }(a), i[a].c.find(".active-rs-slide").removeClass("active-rs-slide"), e(i[a].slides[i[a].pr_active_key]).addClass("active-rs-slide"), i.sA(i[a].c[0], "slideactive", i.gA(i[a].slides[i[a].pr_active_key], "key")), i[a].pr_active_bg.data("pztl") != t && (i[a].pr_active_bg.data("pztl").reverse(), i[a].pr_active_bg.data("pztl").timeScale(25)), i[a].pr_next_bg.data("panzoom") !== t && (i[a].pr_next_bg.data("pztl") != t ? (i[a].pr_next_bg.data("pztl").timeScale(1), i[a].pr_next_bg.data("pztl").play()) : i.startPanZoom(i[a].pr_next_bg, a)), i[a].pr_next_slide.find("rs-bgvideo").each(function(t) {
                    if (r && !i[a].fallbacks.allowHTML5AutoPlayOnAndroid) return !1;
                    var o = e(this);
                    i.resetVideo(o, a, !1, !0), punchgs.TweenMax.fromTo(o, .25, {
                        autoAlpha: 0
                    }, {
                        autoAlpha: 1,
                        ease: punchgs.Power3.easeInOut,
                        delay: .05,
                        onComplete: function() {
                            i.animcompleted && i.animcompleted(o, a)
                        }
                    })
                }), i[a].pr_active_bg.find("rs-bgvideo").each(function(t) {
                    if (r && !i[a].fallbacks.allowHTML5AutoPlayOnAndroid) return !1;
                    var o = e(this);
                    i.stopVideo && (i.resetVideo(o, a), i.stopVideo(o, a)), punchgs.TweenMax.to(o, 1, {
                        autoAlpha: 0,
                        ease: punchgs.Power3.easeInOut,
                        delay: .2
                    })
                ...
                var o = {
                    ...
                    slideIndex: parseInt(i[a].pr_active_key, 0) + 1,
                    slideLIIndex: i[a].pr_active_key,
                    slide: i[a].pr_next_slide,
                    currentslide: i[a].pr_next_slide,
                    prevSlideIndex: i[a].pr_lastshown_key !== t && parseInt(i[a].pr_lastshown_key, 0) + 1,
                    prevSlideLIIndex: i[a].pr_lastshown_key !== t && parseInt(i[a].pr_lastshown_key, 0),
                    prevSlide: i[a].pr_lastshown_key !== t && i[a].slides[i[a].pr_lastshown_key]
                };
                if (i[a].c.trigger("revolution.slide.onchange", o), i[a].c.trigger("revolution.slide.onafterswap", o), i[a].pr_lastshown_key = i[a].pr_active_key, i[a].startWithSlide !== t && "done" !== i[a].startWithSlide && "carousel" === i[a].sliderType) {
                    for (var s = i[a].startWithSlide, n = 0; n <= i[a].slides.length - 1; n++) i[a].slides[n] !== t && i[a].slides[n][0] !== t && i.gA(i[a].slides[n][0], "originalindex") === i[a].startWithSlide && (s = n);
                    0 !== s && i.callingNewSlide(a, s), i[a].startWithSlide = "done"
                }
                i[a].duringslidechange = !1, i[a].pr_active_slide.length > 0 && 0 != i.gA(i[a].pr_active_slide[0], "hal") && i.gA(i[a].pr_active_slide[0], "hal") <= i.gA(i[a].pr_active_slide[0], "sofacounter") && i[a].c.revremoveslide(i[a].pr_active_slide.index());
                var l = i[a].pr_processing_key || i[a].pr_active_key || 0;
                i[a].rowzones != t && (l = l > i[a].rowzones.length ? i[a].rowzones.length : l), i[a].rowzones != t && i[a].rowzones.length > 0 && i[a].rowzones[l] != t && l >= 0 && l <= i[a].rowzones.length && i[a].rowzones[l].length > 0 && i.setSize(a), delete i[a].sc_indicator, delete i[a].sc_indicator_dir, i[a].firstLetItFree === t && (i.scrollHandling && i.scrollHandling(a, !0), i[a].firstLetItFree = !0)
            }
        },
        Q = function(a) {
            i[a].loop = 0, i[a].stopAtSlide != t && i[a].stopAtSlide > -1 ? i[a].lastslidetoshow = i[a].stopAtSlide : i[a].lastslidetoshow = 999, i[a].stopLoop = !1, 0 == i[a].looptogo && (i[a].stopLoop = !0);
            var o = i[a].c.find("rs-progress");
            i[a].c.on("stoptimer", function() {
                var t = e(this).find("rs-progress");
                t[0].tween.pause(), i[a].disableProgressBar && t.css({
                    visibility: "hidden"
                }), i[a].sliderstatus = "paused", i.unToggleState(i[a].slidertoggledby)
            }), i[a].c.on("starttimer", function() {
                i[a].forcepaused || (1 != i[a].conthover && 1 != i[a].stopByVideo && i[a].width > i[a].hideSliderAtLimit && 1 != i[a].tonpause && 1 != i[a].overnav && 1 != i[a].ssop && (1 === i[a].noloopanymore || i[a].viewPort.enable && !i[a].inviewport || (o.css({
                    visibility: "visible"
                }), o[0].tween.resume(), i[a].sliderstatus = "playing")), i[a].disableProgressBar && o.css({
                    visibility: "hidden"
                }), i.toggleState(i[a].slidertoggledby))
            }), i[a].c.on("restarttimer", function() {
                if (!i[a].forcepaused) {
                    var t = e(this).find("rs-progress");
                    if (i[a].mouseoncontainer && "on" == i[a].navigation.onHoverStop && !r) return !1;
                    1 === i[a].noloopanymore || i[a].viewPort.enable && !i[a].inviewport || 1 == i[a].ssop || (t.css({
                        visibility: "visible"
                    }), t[0].tween.kill(), t[0].tween = punchgs.TweenMax.fromTo(t, i[a].duration / 1e3, {
                        width: "0%"
                    }, {
                        force3D: "auto",
                        width: "100%",
                        ...
                        onComplete: s,
                        delay: 1
                    }), i[a].sliderstatus = "playing"), i[a].disableProgressBar && t.css({
                        visibility: "hidden"
                    }), i.toggleState(i[a].slidertoggledby)
                }
            }), i[a].c.on("nulltimer", function() {
                o[0].tween.kill(), o[0].tween = punchgs.TweenMax.fromTo(o, i[a].duration / 1e3, {
                    width: "0%"
                }, {
                    force3D: "auto",
                    width: "100%",
                    ...
                    onComplete: s,
                    delay: 1
                }), o[0].tween.pause(0), i[a].disableProgressBar && o.css({
                    visibility: "hidden"
                }), i[a].sliderstatus = "paused"
            });
            var s = function() {
                0 == e("body").find(i[a].c).length && (! function(t) {
                ...
                }(a), clearInterval(i[a].cdint)), i[a].c.trigger("revolution.slide.slideatend"), 1 == i[a].c.data("conthoverchanged") && (i[a].conthover = i[a].c.data("conthover"), i[a].c.data("conthoverchanged", 0)), i.callingNewSlide(a, 1)
            };
            o[0].tween = punchgs.TweenMax.fromTo(o, i[a].duration / 1e3, {
                width: "0%"
            }, {
                force3D: "auto",
                width: "100%",
                ...
                onComplete: s,
                delay: 1
            }), i[a].slideamount > 1 && (0 != i[a].stopAfterLoops || 1 != i[a].stopAtSlide) ? i[a].c.trigger("starttimer") : (i[a].noloopanymore = 1, i[a].c.trigger("nulltimer")), i[a].c.on("tp-mouseenter", function() {
                i[a].mouseoncontainer = !0, 1 != i[a].navigation.onHoverStop || r || (i[a].c.trigger("stoptimer"), i[a].c.trigger("revolution.slide.onpause"))
            }), i[a].c.on("tp-mouseleft", function() {
                i[a].mouseoncontainer = !1, 1 != i[a].c.data("conthover") && 1 == i[a].navigation.onHoverStop && (1 == i[a].viewPort.enable && i[a].inviewport || 0 == i[a].viewPort.enable) && (i[a].c.trigger("revolution.slide.onresume"), i[a].c.trigger("starttimer"))
            })
        },
        H = function() {
        ...
        D = function() {
            var i = document.documentMode === t,
                r = window.chrome;
            1 !== e("body").data("revslider_focus_blur_listener") && (e("body").data("revslider_focus_blur_listener", 1), i && !r ? e(window).on("focusin", function() {
                H()
        ...
        B = function(e) {
            for (var t, i = [], r = window.location.href.slice(window.location.href.indexOf(e) + 1).split("_"), a = 0; a < r.length; a++) r[a] = r[a].replace("%3D", "="), t = r[a].split("="), i.push(t[0]), i[t[0]] = t[1];
            return i
        },
        W = function(e) {
        ...
        V = function(i) {
            return function(i) {
                for (var r in i.minHeight = i.minHeight !== t ? "none" === i.minHeight || "0" === i.minHeight || "0px" === i.minHeight || "" == i.minHeight || " " == i.minHeight ? 0 : parseInt(i.minHeight, 0) : 0, i.maxHeight = "none" === i.maxHeight || "0" === i.maxHeight ? 0 : parseInt(i.maxHeight, 0), i.carousel.maxVisibleItems = i.carousel.maxVisibleItems < 1 ? 999 : i.carousel.maxVisibleItems, i.carousel.vertical_align = "top" === i.carousel.vertical_align ? "0%" : "bottom" === i.carousel.vertical_align ? "100%" : "50%", i.carousel.space = parseInt(i.carousel.space, 0), i.carousel.maxOpacity = parseInt(i.carousel.maxOpacity, 0), i.carousel.maxRotation = parseInt(i.carousel.maxRotation, 0), i.carousel.minScale = parseInt(i.carousel.minScale, 0), i.carousel.speed = parseInt(i.carousel.speed, 0), i.navigation.maintypes = ["arrows", "tabs", "thumbnails", "bullets"], i.navigation.maintypes) i.navigation.maintypes.hasOwnProperty(r) && i.navigation[i.navigation.maintypes[r]] !== t && (i.navigation[i.navigation.maintypes[r]].animDelay = parseInt(i.navigation[i.navigation.maintypes[r]].animDelay, 0) / 1e3, i.navigation[i.navigation.maintypes[r]].animSpeed = parseInt(i.navigation[i.navigation.maintypes[r]].animSpeed, 0) / 1e3);
                if (e.isNumeric(i.scrolleffect.tilt) || -1 !== i.scrolleffect.tilt.indexOf("%") && (i.scrolleffect.tilt = parseInt(i.scrolleffect.tilt)), i.scrolleffect.tilt = i.scrolleffect.tilt / 100, i.navigation.thumbnails.position = "outer-horizontal" == i.navigation.thumbnails.position ? "bottom" == i.navigation.thumbnails.v_align ? "outer-bottom" : "outer-top" : "outer-vertical" == i.navigation.thumbnails.position ? "left" == i.navigation.thumbnails.h_align ? "outer-left" : "outer-right" : i.navigation.thumbnails.position, i.navigation.tabs.position = "outer-horizontal" == i.navigation.tabs.position ? "bottom" == i.navigation.tabs.v_align ? "outer-bottom" : "outer-top" : "outer-vertical" == i.navigation.tabs.position ? "left" == i.navigation.tabs.h_align ? "outer-left" : "outer-right" : i.navigation.tabs.position, i.sbtimeline.speed = parseInt(i.sbtimeline.speed, 0) / 1e3 || .5, !0 === i.sbtimeline.set && !0 === i.sbtimeline.fixed && "auto" !== i.sliderLayout ? (i.sbtimeline.fixStart = parseInt(i.sbtimeline.fixStart), i.sbtimeline.fixEnd = parseInt(i.sbtimeline.fixEnd)) : i.sbtimeline.fixed = !1, i.startDelay = parseInt(i.startDelay, 0) || 0, i.navigation !== t && i.navigation.arrows != t && i.navigation.arrows.hide_under != t && (i.navigation.arrows.hide_under = parseInt(i.navigation.arrows.hide_under)), i.navigation !== t && i.navigation.bullets != t && i.navigation.bullets.hide_under != t && (i.navigation.bullets.hide_under = parseInt(i.navigation.bullets.hide_under)), i.navigation !== t && i.navigation.thumbnails != t && i.navigation.thumbnails.hide_under != t && (i.navigation.thumbnails.hide_under = parseInt(i.navigation.thumbnails.hide_under)), i.navigation !== t && i.navigation.tabs != t && i.navigation.tabs.hide_under != t && (i.navigation.tabs.hide_under = parseInt(i.navigation.tabs.hide_under)), i.navigation !== t && i.navigation.arrows != t && i.navigation.arrows.hide_over != t && (i.navigation.arrows.hide_over = parseInt(i.navigation.arrows.hide_over)), i.navigation !== t && i.navigation.bullets != t && i.navigation.bullets.hide_over != t && (i.navigation.bullets.hide_over = parseInt(i.navigation.bullets.hide_over)), i.navigation !== t && i.navigation.thumbnails != t && i.navigation.thumbnails.hide_over != t && (i.navigation.thumbnails.hide_over = parseInt(i.navigation.thumbnails.hide_over)), i.navigation !== t && i.navigation.tabs != t && i.navigation.tabs.hide_over != t && (i.navigation.tabs.hide_over = parseInt(i.navigation.tabs.hide_over)), i.lazyloaddata !== t && i.lazyloaddata.length > 0 && i.lazyloaddata.indexOf("-") > 0) {
                    ...
                    for (i.lazyloaddata = a[0], r = 1; r < a.length; r++) i.lazyloaddata += W(a[r])
                }
...
function($, undefined) {
    ...
    function updateToggleByList(e, t, i) {
        var r = e.data(t);
        r === undefined && (r = []), r.push(i), e.data(t, r)
    }
            ...
            if (e.hasOwnProperty(i)) {
                ...
                switch (r[0]) {
                    ...
                    case "n":
                        ...
                        break;
                    case "o":
                        t.on = "click" === r[1] || "c" === r[1] ? "click" : "ml" === r[1] || "mouseleave" === r[1] ? "mouseleave" : "mouseenter" === r[1] || "me" === r[1] ? "mouseenter" : r[1];
                        break;
                    case "d":
                        t.delay = parseInt(r[1], 0) / 1e3, t.delay = "NaN" === t.delay || isNaN(t.delay) ? 0 : t.delay;
                        break;
                    case "a":
                        t.action = r[1];
                        break;
                    ...
                    case "url":
                        t.url = "";
                        for (var a = 1; a < r.length; a++) t.url += r[a] + (a === r.length - 1 ? "" : ":");
                        break;
                    case "target":
                        t.target = r[1];
                        break;
                    case "class":
                        ...
                        break;
                    case "ch":
                        t.children = "true" == r[1] || 1 == r[1] || "t" == r[1];
                        break;
                    default:
                        r[0].length > 0 && "" !== r[0] && (t[r[0]] = r[1])
                }
            }
        return t
    }
...
function(e) {
    ...
    jQuery.extend(!0, t, {
        prepareCarousel: function(e, o, n, l) {
            void 0 !== e && (n = t[e].carousel.lastdirection = r(n, t[e].carousel.lastdirection), i(e), t[e].carousel.slide_offset_target = s(e), void 0 !== l ? a(e, n, !1, 0) : null == o ? t.carouselToEvalPosition(e, n) : a(e, n, !1))
        },
        carouselToEvalPosition: function(e, i) {
            ...
            var s = "center" === o.horizontal_align ? (o.wrapwidth / 2 - o.slide_width / 2 - o.slide_globaloffset) / o.slide_width : (0 - o.slide_globaloffset) / o.slide_width,
                ...
                c = -1 * (Math.ceil(n) - n),
                p = -1 * (Math.floor(n) - n);
            d = l >= .3 && "left" === i || l >= .7 && "right" === i ? c : l < .3 && "left" === i || l < .7 && "right" === i ? p : d, d = o.infinity ? d : n < 0 ? n : s > t[e].slideamount - 1 ? s - (t[e].slideamount - 1) : d, o.slide_offset_target = d * o.slide_width, o.slide_offset_target !== o.slide_offset_targetCACHE && (0 !== Math.abs(o.slide_offset_target) ? a(e, i, !0) : t.organiseCarousel(e, i), o.slide_offset_targetCACHE = o.slide_offset_target)
        },
        organiseCarousel: function(e, i, r, a) {
            ...
            var c = 999,
                p = 0,
                u = t[e].ulw;
            t[e].slides && jQuery.each(t[e].slides, function(a, l) {
                var d = s[a],
                    h = {};
                o.infinity && (d = (d = d > o.wrapwidth - o.inneroffset + o.slide_width && "left" === i ? s[0] - (n - a) * o.slide_width : d) < 0 - o.inneroffset - 3 * o.slide_width ? "left" == i ? d + o.maxwidth : "right" === i ? s[n - 1] + (a + 1) * o.slide_width : d : d, (u = u > d ? d : u) > 0 && d > o.wrapwidth && (d = o.slide_offset - (t[e].slides.length - a) * o.slide_width)), h.left = d + o.inneroffset;
                ...
                if ((r && Math.abs(g) < c || 0 === g) && (c = Math.abs(g), o.focused = a), h.width = o.slide_width, h.x = 0, h.transformPerspective = 1200, h.transformOrigin = "50% " + o.vertical_align, o.fadeout)
            ...
            }), a && (o.focused = void 0 === o.focused ? 0 : o.focused, o.oldfocused = void 0 === o.oldfocused ? 0 : o.oldfocused, t[e].pr_next_key = o.focused, o.focused !== o.oldfocused && t.animateTheLayers && (t.removeTheLayers(jQuery(t[e].slides[o.oldfocused]), e), t.animateTheLayers({
                slide: o.focused,
                id: e,
    ...
    var i = function(e) {
            ...
            var i = t[e].carousel,
                r = t.getHorizontalOffset(t[e].c, "left"),
                a = t.getHorizontalOffset(t[e].c, "right");
            ...
            }(e), i.slide_width = !0 !== i.stretch ? t[e].gridwidth[t[e].level] * (0 === t[e].bw ? 1 : t[e].bw) : t[e].c.width(), i.slide_height = !0 !== i.stretch ? t[e].gridheight[t[e].level] * (0 === t[e].bw ? 1 : t[e].bw) : t[e].c.height(), i.maxwidth = t[e].slideamount * i.slide_width, i.maxVisiblebackup > t[e].slides.length + 1 && (i.maxVisibleItems = t[e].slides.length + 2), i.wrapwidth = i.maxVisibleItems * i.slide_width + (i.maxVisibleItems - 1) * i.space, i.wrapwidth = "auto" != t[e].sliderLayout ? i.wrapwidth > t[e].c.width() ? t[e].c.width() : i.wrapwidth : i.wrapwidth > t[e].canvas.width() ? t[e].canvas.width() : i.wrapwidth, i.infinity = !(i.wrapwidth >= i.maxwidth) && i.infbackup, i.wrapoffset = "center" === i.horizontal_align ? (t[e].c.width() - a - r - i.wrapwidth) / 2 : 0, i.wrapoffset = "auto" != t[e].sliderLayout && t[e].outernav ? 0 : i.wrapoffset < r ? r : i.wrapoffset;
        ...
        a = function(e, i, a, o) {
            ...
            var n = {},
                l = a ? punchgs.Power2.easeOut : s.easing;
            n.from = 0, n.to = s.slide_offset_target, o = void 0 === o ? s.speed / 1e3 : o, 0 !== (o = a ? o * (Math.abs(n.to) / s.wrapwidth) : o) && o < .1 && Math.abs(n.to) > 25 && (o = .3), void 0 !== s.positionanim && s.positionanim.pause(), s.positionanim = punchgs.TweenLite.to(n, o, {
                from: n.to,
                onUpdate: function() {
        ...
        s = function(e) {
            ...
            if (void 0 !== d.positionanim && d.positionanim.kill(), "none" == d.slide_globaloffset) d.slide_globaloffset = l = "center" === d.horizontal_align ? d.wrapwidth / 2 - d.slide_width / 2 : 0;
                ...
                p = t.simp(p, t[e].slideamount, !1), c = (c = c >= 0 ? c : t[e].pr_active_key) >= 0 ? c : 0, l = d.infinity ? (i = p, r = c, a = t[e].slideamount, n = r - a - i, s = o(s = r - i, a), n = o(n, a), -(Math.abs(s) > Math.abs(n) ? n : s)) : p - c, l *= d.slide_width
            }
            return l
        }
}(jQuery),
function(e) {
    ...
    jQuery.extend(!0, i, {
        checkLayerDimensions: function(e) {
            var t = !1;
            for (var r in i[e.id].layers[e.skey])
                if (i[e.id].layers[e.skey].hasOwnProperty(r) && !t) {
                    var a = i[e.id].layers[e.skey][r];
                    i[e.id]._L[a.id].eow !== a.offsetWidth && "true" !== i.gA(a, "vary-layer-dims") && (t = !0)
                }
            return t
        },
                ...
                if (i[o].layers[s].hasOwnProperty(n)) {
                    ...
                    if (void 0 === i.gA(c, "initialised")) {
                        if (i.revCheckIDS(o, c), i[o]._L[c.id] = g, g.ford = void 0 === g.ford ? "frame_0;frame_1;frame_999" : g.ford, g.ford = ";" == g.ford[g.ford.length - 1] ? g.ford.substring(0, g.ford.length - 1) : g.ford, g.ford = g.ford.split(";"), void 0 !== g.clip)
                            for (t in g.clipPath = {
                                    ...
                                    origin: "l",
                                    type: "rectangle"
                                }, g.clip = g.clip.split(";"), g.clip) g.clip.hasOwnProperty(t) && ("u" == (r = g.clip[t].split(":"))[0] && (g.clipPath.use = "true" == r[1]), "o" == r[0] && (g.clipPath.origin = r[1]), "t" == r[0] && (g.clipPath.type = r[1]));
                        if (g.frames = w(g, o), g.c = h, g.p = h.closest(".rs-parallax-wrap"), g.lp = h.closest("rs-loop-wrap"), g.m = h.closest("rs-mask-wrap"), g.triggercache = void 0 === g.triggercache ? "reset" : g.triggercache, g.rsp_bd = void 0 === g.rsp_bd ? "column" === g.type || "row" === g.type ? "off" : "on" : g.rsp_bd, g.rsp_o = void 0 === g.rsp_o ? "on" : g.rsp_o, g.basealign = void 0 === g.basealign ? "grid" : g.basealign, g.group = "group" !== g.type && h.closest("rs-group-wrap").length > 0 ? "group" : "column" !== g.type && h.closest("rs-column").length > 0 ? "column" : "row" !== g.type && h.closest("rs-row").length > 0 ? "row" : void 0, g._lig = "group" === g.group ? h.closest("rs-group") : "column" === g.group ? h.closest("rs-column") : "row" === g.group ? h.closest("rs-row") : void 0, g._ligid = void 0 !== g._lig ? g._lig[0].id : void 0, g._column = "RS-COLUMN" === h[0].tagName ? h.closest("rs-column-wrap") : "none", g._row = "RS-COLUMN" === h[0].tagName && h.closest("rs-row"), g._ingroup = "group" === g.group, g._incolumn = "column" === g.group, g._inrow = "row" === g.group, (g._ingroup || g._incolumn) && g._lig[0].className.indexOf("rs-sba") >= 0 && (!1 !== g.animationonscroll || void 0 === g.frames.loop) && !0 !== g.animOnScrollForceDisable && (g.animationonscroll = !0, h[0].className += " rs-sba", i[o].sbas[s][c.id] = h[0]), g.animOnScrollRepeats = 0, g._isgroup = "RS-GROUP" === h[0].tagName, g.type = g.type || "none", "row" === g.type && void 0 === g.cbreak && (g.cbreak = 2), g._isnotext = -1 !== jQuery.inArray(g.type, ["video", "image", "audio", "shape"]), g._mediatag = "html5" == g.audio ? "audio" : "video", g.img = h.find("img"), g.deepiframe = h[0].getElementsByTagName("iframe"), g.deepmedia = h[0].getElementsByTagName(g._mediatag), g.layertype = "image" === g.type ? "image" : h[0].className.indexOf("rs-layer-video") >= 0 || h[0].className.indexOf("rs-layer-audio") >= 0 || g.deepiframe.length > 0 && (g.deepiframe[0].src.toLowerCase().indexOf("youtube") > 0 || g.deepiframe[0].src.toLowerCase().indexOf("vimeo") > 0) || g.deepmedia.length > 0 ? "video" : "html", g.deepiframe.length > 0 && i.sA(g.deepiframe[0], "layertype", g.layertype), "column" === g.type && (g.cbg = g.p.find("rs-column-bg"), g.cbgmask = g.p.find("rs-cbg-mask-wrap")), g._slidelink = h[0].className.indexOf("slidelink") >= 0, g._isstatic = h[0].className.indexOf("rs-layer-static") >= 0, g.slidekey = g._isstatic ? "staticlayers" : s, g._togglelisteners = h.find(".rs-toggled-content").length > 0, g.bgcol = void 0 === g.bgcol ? h[0].style.background.indexOf("gradient") >= 0 ? h[0].style.background : h.css("backgroundColor") : g.bgcol, g.bgcol = 0 === g.bgcol.indexOf("rgba(0, 0, 0, 0)") && g.bgcol.length > 18 ? g.bgcol.replace("rgba(0, 0, 0, 0)", "") : g.bgcol, g.zindex = h.css("z-Index"), g._togglelisteners && h.click(function() {
                            ...
                            for (t in g.border = g.border.split(";"), g.bordercolor = "transparent", g.border)
                                if (g.border.hasOwnProperty(t)) switch ((r = g.border[t].split(":"))[0]) {
                                    case "boc":
                                        g.bordercolor = r[1];
                                        break;
                                    case "bow":
                                        g.borderwidth = i.revToResp(r[1], 4, 0);
                                        break;
                                    case "bos":
                                        g.borderstyle = i.revToResp(r[1], 4, 0);
                                        break;
                                    case "bor":
                                        g.borderradius = i.revToResp(r[1], 4, 0)
                                }
                        if ("svg" === g.type && (g.svg = h.find("svg"), g.svgPath = g.svg.find("path"), g.svgI = p(g.svgi, o), g.svgH = p(g.svgh, o)), void 0 !== g.btrans) {
                            ...
                            for (t in g.btrans = {
                                ...
                                if (f.hasOwnProperty(t)) switch ((r = f[t].split(":"))[0]) {
                                    case "rX":
                                        g.btrans.rX = r[1];
                                        break;
                                    case "rY":
                        ...
                        if (void 0 !== g.tsh)
                            for (t in g.tshadow = {
                                ...
                                if (g.tsh.hasOwnProperty(t)) switch ((r = g.tsh[t].split(":"))[0]) {
                                    case "c":
                                        g.tshadow.c = r[1];
                                        break;
                                    case "h":
                        ...
                        if (void 0 !== g.tst)
                            for (t in g.tstroke = {
                                ...
                                if (g.tst.hasOwnProperty(t)) switch ((r = g.tst[t].split(":"))[0]) {
                                    case "c":
                                        g.tstroke.c = r[1];
                                        break;
                                    case "w":
                        ...
                        if (void 0 !== g.bsh)
                            for (t in g.bshadow = {
                                ...
                                if (g.bsh.hasOwnProperty(t)) switch ((r = g.bsh[t].split(":"))[0]) {
                                    case "c":
                                        g.bshadow.c = r[1];
                                        break;
                                    case "h":
                        ...
                        if (void 0 !== g.dim)
                            for (t in g.dim = g.dim.split(";"), g.dim)
                                if (g.dim.hasOwnProperty(t)) switch ((r = g.dim[t].split(":"))[0]) {
                                    case "w":
                                        g.width = r[1];
                                        break;
                                    case "h":
                        ...
                        if (void 0 !== g.xy)
                            for (t in g.xy = g.xy.split(";"), g.xy)
                                if (g.xy.hasOwnProperty(t)) switch ((r = g.xy[t].split(":"))[0]) {
                                    case "x":
                                        g.x = r[1].replace("px", "");
                                        break;
                                    case "y":
                                        ...
                                        break;
                                    case "xo":
                                        g.hoffset = r[1].replace("px", "");
                                        break;
                                    case "yo":
                                        g.voffset = r[1].replace("px", "")
                                }
                        if (!g._isnotext && void 0 !== g.text)
                            for (t in g.text = g.text.split(";"), g.text)
                                if (g.text.hasOwnProperty(t)) switch ((r = g.text[t].split(":"))[0]) {
                                    case "w":
                                        g.whitespace = r[1];
                                        break;
                                    case "td":
                                        g.textDecoration = r[1];
                                        break;
                                    case "c":
                                        g.clear = r[1];
                                        break;
                        ...
                        if (void 0 !== g.flcr)
                            for (t in g.flcr = g.flcr.split(";"), g.flcr)
                                if (g.flcr.hasOwnProperty(t)) switch ((r = g.flcr[t].split(":"))[0]) {
                                    case "c":
                                        g.clear = r[1];
                                        break;
                                    case "f":
                        ...
                        if (void 0 !== g.padding)
                            for (t in g.padding = g.padding.split(";"), g.padding)
                                if (g.padding.hasOwnProperty(t)) switch ((r = g.padding[t].split(":"))[0]) {
                                    case "t":
                                        g.paddingtop = r[1];
                                        break;
                                    case "b":
                        ...
                        if (void 0 !== g.margin)
                            for (t in g.margin = g.margin.split(";"), g.margin)
                                if (g.margin.hasOwnProperty(t)) switch ((r = g.margin[t].split(":"))[0]) {
                                    case "t":
                                        g.margintop = r[1];
                                        break;
                                    case "b":
                        ...
                        if (void 0 !== g.spike && (g.spike = I(g.spike)), void 0 !== g.corners)
                            for (t in a = g.corners.split(";"), g.corners = {}, a) a.hasOwnProperty(t) && a[t].length > 0 && (g.corners[a[t]] = jQuery("<" + a[t] + "></" + a[t] + ">"), g.c.append(g.corners[a[t]]));
                    ...
                    if (d = "slide" === g.basealign ? 0 : Math.max(0, "fullscreen" == i[o].sliderLayout ? v / 2 - i[o].gridheight[i[o].level] * (i[o].keepBPHeight ? 1 : i[o].bh) / 2 : i[o].autoHeight || null != i[o].minHeight && i[o].minHeight > 0 ? i[o].conh / 2 - i[o].gridheight[i[o].level] * i[o].bh / 2 : d), l = "slide" === g.basealign ? 0 : Math.max(0, l), "slide" !== g.basealign && "carousel" === i[o].sliderType && g._isstatic && void 0 !== i[o].carousel && void 0 !== i[o].carousel.horizontal_align && (l = Math.max(0, "center" === i[o].carousel.horizontal_align ? 0 + (i[o].ulw - i[o].gridwidth[i[o].level] * i[o].bw) / 2 : "right" === i[o].carousel.horizontal_align ? i[o].ulw - i[o].gridwidth[i[o].level] * i[o].bw : l)), "updateposition" !== e.mode) {
                        if (0 == g.vbility[i[o].levelForced] || "f" == g.vbility[i[o].levelForced] || m < i[o].hideLayerAtLimit && "on" == g.layeronlimit || m < i[o].hideAllLayerAtLimit ? g.p[0].classList.add("rs-layer-hidden") : g.p[0].classList.remove("rs-layer-hidden"), g.poster = null == g.poster && void 0 !== g.thumbimage ? g.thumbimage : g.poster, "image" === g.layertype)
                            ...
                            var z = h[0].className.indexOf("coverscreenvideo") >= 0;
                            g.media.css({
                                display: "block"
                            });
                            var S = g.width[i[o].level],
                            ...
                            var O = T(h, o);
                            if (g._incolumn && "100%" === S && "auto" === M && void 0 !== g.ytid) {
                            ...
                            } else -1 != h[0].className.indexOf("rs-fsv") || z ? (l = 0, d = 0, g.x = i.revToResp(0, i[o].rle, 0), g.y = i.revToResp(0, i[o].rle, 0), h.css({
                                width: m,
                                ...
                                width: S,
                                height: M
                            }), (0 == g.html5vid && !z || 1 != g.forcecover && !h.hasClass("rs-fsv") && !z) && (g.media.width(S), g.media.height(M)), g._ingroup && null != S && !jQuery.isNumeric(S) && S.indexOf("%") > 0 && punchgs.TweenMax.set([g.lp, g.p, g.m], {
                                minWidth: S
                            })
                        }
                    ...
                    if ("preset" !== e.mode) {
                        if (g.eow = h.outerWidth(!0), g.eoh = h.outerHeight(!0), ("text" === g.type || "button" === g.type) && void 0 !== g.corners) {
                            for (a in g.corners)
                                if (g.corners.hasOwnProperty(a)) {
                                    g.corners[a].css("borderWidth", g.eoh + "px");
                                    var P = "rs-fcrt" === a || "rs-fcr" === a;
                                    g.corners[a].css("border" + (P ? "Right" : "Left"), "0px solid transparent"), g.corners[a].css("border" + ("rs-fcrt" == a || "rs-bcr" == a ? "Bottom" : "Top") + "Color", g.bgcol)
                                }
        ...
        animcompleted: function(e, t) {
            if (void 0 !== i[t].videos) {
                ...
                null != r && null != r.type && "none" != r.type && (1 == r.aplay || "true" == r.aplay || "on" == r.aplay || "1sttime" == r.aplay ? ("carousel" === i[t].sliderType && e.closest("rs-slide").index() != i[t].pr_active_key || i.playVideo(e, t), i.toggleState(e.data("videotoggledby")), (r.aplay1 || "1sttime" == r.aplay) && (r.aplay1 = !1, r.aplay = !1)) : ("no1sttime" == r.aplay && (r.aplay = !0), i.unToggleState(e.data("videotoggledby"))))
            }
        },
        handleStaticLayers: function(e, t) {
            var r = 0,
                a = i[t].realslideamount + 1;
            if (void 0 !== i.gA(e[0], "onslides")) {
                var o = i.gA(e[0], "onslides").split(";");
                for (var s in o)
                    if (o.hasOwnProperty(s)) {
                        var n = o[s].split(":");
                        "s" === n[0] && (r = parseInt(n[1], 0)), "e" === n[0] && (a = parseInt(n[1], 0))
                    }
            }
            r = Math.max(0, r), a = Math.min(i[t].realslideamount, a < 0 ? i[t].realslideamount : a), a = 1 !== r && 0 !== r || a !== i[t].realslideamount ? a : i[t].realslideamount + 1, e.data("startslide", r), e.data("endslide", a), i.sA(e[0], "startslide", r), i.sA(e[0], "endslide", a)
        },
        animateTheLayers: function(e) {
            ...
            var r = i.gA(i[t].slides[e.slide], "key"),
                a = i[t].pr_processing_key || i[t].pr_active_key || 0;
            if (i[t].layers = i[t].layers || {}, i[t].layers[r] = void 0 === i[t].layers[r] ? x(jQuery(i[t].slides[e.slide]), "rs-layer") : i[t].layers[r], i[t].layers.static = void 0 === i[t].layers.static ? x(jQuery(i[t].c.find("rs-static-layers")), "rs-layer") : i[t].layers.static, i[t].sbas[r] = void 0 === i[t].sbas[r] ? x(jQuery(i[t].slides[e.slide]), "rs-sba") : i[t].sbas[r], i.updateDimensions(t), void 0 !== r && i[t].layers[r] && i.initLayer({
                    id: t,
                    skey: r,
                    mode: e.mode,
                    ...
                    void 0 !== r && i[t].layers[r] && i.checkLayerDimensions({
                        id: t,
                        skey: r
                    }) && i.initLayer({
                        id: t,
                ...
                }, 200), i[t].dimensionReCheck = !0), (void 0 !== i[t].rowzones && i[t].rowzones.length > 0 && a >= 0 && i[t].rowzones[Math.min(a, i[t].rowzones.length)].length > 0 || void 0 !== i[t].srowzones && i[t].srowzones.length > 0 || void 0 !== i[t].smiddleZones && i[t].smiddleZones.length > 0) && (i.setSize(t), i.updateDimensions(t), i.initLayer({
                    id: t,
                    skey: r,
                    mode: "updateposition"
                }), i.initLayer({
                    ...
                    skey: "static",
                    mode: "updateposition"
                }), "start" !== e.mode && "preset" !== e.mode || i.manageNavigation(t)), void 0 !== r && i[t].layers[r])
        ...
        removeTheLayers: function(e, t, r) {
            var a = i.gA(e[0], "key");
            if (i[t].sloops && i[t].sloops[a] && i[t].sloops[a].tl && i[t].sloops[a].tl.stop(), "carousel" === i[t].sliderType && i[t].carousel.showLayersAllTime);
            else {
            ...
            if ("preset" !== e.mode || !0 === u.frames.frame_1.timeline.waitoncall || void 0 !== u.scrollBasedOffset || !0 === u.forceRender) {
                    ...
                    if (u.ford.hasOwnProperty(R)) {
                        ...
                        if ("frame_0" !== I && "frame_hover" !== I && "loop" !== I) {
                            ...
                            if ("frame_999" !== I || !1 !== _ || "continue" !== e.mode && "start" !== e.mode && "rebuild" !== e.mode) {
                                ...
                                var z = u.frames[I],
                                    S = u.fff ? u.frames.frame_0 : void 0,
                                    M = new punchgs.TimelineMax,
                                    O = new punchgs.TimelineMax,
                                    C = u.c,
                                    P = void 0 !== z.sfx && g(z.sfx.effect, u.m, z.timeline.ease),
                                    j = z.timeline.speed / 1e3,
                                    Q = 0,
                                    H = m({
                                        id: c,
                                        frame: z,
                                        layer: d,
                                        ease: z.timeline.ease,
                                    ...
                                    W = H.ease;
                                "block" === P.type && (P.ft[0].background = z.sfx.fxc, M.add(punchgs.TweenMax.fromTo(P.bmask_in, j / 2, P.ft[0], P.ft[1], 0)), M.add(punchgs.TweenMax.fromTo(P.bmask_in, j / 2, P.ft[1], P.t, j / 2)), "frame_0" === I || "frame_1" === I ? N.opacity = 0 : "frame_999" === I && M.add(O.staggerFromTo(C, .05, {
                                    autoAlpha: 1
                                }, {
                                    autoAlpha: 0,
                                    delay: j / 2
                                }, 0), .001)), void 0 !== z.color ? H.color = z.color : void 0 !== u.color && "npc" !== u.color[p] && (H.color = u.color[p]), void 0 !== S && void 0 !== S.color ? N.color = S.color : void 0 !== S && void 0 !== u.color && "npc" !== u.color[p] && (N.color = u.color[p]), void 0 !== z.bgcolor ? z.bgcolor.indexOf("gradient") >= 0 ? H.background = z.bgcolor : H.backgroundColor = z.bgcolor : !0 === u.bgcolinuse && (u.bgcol.indexOf("gradient") >= 0 ? H.background = u.bgcol : H.backgroundColor = u.bgcol), void 0 !== S && (void 0 !== S.bgcolor ? S.bgcolor.indexOf("gradient") >= 0 ? N.background = S.bgcolor : N.backgroundColor = S.bgcolor : !0 === u.bgcolinuse && (u.bgcol.indexOf("gradient") >= 0 ? N.background = u.bgcol : N.backgroundColor = u.bgcol));
                                var V = 0;
                                if (void 0 !== u.splitText && !1 !== u.splitText)
                                    for (var Y in t)
                                        if (void 0 === z[t[Y]] || u.quickRendering) u.fff ? M.add(O.fromTo(u.splitText[t[Y]], j, {
                                            immediateRender: !1,
                                            color: N.color
                                        }, {
                                            color: H.color
                                            ...
                                            var F = y(u.splitText[t[Y]], z[t[Y]].dir),
                                                E = m({
                                                    id: c,
                                                    frame: z,
                                                    source: t[Y],
                                            ...
                                            Q = void 0 === z[t[Y]].delay ? .05 : z[t[Y]].delay / 100, E.color = H.color, void 0 !== N && (X.color = N.color);
                                ...
                                j += u.frames[I].split ? Q * V : 0, u.pxundermask || void 0 !== D && (void 0 !== S && "hidden" === S.mask.overflow || "hidden" === z.mask.overflow) ? (M.add(punchgs.TweenMax.to(u.m, .001, {
                                    ...
                                    overflow: "visible"
                                }), 0), H.force3D = "auto", u.fff ? (H.visibility = "visible", void 0 !== u.cbg && M.fromTo(u.cbg, j, N, H, 0), i[c].BUG_safari_clipPath && (N.clipPath || H.clipPath || u.spike) && (N.z && parseInt(N.z, 10) || (N.z = -1e-4), H.z && parseInt(H.z, 10) || (H.z = 0)), void 0 !== u.cbg && "column" === u.type ? M.fromTo(C, j, r(N), r(H), 0) : M.fromTo(C, j, N, H, 0)) : (void 0 !== u.cbg && M.to(u.cbg, j, H, 0), !i[c].BUG_safari_clipPath || !H.clipPath && !u.spike || H.z && parseInt(H.z, 10) || (H.z = 0 - .01 * Math.random()), void 0 !== u.cbg && "column" === u.type ? M.to(C, j, r(H), 0) : M.to(C, j, H, 0)), void 0 !== W && "object" != typeof W && W.indexOf("SFXBounce") >= 0 && M.to(C, j, {
                                    scaleY: .5,
                                    scaleX: 1.3,
                                    ease: H.ease + "-squash",
                                    transformOrigin: "bottom"
                                }, 1e-4);
                                var U = "trigger" !== e.mode && (!0 !== b && "skiprest" !== b || "rebuild" !== e.mode) || e.frame === I || void 0 === z.timeline.start || !jQuery.isNumeric(z.timeline.start) ? "+=0" === z.timeline.start || void 0 === z.timeline.start ? "+=0.005" : parseInt(z.timeline.start, 0) / 1e3 : "+=" + parseInt(z.timeline.startRelative, 0) / 1e3;
                                u.timeline.addLabel(I, U), u.timeline.add(M, U), u.timeline.addLabel(I + "_end", "+=0.01"), M.eventCallback("onStart", o, [{
                                    id: c,
                                    frame: I,
                                    L: d
                ...
                if (void 0 !== u.frames.loop) {
                    var G = u.frames.loop.frame_0,
                        ...
                        re = parseInt(u.frames.loop.timeline.speed, 0) / 1e3,
                        ae = parseInt(u.frames.loop.timeline.start) / 1e3 || 0,
                        oe = ae + .2;
                    if (K.add($, 0), K.add(ee, 0), K.add(te, 0), K.add(ie, 0), J.originX = G.originX, J.originY = G.originY, J.originZ = G.originZ, u.frames.loop.timeline.curved) {
                        ...
                        u.timeline.fromTo(u.lp, .2, {
                            ...
                            opacity: G.opacity
                        }, ae), $.to(u.lp, u.frames.loop.timeline.yoyo_move ? re / 2 : re, {
                            bezier: le,
                    ...
                    ee.to(u.lp, u.frames.loop.timeline.yoyo_rotate ? re / 2 : re, {
                        rotationX: J.rotationX,
                        rotationY: J.rotationY,
                        rotationZ: J.rotationZ,
                        ease: u.frames.loop.timeline.ease
                    }), te.to(u.lp, u.frames.loop.timeline.yoyo_scale ? re / 2 : re, {
                        scaleX: J.scaleX,
                        scaleY: J.scaleY,
                        skewX: J.skewX,
                        skewY: J.skewY,
                    ...
                    ie.to(u.lp, u.frames.loop.timeline.yoyo_filter ? re / 2 : re, ce), u.timeline.add(K, oe)
                }
                    ...
                    pe = 0 === pe ? 1e-5 : pe, u.hoverlistener || (u.hoverlistener = !0, jQuery(document).on("mouseenter mousemove", ("column" === u.type ? "#" + u.cbg[0].id + "," : "") + "#" + u.c[0].id, function(e) {
                        if (("mousemove" !== e.type || !0 !== u.ignoremousemove) && u.readyForHover) {
                            if (u.ignoremousemove = !0, u.elementHovered = !0, u.hovertimeline || (u.hovertimeline = new punchgs.TimelineMax), u.hovertimeline.to([u.m, u.cbgmask], pe, {
                                ...
                                }, 0), "column" === u.type ? u.hovertimeline.to(u.c, pe, r(jQuery.extend(!0, {}, l(u.frames.frame_hover, u.c))), 0) : u.hovertimeline.to(u.c, pe, jQuery.extend(!0, {}, l(u.frames.frame_hover, u.c)), 0), "svg" === u.type) {
                        ...
                        u.elementHovered = !1, u.readyForHover && void 0 !== u.hovertimeline && (u.hovertimeline.reverse(), u.hovertimeline.eventCallback("onReverseComplete", a, [{
                            id: c,
                            L: d
                        }]))
                    }))
    ...
    var r = function(e) {
        ...
        o = function(e) {
            ...
            var t = i[e.id]._L[e.L[0].id],
                r = t.hovertimeline;
            r && r.time() > 0 && (r.pause(), r.time(0), r.kill(), delete t.hovertimeline), i[e.id]._L[e.L[0].id].p[0].classList.remove("rs-forcehidden");
            var a = {};
        ...
        n = function(e) {
            ...
            if ("column" === i[e.id]._L[e.L[0].id].type || "row" === i[e.id]._L[e.L[0].id].type || "group" === i[e.id]._L[e.L[0].id].type) {
                var r = i[e.id]._L[e.L[0].id].timeline.currentLabel(),
                    a = jQuery.inArray(r, i[e.id]._L[e.L[0].id].ford);
                a++, a = i[e.id]._L[e.L[0].id].ford.length > a ? i[e.id]._L[e.L[0].id].ford[a] : r, void 0 !== i[e.id]._L[e.L[0].id].frames[a] && void 0 !== i[e.id]._L[e.L[0].id].frames[r] && (i[e.id]._L[e.L[0].id].timezone = {
                    from: parseInt(i[e.id]._L[e.L[0].id].frames[r].timeline.startAbsolute, 0),
                    to: parseInt(i[e.id]._L[e.L[0].id].frames[a].timeline.startAbsolute, 0)
                })
            }
        ...
        p = function(e, t) {
            ...
            for (var a in e)
                if (e.hasOwnProperty(a)) {
                    ...
                    switch (o[0]) {
                        case "c":
                            r.fill = i.revToResp(o[1], i[t].rle, void 0, "||");
                            break;
                        case "sw":
                            r["stroke-width"] = o[1];
                            break;
                        case "sc":
                            ...
                            break;
                        case "so":
                            r["stroke-dashoffset"] = o[1];
                            break;
                        case "sa":
                            r["stroke-dasharray"] = o[1]
                    }
                }
            return r
        },
        ...
        h = function(e) {
            ...
            if (t.splitText && !1 !== t.splitText && t.splitText.revert(), "text" === t.type || "button" === t.type) {
                ...
                t.splitText = !!r && new punchgs.SplitText(t.c, {
        ...
        g = function(e, t, i) {
            if (void 0 !== e && e.indexOf("block") >= 0) {
                var r = {};
                switch (0 === t.find(".tp-blockmask_in").length && (t.append('<div class="tp-blockmask_in"></div>'), t.append('<div class="tp-blockmask_out"></div>')), i = void 0 === i ? punchgs.Power3.easeInOut : i, r.ft = [{
                    scaleY: 1,
                    scaleX: 0,
                    ...
                    ease: i,
                    immediateRender: !1
                }, r.bmask_in = t.find(".tp-blockmask_in"), r.bmask_out = t.find(".tp-blockmask_out"), r.type = "block", e) {
                    case "blocktoleft":
                    case "blockfromright":
                        r.ft[0].transformOrigin = "100% 50%", r.t.transformOrigin = "0% 50%";
                        break;
                    case "blockfromtop":
                    case "blocktobottom":
                        r.ft = [{
                ...
                return r.ft[1].overwrite = "auto", r.t.overwrite = "auto", r
            }
            return !1
        },
        f = function(e, t, r, a, o) {
            return 0 === i[o].sdir || void 0 === t ? e : ("mask" === r ? a = "x" === a ? "mX" : "y" === a ? "mY" : a : "chars" === r ? a = "x" === a ? "cX" : "y" === a ? "cY" : "dir" === a ? "cD" : a : "words" === r ? a = "x" === a ? "wX" : "y" === a ? "wY" : "dir" === a ? "wD" : a : "lines" === r && (a = "x" === a ? "lX" : "y" === a ? "lY" : "dir" === a ? "lD" : a), void 0 === t[a] || !1 === t[a] ? e : void 0 !== t && !0 === t[a] ? "t" === e || "top" === e ? "b" : "b" === e || "bottom" === e ? "t" : "l" === e || "left" === e ? "r" : "r" === e || "right" === e ? "l" : -1 * e : void 0)
        },
        m = function(e) {
            var t = i[e.id]._L[e.layer[0].id],
            ...
            for (var n in r)
                if (r.hasOwnProperty(n))
                    if (r[n] = "object" == typeof r[n] ? r[n][i[e.id].level] : r[n], "inherit" === r[n] || "delay" === n || "direction" === n || "use" === n) delete r[n];
                    else if ("originX" === n || "originY" === n || "originZ" === n) a[n] = r[n], delete r[n];
            else if (jQuery.isNumeric(r[n], 0)) r[n] = f(r[n], e.frame.reverse, e.target, n, e.id, e.id);
            else if ("r" === r[n][0] && "a" === r[n][1] && "random" !== r[n]) {
                r[n] = r[n].replace("ran(", "").replace(")", "");
                var l = r[n].indexOf("%") >= 0 ? "%" : "",
                    d = r[n].split("|");
                if (d[0] = parseFloat(d[0]), d[1] = parseFloat(d[1]), void 0 !== e.splitAmount && e.splitAmount > 1) {
                    r[n] = "[" + (Math.random() * (d[1] - d[0]) + d[0]) + l;
                    for (var c = 0; c < e.splitAmount; c++) r[n] = r[n] + "|" + (Math.random() * (d[1] - d[0]) + d[0]) + l;
                    r[n] = r[n] + "]"
                } else r[n] = Math.random() * (d[1] - d[0]) + d[0] + l
            } else {
                r[n] = r[n].replace("[", "").replace("]", ""), r[n] = r[n].replace("cyc(", "").replace(")", "");
                var p = parseInt(r[n], 0);
                if (r[n].indexOf("%") >= 0 && jQuery.isNumeric(p)) "x" == n ? r[n] = f(t.eow * p / 100, e.frame.reverse, e.target, n, e.id) : "y" == n && (r[n] = f(t.eoh * p / 100, e.frame.reverse, e.target, n, e.id));
                else switch (r[n] = f(r[n], e.frame.reverse, e.target, n, e.id, e.id), r[n]) {
                    case "t":
                    case "top":
                        r[n] = 0 - t.eoh - ("column" === t.type ? 0 : t.calcy);
                        break;
                    case "b":
                    case "bottom":
                        r[n] = s - ("column" === t.type ? 0 : t.calcy);
                        break;
                    case "l":
                    case "left":
                        r[n] = 0 - t.eow - ("column" === t.type ? 0 : t.calcx);
                        break;
                    case "r":
                    case "right":
                        r[n] = o - ("column" === t.type ? 0 : t.calcx);
                        break;
                    case "m":
                    case "c":
                    case "middle":
                    case "center":
                        "x" === n && (r[n] = f(o / 2 - ("column" === t.type ? 0 : t.calcx) - t.eow / 2, e.frame.reverse, e.target, n, e.id)), "y" === n && (r[n] = f(s / 2 - ("column" === t.type ? 0 : t.calcy) - t.eoh / 2, e.frame.reverse, e.target, n, e.id))
                }
            }
            if (r.transformOrigin = a.originX + " " + a.originY + " " + a.originZ, !i[e.id].BUG_ie_clipPath && void 0 !== r.clip && void 0 !== t.clipPath && t.clipPath.use) {
                ...
                switch (t.clipPath.origin) {
                    case "invh":
                        r.clipPath = "polygon(0% 0%, 0% 100%, " + h + "% 100%, " + h + "% 0%, 100% 0%, 100% 100%, " + g + "% 100%, " + g + "% 0%, 0% 0%)";
                        break;
                    case "invv":
                        r.clipPath = "polygon(100% 0%, 0% 0%, 0% " + h + "%, 100% " + h + "%, 100% 100%, 0% 100%, 0% " + g + "%, 100% " + g + "%, 100% 0%)";
                        break;
                    case "cv":
                        r.clipPath = u ? "polygon(" + (50 - m) + "% 0%, " + (50 + m) + "% 0%, " + (50 + m) + "% 100%, " + (50 - m) + "% 100%)" : "circle(" + h + "% at 50% 50%)";
                        break;
                    case "ch":
                        r.clipPath = u ? "polygon(0% " + (50 - m) + "%, 0% " + (50 + m) + "%, 100% " + (50 + m) + "%, 100% " + (50 - m) + "%)" : "circle(" + h + "% at 50% 50%)";
                        break;
                    case "l":
                        r.clipPath = u ? "polygon(0% 0%, " + h + "% 0%, " + h + "% 100%, 0% 100%)" : "circle(" + h + "% at 0% 50%)";
                        break;
                    case "r":
                        r.clipPath = u ? "polygon(" + (100 - h) + "% 0%, 100% 0%, 100% 100%, " + (100 - h) + "% 100%)" : "circle(" + h + "% at 100% 50%)";
                        break;
                    case "t":
                        r.clipPath = u ? "polygon(0% 0%, 100% 0%, 100% " + h + "%, 0% " + h + "%)" : "circle(" + h + "% at 50% 0%)";
                        break;
                    case "b":
                        r.clipPath = u ? "polygon(0% 100%, 100% 100%, 100% " + (100 - h) + "%, 0% " + (100 - h) + "%)" : "circle(" + h + "% at 50% 100%)";
                        break;
                    case "lt":
                        r.clipPath = u ? "polygon(0% 0%," + 2 * h + "% 0%, 0% " + 2 * h + "%)" : "circle(" + h + "% at 0% 0%)";
                        break;
                    case "lb":
                        r.clipPath = u ? "polygon(0% " + (100 - 2 * h) + "%, 0% 100%," + 2 * h + "% 100%)" : "circle(" + h + "% at 0% 100%)";
                        break;
                    case "rt":
                        r.clipPath = u ? "polygon(" + (100 - 2 * h) + "% 0%, 100% 0%, 100% " + 2 * h + "%)" : "circle(" + h + "% at 100% 0%)";
                        break;
                    case "rb":
                        r.clipPath = u ? "polygon(" + (100 - 2 * h) + "% 100%, 100% 100%, 100% " + (100 - 2 * h) + "%)" : "circle(" + h + "% at 100% 100%)";
                        break;
                    case "clr":
                        r.clipPath = u ? "polygon(0% 0%, 0% " + h + "%, " + (100 - h) + "% 100%, 100% 100%, 100% " + (100 - h) + "%, " + h + "% 0%)" : "circle(" + h + "% at 50% 50%)";
                        break;
                    case "crl":
                        r.clipPath = u ? "polygon(0% " + (100 - h) + "%, 0% 100%, " + h + "% 100%, 100% " + h + "%, 100% 0%, " + (100 - h) + "% 0%)" : "circle(" + h + "% at 50% 50%)"
                }
                r["-webkit-clip-path"] = r.clipPath, delete r.clip
            } else delete r.clip;
            return "mask" !== e.target && (void 0 === e.frame || void 0 === e.frame.filter && !e.forcefilter || (r["-webkit-filter"] = "blur(" + (null == e.frame.filter ? 0 : e.frame.filter.blur || 0) + "px) grayscale(" + (null == e.frame.filter ? 0 : e.frame.filter.grayscale || 0) + "%) brightness(" + (null == e.frame.filter ? 100 : e.frame.filter.brightness || 100) + "%)", r.filter = "blur(" + (null == e.frame.filter ? 0 : e.frame.filter.blur || 0) + "px) grayscale(" + (null == e.frame.filter ? 0 : e.frame.filter.grayscale || 0) + "%) brightness(" + (null == e.frame.filter ? 100 : e.frame.filter.brightness || 100) + "%)"), jQuery.inArray(e.source, ["chars", "words", "lines"]) >= 0 && (void 0 !== e.frame[e.source].blur || e.forcefilter) && (r["-webkit-filter"] = "blur(" + (parseInt(e.frame[e.source].blur, 0) || 0) + "px) grayscale(" + (parseInt(e.frame[e.source].grayscale, 0) || 0) + "%) brightness(" + (parseInt(e.frame[e.source].brightness, 0) || 100) + "%)", r.filter = "blur(" + (parseInt(e.frame[e.source].blur, 0) || 0) + "px) grayscale(" + (parseInt(e.frame[e.source].grayscale, 0) || 0) + "%) brightness(" + (parseInt(e.frame[e.source].brightness, 0) || 100) + "%)")), r.ease = void 0 !== r.ease ? r.ease : void 0 === r.ease && void 0 !== e.ease || void 0 !== r.ease && void 0 !== e.ease && "inherit" === r.ease ? e.ease : e.frame.timeline.ease, r.ease = void 0 === r.ease || "default" === r.ease ? punchgs.Power3.easeInOut : r.ease, r
        },
        v = function(e) {
            var t;
        ...
        y = function(e, t) {
            ...
            switch (t) {
                ...
                case "middletoedge":
                    var n = Math.ceil(o / 2);
                    for (a = n - 1, r = n + 1, s.push(n), i = 0; i < n; i++) a >= 0 && s.push(a), r <= o && s.push(r), a--, r++;
                    break;
                case "e":
                case "edgetomiddle":
                    for (a = o, r = 0, i = 0; i <= Math.floor(o / 2); i++) s.push(a), r < a && s.push(r), a--, r++;
                    break;
                default:
                    for (i = 0; i <= o; i++) s.push(i)
            }
        ...
        b = function(e, t, r, a, o) {
            var s, n, l = {},
                d = {},
                c = {};
            for (var p in a = void 0 === a ? "transform" : a, "loop" === o ? (c.autoRotate = !1, c.yoyo_filter = !1, c.yoyo_rotate = !1, c.yoyo_move = !1, c.yoyo_scale = !1, c.curved = !1, c.curviness = 2, c.ease = "Linear.easeNone", c.speed = 1e3, c.st = 0, l.x = 0, l.y = 0, l.z = 0, l.xr = 0, l.yr = 0, l.zr = 0, l.scaleX = 1, l.scaleY = 1, l.originX = "50%", l.originY = "50%", l.originZ = "0", l.rotationX = "0deg", l.rotationY = "0deg", l.rotationZ = "0deg") : (c.speed = 300, r ? c.ease = "default" : l.ease = "default"), "sfx" === o && (l.fxc = "#ffffff"), e = e.split(";"))
            ...
            return jQuery.isEmptyObject(d) || ("split" === o ? l = jQuery.extend(!0, l, d) : h.filter = d), "split" === o && void 0 === l.dir && (l.dir = "forward"), jQuery.isEmptyObject(s) || (h.color = s), jQuery.isEmptyObject(n) || (h.bgcolor = n), h[a] = l, h
        },
        w = function(e, t) {
            var r = {},
                a = 0;
            ...
            for (var a in void 0 === e.frame_0 && (e.frame_0 = "x:0"), void 0 === e.frame_1 && (e.frame_1 = "x:0"), e.ford)
                if (e.ford.hasOwnProperty(a)) {
                    var s = e.ford[a];
                    if (e[s]) {
                        if (r[s] = b(e[s], t, !0), void 0 !== r[s].bgcolor && (e.bgcolinuse = !0), i[t].BUG_ie_clipPath && void 0 !== e.clipPath && e.clipPath.use && void 0 !== r[s].transform.clip) {
                            var n = "rectangle" === e.clipPath.type ? 100 - parseInt(r[s].transform.clip) : 100 - Math.min(100, 2 * parseInt(r[s].transform.clip));
                            switch (e.clipPath.origin) {
                                case "clr":
                                case "rb":
                                case "rt":
                                case "r":
                                    e[s + "_mask"] = "u:t;x:" + n + "%;y:0px;", r[s].transform.x = i.revToResp("-" + n + "%", i[t].rle);
                                    break;
                                case "crl":
                                case "lb":
                                case "lt":
                                ...
                                case "ch":
                                case "t":
                                    e[s + "_mask"] = "u:t;y:-" + n + "%;y:0px;", r[s].transform.y = i.revToResp(n + "%", i[t].rle);
                                    break;
                                case "b":
                                    e[s + "_mask"] = "u:t;y:" + n + "%;y:0px;", r[s].transform.y = i.revToResp("-" + n + "%", i[t].rle)
                            }
                            delete r[s].transform.clip, delete r[s].transform.clipB, e.maskinuse = !0
                        }
                        e[s + "_mask"] && (r[s].mask = b(e[s + "_mask"], t).transform), null != r[s].mask && r[s].mask.use ? (r[s].mask.x = void 0 === r[s].mask.x ? 0 : r[s].mask.x, r[s].mask.y = void 0 === r[s].mask.y ? 0 : r[s].mask.y, delete r[s].mask.use, r[s].mask.overflow = "hidden") : r[s].mask = {
                            ease: "default",
                            overflow: "visible"
                        }, e[s + "_chars"] && (r[s].chars = b(e[s + "_chars"], t, void 0, void 0, "split").transform), e[s + "_words"] && (r[s].words = b(e[s + "_words"], t, void 0, void 0, "split").transform), e[s + "_lines"] && (r[s].lines = b(e[s + "_lines"], t, void 0, void 0, "split").transform), (e[s + "_chars"] || e[s + "_words"] || e[s + "_lines"]) && (r[s].split = !0), r.frame_0 = void 0 === r.frame_0 ? {
                            transform: {}
                        } : r.frame_0, r[s].transform.auto && (r[s].transform = jQuery.extend(!0, {}, r.frame_0.transform), r[s].transform.opacity = void 0 === r[s].transform.opacity ? 0 : r[s].transform.opacity, void 0 !== r.frame_0.filter && (r[s].filter = jQuery.extend(!0, {}, r.frame_0.filter)), void 0 !== r.frame_0.mask && (r[s].mask = jQuery.extend(!0, {}, r.frame_0.mask)), void 0 !== r.frame_0.chars && (r[s].chars = jQuery.extend(!0, {}, r.frame_0.chars)), void 0 !== r.frame_0.words && (r[s].words = jQuery.extend(!0, {}, r.frame_0.words)), void 0 !== r.frame_0.lines && (r[s].lines = jQuery.extend(!0, {}, r.frame_0.lines))), e[s + "_sfx"] && (r[s].sfx = b(e[s + "_sfx"], t, !1, void 0, "sfx").transform), e[s + "_reverse"] && (r[s].reverse = b(e[s + "_reverse"], t, !1, void 0, "reverse").transform)
                    }
                }
            if (r.frame_0.split && (r.frame_1.split = !0), void 0 !== r.frame_0.transform.fpr && (e.forceRender = r.frame_0.transform.fpr, delete r.frame_0.transform.fpr), void 0 === e.frame_hover && void 0 === e.svgh || (r.frame_hover = b(void 0 === e.frame_hover ? "" : e.frame_hover, t), r.frame_hover.transform.color = r.frame_hover.color, void 0 === r.frame_hover.transform.color && delete r.frame_hover.transform.color, void 0 !== r.frame_hover.bgcolor && r.frame_hover.bgcolor.indexOf("gradient") >= 0 ? r.frame_hover.transform.backgroundImage = r.frame_hover.bgcolor : void 0 !== r.frame_hover.bgcolor && (r.frame_hover.transform.backgroundColor = r.frame_hover.bgcolor), void 0 !== r.frame_hover.bgcolor && (e.bgcolinuse = !0), r.frame_hover.transform.opacity = void 0 === r.frame_hover.transform.opacity ? 1 : r.frame_hover.transform.opacity, r.frame_hover.mask = void 0 !== r.frame_hover.transform.mask && r.frame_hover.transform.mask, delete r.frame_hover.transform.mask, void 0 !== r.frame_hover.transform && ((r.frame_hover.transform.borderWidth || r.frame_hover.transform.borderStyle) && (r.frame_hover.transform.borderColor = void 0 === r.frame_hover.transform.borderColor ? "transparent" : r.frame_hover.transform.borderColor), "none" !== r.frame_hover.transform.borderStyle && void 0 === r.frame_hover.transform.borderWidth && (r.frame_hover.transform.borderWidth = i.revToResp(0, 4, 0).toString().replace(/,/g, " ")), void 0 === e.bordercolor && void 0 !== r.frame_hover.transform.borderColor && (e.bordercolor = "transparent"), void 0 === e.borderwidth && void 0 !== r.frame_hover.transform.borderWidth && (e.borderwidth = i.revToResp(r.frame_hover.transform.borderWidth, 4, 0)), void 0 === e.borderstyle && void 0 !== r.frame_hover.transform.borderStyle && (e.borderstyle = i.revToResp(r.frame_hover.transform.borderStyle, 4, 0)))), void 0 !== e.tloop) {
                e.layerLoop = {
                    from: "frame_1",
                    to: "frame_999",
                    repeat: -1,
            ...
            for (var a in (e.loop_0 || e.loop_999) && (r.loop = b(e.loop_999, t, !0, "frame_999", "loop"), r.loop.frame_0 = b(e.loop_0 || "", t, !1, void 0, "loop").transform), r.frame_0.transform.opacity = void 0 === r.frame_0.transform.opacity ? 0 : r.frame_0.transform.opacity, r.frame_1.transform.opacity = void 0 === r.frame_1.transform.opacity ? 1 : r.frame_1.transform.opacity, r.frame_999.transform.opacity = void 0 === r.frame_999.transform.opacity ? "inherit" : r.frame_999.transform.opacity, r.frame_0.transform.transformPerspective = void 0 === r.frame_0.transform.transformPerspective ? "600px" : r.frame_0.transform.transformPerspective, e.clipPath && e.clipPath.use && (r.frame_0.transform.clip = void 0 === r.frame_0.transform.clip ? 100 : parseInt(r.frame_0.transform.clip), r.frame_1.transform.clip = void 0 === r.frame_1.transform.clip ? 100 : parseInt(r.frame_1.transform.clip)), e.resetfilter = !1, r) void 0 !== r[a].filter && (e.resetfilter = !0);
        ...
        _ = function(e) {
            ...
            for (var a in e) "loop" !== a && "frame_hover" !== a && (i = jQuery.extend(!0, i, e[a]));
            for (var a in e)
                if (e.hasOwnProperty(a) && "loop" !== a && "frame_hover" !== a) {
                    for (t in i.transform) i.transform.hasOwnProperty(t) && (i.transform[t] = void 0 === e[a].transform[t] ? "frame_0" === a ? window.rdF0.transform[t] : "frame_1" === a ? window.rdF1.transform[t] : i.transform[t] : e[a].transform[t], e[a].transform[t] = void 0 === e[a].transform[t] ? i.transform[t] : e[a].transform[t]);
                    for (var o = 1; o <= 4; o++)
                        for (t in i[r[o]]) i[r[o]].hasOwnProperty(t) && (e[a][r[o]] = void 0 === e[a][r[o]] ? {} : e[a][r[o]], i[r[o]][t] = void 0 === e[a][r[o]][t] ? "frame_0" === a ? window.rdF0[r[o]][t] : "frame_1" === a ? window.rdF1[r[o]][t] : i[r[o]][t] : e[a][r[o]][t], e[a][r[o]][t] = void 0 === e[a][r[o]][t] ? i[r[o]][t] : e[a][r[o]][t])
                }
            return e
        },
        x = function(e, t) {
            if (0 === e.length) return {};
            for (var i = e[0].getElementsByClassName(t), r = {}, a = 0; a < i.length; a++) r[i[a].id] = i[a];
            return r
        },
        k = function(e, t, r) {
            if ("BR" == e[0].nodeName || "br" == e[0].tagName || "object" != typeof e[0].className && e[0].className.indexOf("rs_splitted_") >= 0) return !1;
            i.sA(e[0], "stylerecorder", !0);
            var a = window.getComputedStyle(e[0], null),
                o = void 0 !== e[0].id && void 0 !== i[r]._L[e[0].id] ? i[r]._L[e[0].id] : e.data(),
                s = "rekursive" === t ? e.closest(".rs-layer") : void 0,
                n = void 0 !== s && a.fontSize === s.css("fontSize") && a.fontWeight === s.css("fontWeight") && a.lineHeight === s.css("lineHeight"),
                l = n ? void 0 !== s[0].id && void 0 !== i[r]._L[s[0].id] ? i[r]._L[s[0].id] : s.data() : void 0,
                d = 0;
            o.basealign = void 0 === o.basealign ? "grid" : o.basealign, o._isnotext || (o.fontSize = i.revToResp(n ? void 0 === l.fontsize ? parseInt(s.css("fontSize"), 0) || 20 : l.fontsize : void 0 === o.fontsize ? "rekursive" !== t ? 20 : "inherit" : o.fontsize, i[r].rle), o.fontWeight = i.revToResp(n ? void 0 === l.fontweight ? s.css("fontWeight") || "inherit" : l.fontweight : void 0 === o.fontweight ? e.css("fontWeight") || "inherit" : o.fontweight, i[r].rle), o.whiteSpace = i.revToResp(n ? void 0 === l.whitespace ? "nowrap" : l.whitespace : void 0 === o.whitespace ? "nowrap" : o.whitespace, i[r].rle), o.textAlign = i.revToResp(n ? void 0 === l.textalign ? "left" : l.textalign : void 0 === o.textalign ? "left" : o.textalign, i[r].rle), o.letterSpacing = i.revToResp(n ? void 0 === l.letterspacing ? parseInt(s.css("letterSpacing"), 0) || "inherit" : l.letterspacing : void 0 === o.letterspacing ? parseInt(e.css("letterSpacing"), 0) || "inherit" : o.letterspacing, i[r].rle), o.textDecoration = n ? void 0 === l.textDecoration ? "none" : l.textDecoration : void 0 === o.textDecoration ? "none" : o.textDecoration, d = 25, d = void 0 !== s && "I" === e[0].tagName ? "inherit" : d, void 0 !== o.tshadow && (o.tshadow.b = i.revToResp(o.tshadow.b, i[r].rle), o.tshadow.h = i.revToResp(o.tshadow.h, i[r].rle), o.tshadow.v = i.revToResp(o.tshadow.v, i[r].rle))), void 0 !== o.bshadow && (o.bshadow.b = i.revToResp(o.bshadow.b, i[r].rle), o.bshadow.h = i.revToResp(o.bshadow.h, i[r].rle), o.bshadow.v = i.revToResp(o.bshadow.v, i[r].rle), o.bshadow.s = i.revToResp(o.bshadow.s, i[r].rle)), o.display = n ? void 0 === l.display ? s.css("display") : l.display : void 0 === o.display ? e.css("display") : o.display, o.float = i.revToResp(n ? void 0 === l.float ? s.css("float") || "none" : l.float : void 0 === o.float ? "none" : o.float, i[r].rle), o.clear = i.revToResp(n ? void 0 === l.clear ? s.css("clear") || "none" : l.clear : void 0 === o.clear ? "none" : o.clear, i[r].rle), o.lineHeight = i.revToResp(e.is("img") || -1 != jQuery.inArray(o.layertype, ["video", "image", "audio"]) ? d : n ? void 0 === l.lineheight ? parseInt(s.css("lineHeight"), 0) || d : l.lineheight : void 0 === o.lineheight ? d : o.lineheight, i[r].rle), o.zIndex = n ? void 0 === l.zindex ? parseInt(s.css("zIndex"), 0) || "inherit" : l.zindex : void 0 === o.zindex ? parseInt(e.css("zIndex"), 0) || "inherit" : o.zindex, o.paddingTop = i.revToResp(void 0 === o.paddingtop ? parseInt(a.paddingTop, 0) || 0 : o.paddingtop, i[r].rle), o.paddingBottom = i.revToResp(void 0 === o.paddingbottom ? parseInt(a.paddingBottom, 0) || 0 : o.paddingbottom, i[r].rle), o.paddingLeft = i.revToResp(void 0 === o.paddingleft ? parseInt(a.paddingLeft, 0) || 0 : o.paddingleft, i[r].rle), o.paddingRight = i.revToResp(void 0 === o.paddingright ? parseInt(a.paddingRight, 0) || 0 : o.paddingright, i[r].rle), o.marginTop = i.revToResp(void 0 === o.margintop ? parseInt(a.marginTop, 0) || 0 : o.margintop, i[r].rle), o.marginBottom = i.revToResp(void 0 === o.marginbottom ? parseInt(a.marginBottom, 0) || 0 : o.marginbottom, i[r].rle), o.marginLeft = i.revToResp(void 0 === o.marginleft ? parseInt(a.marginLeft, 0) || 0 : o.marginleft, i[r].rle), o.marginRight = i.revToResp(void 0 === o.marginright ? parseInt(a.marginRight, 0) || 0 : o.marginright, i[r].rle), o.borderTopWidth = void 0 === o.borderwidth ? parseInt(a.borderTopWidth, 0) || 0 : o.borderwidth[0], o.borderBottomWidth = void 0 === o.borderwidth ? parseInt(a.borderBottomWidth, 0) || 0 : o.borderwidth[2], o.borderLeftWidth = void 0 === o.borderwidth ? parseInt(a.borderLeftWidth, 0) || 0 : o.borderwidth[3], o.borderRightWidth = void 0 === o.borderwidth ? parseInt(a.borderRightWidth, 0) || 0 : o.borderwidth[1], o.borderTopLeftRadius = i.revToResp(void 0 === o.borderradius ? a.borderTopLeftRadius || 0 : o.borderradius[0], i[r].rle), o.borderTopRightRadius = i.revToResp(void 0 === o.borderradius ? a.borderTopRightRadius || 0 : o.borderradius[1], i[r].rle), o.borderBottomLeftRadius = i.revToResp(void 0 === o.borderradius ? a.borderBottomLeftRadius || 0 : o.borderradius[3], i[r].rle), o.borderBottomRightRadius = i.revToResp(void 0 === o.borderradius ? a.borderBottomRightRadius || 0 : o.borderradius[2], i[r].rle), o.borderStyle = i.revToResp(void 0 === o.borderstyle ? a.borderStyle || 0 : o.borderstyle, i[r].rle), o.borderBottomColor = void 0 === o.bordercolor ? a["border-bottom-color"] : o.bordercolor, o.borderTopColor = void 0 === o.bordercolor ? a["border-top-color"] : o.bordercolor, o.borderLeftColor = void 0 === o.bordercolor ? a["border-left-color"] : o.bordercolor, o.borderRightColor = void 0 === o.bordercolor ? a["border-right-color"] : o.bordercolor, "rekursive" !== t ? (o.color = i.revToResp(void 0 === o.color ? "#ffffff" : o.color, i[r].rle, void 0, "||"), o.minWidth = i.revToResp(void 0 === o.minwidth ? parseInt(a.minWidth, 0) || 0 : o.minwidth, i[r].rle), o.minHeight = i.revToResp(void 0 === o.minheight ? parseInt(a.minHeight, 0) || 0 : o.minheight, i[r].rle), o.width = i.revToResp(void 0 === o.width ? "auto" : i.smartConvertDivs(o.width), i[r].rle), o.height = i.revToResp(void 0 === o.height ? "auto" : i.smartConvertDivs(o.height), i[r].rle), o.maxWidth = i.revToResp(void 0 === o.maxwidth ? parseInt(a.maxWidth, 0) || "none" : o.maxwidth, i[r].rle), o.maxHeight = i.revToResp(-1 !== jQuery.inArray(o.type, ["column", "row"]) ? "none" : void 0 !== o.maxheight ? parseInt(a.maxHeight, 0) || "none" : o.maxheight, i[r].rle)) : "html" === o.layertype && (o.width = i.revToResp(e[0].width, i[r].rle), o.height = i.revToResp(e[0].height, i[r].rle)), o.styleProps = {
                background: e[0].style.background,
                "background-color": e[0].style["background-color"],
                color: e[0].style.color,
                cursor: e[0].style.cursor,
                "font-style": e[0].style["font-style"]
            }, null == o.bshadow && (o.styleProps.boxShadow = e[0].style.boxShadow), "" !== o.styleProps.background && void 0 !== o.styleProps.background && o.styleProps.background !== o.styleProps["background-color"] || delete o.styleProps.background, "" == o.styleProps.color && (o.styleProps.color = a.color)
        },
        T = function(e, t) {
            if (void 0 !== e) {
                if ("BR" == e[0].nodeName || "br" == e[0].tagName) return !1;
                var r = i[t].level,
                    a = void 0 !== e[0] && void 0 !== e[0].id && void 0 !== i[t]._L[e[0].id] ? i[t]._L[e[0].id] : e.data(),
                    o = {
                        basealign: void 0 === (a = void 0 === a.basealign ? e.closest("rs-layer").data() : a).basealign ? "grid" : a.basealign,
                        lineHeight: void 0 === a.basealign ? "inherit" : parseInt(a.lineHeight[r]),
                        color: void 0 === a.color ? void 0 : a.color[r],
                        width: void 0 === a.width ? void 0 : "a" === a.width[r] ? "auto" : a.width[r],
                        height: void 0 === a.height ? void 0 : "a" === a.height[r] ? "auto" : a.height[r],
                        minWidth: void 0 === a.minWidth ? void 0 : "n" === a.minWidth[r] ? "none" : a.minWidth[r],
                        minHeight: void 0 === a.minHeight ? void 0 : "n" == a.minHeight[r] ? "none" : a.minHeight[r],
                        maxWidth: void 0 === a.maxWidth ? void 0 : "n" == a.maxWidth[r] ? "none" : a.maxWidth[r],
                        maxHeight: void 0 === a.maxHeight ? void 0 : "n" == a.maxHeight[r] ? "none" : a.maxHeight[r],
                        paddingTop: a.paddingTop[r],
                        paddingBottom: parseInt(a.paddingBottom[r]),
                        paddingLeft: parseInt(a.paddingLeft[r]),
                        paddingRight: parseInt(a.paddingRight[r]),
                        marginTop: parseInt(a.marginTop[r]),
                        marginBottom: parseInt(a.marginBottom[r]),
                        marginLeft: parseInt(a.marginLeft[r]),
                        marginRight: parseInt(a.marginRight[r]),
                        borderTopWidth: parseInt(a.borderTopWidth),
                        borderBottomWidth: parseInt(a.borderBottomWidth),
                        borderLeftWidth: parseInt(a.borderLeftWidth),
                        borderRightWidth: parseInt(a.borderRightWidth),
                        borderTopLeftRadius: a.borderTopLeftRadius[r],
                        borderTopRightRadius: a.borderTopRightRadius[r],
                        borderBottomLeftRadius: a.borderBottomLeftRadius[r],
                        borderBottomRightRadius: a.borderBottomRightRadius[r],
                        borderStyle: a.borderStyle[r],
                        float: a.float[r],
                        clear: a.clear[r]
                    };
                return o.borderTopColor = a.borderTopColor, o.borderBottomColor = a.borderBottomColor, o.borderLeftColor = a.borderLeftColor, o.borderRightColor = a.borderRightColor, a._isnotext || (o.textDecoration = a.textDecoration, o.fontSize = parseInt(a.fontSize[r]), o.fontWeight = parseInt(a.fontWeight[r]), o.letterSpacing = parseInt(a.letterSpacing[r]) || 0, o.textAlign = a.textAlign[r], o.whiteSpace = a.whiteSpace[r], o.whiteSpace = "normal" === o.whiteSpace && "auto" === o.width && !0 !== a._incolumn ? "nowrap" : o.whiteSpace, o.display = a.display, void 0 !== a.tshadow && (o.textShadow = parseInt(a.tshadow.h[r], 0) + "px " + parseInt(a.tshadow.v[r], 0) + "px " + a.tshadow.b[r] + " " + a.tshadow.c), void 0 !== a.tstroke && (o.textStroke = parseInt(a.tstroke.w, 0) + "px " + a.tstroke.c)), void 0 !== a.bshadow && (o.boxShadow = parseInt(a.bshadow.h[r], 0) + "px " + parseInt(a.bshadow.v[r], 0) + "px " + parseInt(a.bshadow.b[r], 0) + "px " + parseInt(a.bshadow.s[r], 0) + "px " + a.bshadow.c), o
            }
        },
        L = function(e, t, i, r, a) {
            var o = jQuery.isNumeric(e) || void 0 === e ? "" : e.indexOf("px") >= 0 ? "px" : e.indexOf("%") >= 0 ? "%" : "";
            return e = jQuery.isNumeric(parseInt(e)) ? parseInt(e) : e, e = null == (e = "full" === (e = jQuery.isNumeric(e) ? e * t + o : e) ? r : "auto" === e || "none" === e ? i : e) ? a : e
        },
        R = function(e, t, r, a) {
            var o = i[t]._L[e[0].id];
            o = void 0 === o ? {} : o;
        ...
        A = function(e, t, i, r) {
            ...
            switch (e) {
                ...
                case "bottom":
                    ...
                    break;
                case "two":
                    a = i + "% 100%," + t + "% 75%," + i + "% 50%," + t + "% 25%," + i + "% 0%";
                    break;
                case "three":
                    a = t + "% 100%," + i + "% 75%," + t + "% 50%," + i + "% 25%," + t + "% 0%";
                    break;
                case "four":
                    a = t + "% 100%," + i + "% 87.5%," + t + "% 75%," + i + "% 62.5%," + t + "% 50%," + i + "% 37.5%," + t + "% 25%," + i + "% 12.5%," + t + "% 0%";
                    break;
                case "five":
                    a = t + "% 100%," + i + "% 90%," + t + "% 80%," + i + "% 70%," + t + "% 60%," + i + "% 50%," + t + "% 40%," + i + "% 30%," + t + "% 20%," + i + "% 10%," + t + "% 0%"
            }
            if (r) {
                var o = a.split(",");
                for (var i in a = "", o) o.hasOwnProperty(i) && (a += o[o.length - 1 - i] + (i < o.length - 1 ? "," : ""))
            }
            return a
        }
}(jQuery),
function(e) {
    ...
    function r(e, i) {
        ...
        return r.mask = r.c.find(".tp-" + i + "-mask"), r.wrap = r.c.find(".tp-" + i + "s-inner-wrapper"), r
    }
    jQuery.extend(!0, t, {
        hideUnHideNav: function(e) {
            var i = t[e].c.width(),
                r = t[e].navigation.arrows,
                a = t[e].navigation.bullets,
                o = t[e].navigation.thumbnails,
                s = t[e].navigation.tabs;
            p(r) && k(t[e].c.find(".tparrows"), r.hide_under, i, r.hide_over), p(a) && k(t[e].c.find(".tp-bullets"), a.hide_under, i, a.hide_over), p(o) && k(o.c, o.hide_under, i, o.hide_over), p(s) && k(s.c, s.hide_under, i, s.hide_over), x(e)
        },
        resizeThumbsTabs: function(e, i) {
            if (void 0 !== t[e] && t[e].navigation.use && (t[e].navigation && t[e].navigation.bullets.enable || t[e].navigation && t[e].navigation.tabs.enable || t[e].navigation && t[e].navigation.thumbnails.enable)) {
                var r = (jQuery(window).width() - 480) / 500,
                    a = new punchgs.TimelineLite,
                    s = t[e].navigation.tabs,
                    n = t[e].navigation.thumbnails,
                    l = t[e].navigation.bullets;
                if (a.pause(), r = r > 1 ? 1 : r < 0 ? 0 : r, p(s) && (i || s.width > s.min_width) && o(r, a, t[e].c, s, t[e].slideamount, "tab"), p(n) && (i || n.width > n.min_width) && o(r, a, t[e].c, n, t[e].slideamount, "thumb"), p(l) && i) {
                    var d = t[e].c.find(".tp-bullets");
                    d.find(".tp-bullet").each(function(e) {
                        var t = jQuery(this),
                            i = e + 1,
                            r = t.outerWidth() + parseInt(void 0 === l.space ? 0 : l.space, 0),
                            a = t.outerHeight() + parseInt(void 0 === l.space ? 0 : l.space, 0);
                        "vertical" === l.direction ? (t.css({
                            top: (i - 1) * a + "px",
                            left: "0px"
                        }), d.css({
                            height: (i - 1) * a + t.outerHeight(),
                            width: t.outerWidth()
                        })) : (t.css({
                            left: (i - 1) * r + "px",
                            top: "0px"
                        }), d.css({
                            width: (i - 1) * r + t.outerWidth(),
        ...
        createNavigation: function(e) {
            ...
            s(e), n(e), y && (m(o, e), o.c = t[e].cpar.find(".tparrows")), t[e].slides.each(function(i) {
                if (-1 === this.className.indexOf("not-in-nav")) {
                    var r = jQuery(t[e].slides[t[e].slides.length - 1 - i]),
                        a = jQuery(this);
                    b && (t[e].navigation.bullets.rtl ? w(t[e].c, l, r, e) : w(t[e].c, l, a, e)), x && (t[e].navigation.thumbnails.rtl ? _(t[e].c, f, r, "tp-thumb", e) : _(t[e].c, f, a, "tp-thumb", e)), k && (t[e].navigation.tabs.rtl ? _(t[e].c, v, r, "tp-tab", e) : _(t[e].c, v, a, "tp-tab", e))
                }
            }), b && (l.c = t[e].cpar.find(".tp-bullets")), x && jQuery.extend(!0, f, r(e, "thumb")), k && jQuery.extend(!0, v, r(e, "tab")), t[e].c.bind("revolution.slide.onafterswap revolution.nextslide.waiting", function(i) {
                if (void 0 !== t[e].pr_next_key || void 0 !== t[e].pr_active_key) {
                    var r = void 0 === t[e].pr_next_key ? t.gA(t[e].slides[t[e].pr_active_key], "key") : t.gA(t[e].slides[t[e].pr_next_key], "key");
                    t[e].c.find(".tp-bullet").each(function() {
                        t.gA(this, "key") === r ? this.classList.add("selected") : this.classList.remove("selected")
                    }), t[e].cpar.find(".tp-thumb, .tp-tab").each(function() {
                        t.gA(this, "key") === r ? (this.classList.add("selected"), "RS-TAB" === this.nodeName ? a(v, e) : a(f, e)) : this.classList.remove("selected")
                    });
                    var s = 0,
                        n = !1;
                    t[e].thumbs && jQuery.each(t[e].thumbs, function(e, t) {
                        s = !1 === n ? e : s, n = void 0 !== t && t.id === r || e === r || n
                    });
            ...
            }), c(o), c(l), c(f), c(v), t[e].cpar.on("mouseenter mousemove", function(r) {
    ...
    var a = function(e, i) {
            var r = "vertical" === e.direction ? e.mask.find(e.single).first().outerHeight(!0) + e.space : e.mask.find(e.single).first().outerWidth(!0) + e.space,
            ...
            s > 2 && (c = l - (p + r) <= 0 ? l - (p + r) < 0 - r ? p : c + r : c, c = l - r + p + a < r && l + (Math.round(s) - 2) * r < p ? l + (Math.round(s) - 2) * r : c), c = "vertical" !== e.direction && e.mask.width() >= e.wrap.width() || "vertical" === e.direction && e.mask.height() >= e.wrap.height() ? 0 : c < 0 - (d - n) ? 0 - (d - n) : c > 0 ? 0 : c, e.c.hasClass("dragged") || ("vertical" === e.direction ? e.wrap.data("tmmove", punchgs.TweenLite.to(e.wrap, .5, {
                top: c + "px",
                ease: punchgs.Power3.easeInOut
        ...
        o = function(e, t, i, r, a, o) {
            var s = i.parent().find(".tp-" + o + "s"),
                n = s.find(".tp-" + o + "s-inner-wrapper"),
                l = s.find(".tp-" + o + "-mask"),
                d = r.width * e < r.min_width ? r.min_width : Math.round(r.width * e),
                c = Math.round(d / r.width * r.height),
                p = "vertical" === r.direction ? d : d * a + r.space * (a - 1),
                u = "vertical" === r.direction ? c * a + r.space * (a - 1) : c,
                h = "vertical" === r.direction ? {
                    width: d + "px"
                } : {
                    height: c + "px"
                };
            ...
            return g && jQuery.each(g, function(e, i) {
                "vertical" === r.direction ? t.add(punchgs.TweenLite.set(i, {
                    top: e * (c + parseInt(void 0 === r.space ? 0 : r.space, 0)),
                    width: d + "px",
                    height: c + "px"
                })) : "horizontal" === r.direction && t.add(punchgs.TweenLite.set(i, {
                    left: e * (d + parseInt(void 0 === r.space ? 0 : r.space, 0)),
                    width: d + "px",
                    height: c + "px"
                }))
            }), t
        ...
        n = function(e) {
            if (!0 === t[e].navigation.mouseScrollNavigation || "on" === t[e].navigation.mouseScrollNavigation || "carousel" === t[e].navigation.mouseScrollNavigation) {
                ...
                var i = t[e].ischrome ? -49 : t[e].isIEEleven || t[e].isSafari ? -9 : navigator.userAgent.match(/mozilla/i) ? -29 : -49,
                    r = t[e].ischrome ? 49 : t[e].isIEEleven || t[e].isSafari ? 9 : navigator.userAgent.match(/mozilla/i) ? 29 : 49;
                t[e].c.on("mousewheel DOMMouseScroll", function(a) {
                    var o, s, n, l, d, c = (o = a.originalEvent, s = 0, n = 0, l = 0, d = 0, "detail" in o && (n = o.detail), "wheelDelta" in o && (n = -o.wheelDelta / 120), "wheelDeltaY" in o && (n = -o.wheelDeltaY / 120), "wheelDeltaX" in o && (s = -o.wheelDeltaX / 120), "axis" in o && o.axis === o.HORIZONTAL_AXIS && (s = n, n = 0), l = 1 * s, d = 1 * n, "deltaY" in o && (d = o.deltaY), "deltaX" in o && (l = o.deltaX), (l || d) && o.deltaMode && (o.deltaMode, l *= 1, d *= 1), l && !s && (s = l < 1 ? -1 : 1), d && !n && (n = d < 1 ? -1 : 1), ((d = navigator.userAgent.match(/mozilla/i) ? 10 * d : d) > 300 || d < -300) && (d /= 10), {
                            spinX: s,
                            spinY: n,
                            pixelX: l,
                            pixelY: d
                    ...
                    "carousel" == t[e].navigation.mouseScrollNavigation && (u = h = !1), void 0 === t[e].pr_processing_key ? c.pixelY < i ? (u || (t[e].sc_indicator = "arrow", "reverse" !== t[e].navigation.mouseScrollReverse && (t[e].sc_indicator_dir = 1, t.callingNewSlide(e, -1)), p = !1), h || (t[e].sc_indicator = "arrow", "reverse" === t[e].navigation.mouseScrollReverse && (t[e].sc_indicator_dir = 0, t.callingNewSlide(e, 1)), p = !1)) : c.pixelY > r && (h || (t[e].sc_indicator = "arrow", "reverse" !== t[e].navigation.mouseScrollReverse && (t[e].sc_indicator_dir = 0, t.callingNewSlide(e, 1)), p = !1), u || (t[e].sc_indicator = "arrow", "reverse" === t[e].navigation.mouseScrollReverse && (t[e].sc_indicator_dir = 1, t.callingNewSlide(e, -1)), p = !1)) : p = !1;
                    var g = t[e].c.offset().top - jQuery("body").scrollTop(),
                        f = g + t[e].c.height();
                    return "carousel" != t[e].navigation.mouseScrollNavigation ? ("reverse" !== t[e].navigation.mouseScrollReverse && (g > 0 && c.pixelY > 0 || f < jQuery(window).height() && c.pixelY < 0) && (p = !0), "reverse" === t[e].navigation.mouseScrollReverse && (g < 0 && c.pixelY < 0 || f > jQuery(window).height() && c.pixelY > 0) && (p = !0)) : p = !1, p ? void 0 : (a.preventDefault(a), !1)
                })
            }
        },
        l = function(e, t, r) {
            return !0 === (e = i ? jQuery(r.target).closest(e).length || jQuery(r.srcElement).closest(e).length : jQuery(r.toElement).closest(e).length || jQuery(r.originalTarget).closest(e).length) || 1 === e ? 1 : 0
        },
        d = function(e, r, a) {
            var o = t[r].carousel;
            jQuery(".bullet, .bullets, .tp-bullets, .tparrows").addClass("noSwipe"), o.Limit = "endless";
            var s = e,
                n = "vertical" === t[r].navigation.thumbnails.direction || "vertical" === t[r].navigation.tabs.direction ? "none" : "vertical",
                d = t[r].navigation.touch.swipe_direction || "horizontal";
            n = "swipebased" == a && "vertical" == d ? "none" : a ? "vertical" : n, jQuery.fn.swipetp || (jQuery.fn.swipetp = jQuery.fn.swipe), jQuery.fn.swipetp.defaults && jQuery.fn.swipetp.defaults.excludedElements || jQuery.fn.swipetp.defaults || (jQuery.fn.swipetp.defaults = {}), jQuery.fn.swipetp.defaults.excludedElements = "label, button, input, select, textarea, .noSwipe", s.swipetp({
                allowPageScroll: n,
                triggerOnTouchLeave: !0,
                treshold: t[r].navigation.touch.swipe_treshold,
                fingers: t[r].navigation.touch.swipe_min_touches > 5 ? 1 : t[r].navigation.touch.swipe_min_touches,
                excludeElements: jQuery.fn.swipetp.defaults.excludedElements,
                swipeStatus: function(a, s, n, c, p, u, h) {
                    var g = l("rs-module-wrap", 0, a),
                        f = l(".tp-thumbs", 0, a),
                        m = l(".tp-tabs", 0, a),
                        v = !!jQuery(this).attr("class").match(/tp-tabs|tp-thumb/gi);
                    if ("carousel" === t[r].sliderType && (("move" === s || "end" === s || "cancel" == s) && t[r].dragStartedOverSlider && !t[r].dragStartedOverThumbs && !t[r].dragStartedOverTabs || "start" === s && g > 0 && 0 === f && 0 === m)) {
                        if (i && ("up" === n || "down" === n)) return;
                        switch (void 0 !== o.positionanim && o.positionanim.pause(), t[r].dragStartedOverSlider = !0, c = n && n.match(/left|up/g) ? Math.round(-1 * c) : c = Math.round(1 * c), s) {
                            case "start":
                                ...
                                break;
                            case "move":
                                if (Math.abs(c) >= 10 || t[r].carousel.isDragged) {
                                    if (t[r].carousel.isDragged = !0, t[r].c.find(".rs-waction").addClass("tp-temporarydisabled"), o.slide_offset = "off" === o.infinity ? o.slide_globaloffset + c : t.simp(o.slide_globaloffset + c, o.maxwidth), "off" === o.infinity) {
                                        ...
                                        "none" !== o.overpull && 0 !== o.overpull || !(y < 0 || y > t[r].slideamount - 1) ? y >= 0 && y <= t[r].slideamount - 1 && (y >= 0 && c > o.overpull || y <= t[r].slideamount - 1 && c < o.overpull) && (o.overpull = 0) : o.overpull = c, o.slide_offset = y < 0 ? o.slide_offset + (o.overpull - c) / 1.1 + Math.sqrt(Math.abs((o.overpull - c) / 1.1)) : y > t[r].slideamount - 1 ? o.slide_offset + (o.overpull - c) / 1.1 - Math.sqrt(Math.abs((o.overpull - c) / 1.1)) : o.slide_offset
                                    }
                                    t.organiseCarousel(r, n, !0, !0)
                                }
                                break;
                            case "end":
                            case "cancel":
                                t[r].carousel.isDragged = !1, o.slide_globaloffset = o.slide_offset, o.wrap.removeClass("dragged"), t.carouselToEvalPosition(r, n), t[r].dragStartedOverSlider = !1, t[r].dragStartedOverThumbs = !1, t[r].dragStartedOverTabs = !1, setTimeout(function() {
                                    t[r].c.find(".rs-waction").removeClass("tp-temporarydisabled")
                                }, 19)
                        }
                    } else {
                        if (("move" !== s && "end" !== s && "cancel" != s || t[r].dragStartedOverSlider || !t[r].dragStartedOverThumbs && !t[r].dragStartedOverTabs) && !("start" === s && g > 0 && (f > 0 || m > 0))) {
                            if ("end" == s && !v) {
                                if (t[r].sc_indicator = "arrow", "horizontal" == d && "left" == n || "vertical" == d && "up" == n) return t[r].sc_indicator_dir = 0, t.callingNewSlide(r, 1), !1;
                                if ("horizontal" == d && "right" == n || "vertical" == d && "down" == n) return t[r].sc_indicator_dir = 1, t.callingNewSlide(r, -1), !1
                            }
                            return t[r].dragStartedOverSlider = !1, t[r].dragStartedOverThumbs = !1, t[r].dragStartedOverTabs = !1, !0
                        }
                        f > 0 && (t[r].dragStartedOverThumbs = !0), m > 0 && (t[r].dragStartedOverTabs = !0);
                        var b = t[r].dragStartedOverThumbs ? ".tp-thumbs" : ".tp-tabs",
                            w = t[r].dragStartedOverThumbs ? ".tp-thumb-mask" : ".tp-tab-mask",
                            _ = t[r].dragStartedOverThumbs ? ".tp-thumbs-inner-wrapper" : ".tp-tabs-inner-wrapper",
                            x = t[r].dragStartedOverThumbs ? ".tp-thumb" : ".tp-tab",
                            k = t[r].dragStartedOverThumbs ? t[r].navigation.thumbnails : t[r].navigation.tabs;
                        ...
                        var T = e.parent().find(w),
                            ...
                            z = "vertical" === R ? T.find(x).first().outerHeight(!0) + k.space : T.find(x).first().outerWidth(!0) + k.space,
                            S = void 0 === L.data("offset") ? 0 : parseInt(L.data("offset"), 0),
                            M = 0;
                        switch (s) {
                            case "start":
                                e.parent().find(b).addClass("dragged"), S = "vertical" === R ? L.position().top : L.position().left, L.data("offset", S), L.data("tmmove") && L.data("tmmove").pause();
                                break;
                            case "move":
                                if (I <= A) return !1;
                                M = (M = S + c) > 0 ? "horizontal" === R ? M - L.width() * (M / L.width() * M / L.width()) : M - L.height() * (M / L.height() * M / L.height()) : M;
                            ...
                            case "cancel":
                                if (v) return M = S + c, M = (M = "vertical" === R ? M < 0 - (L.height() - T.height()) ? 0 - (L.height() - T.height()) : M : M < 0 - (L.width() - T.width()) ? 0 - (L.width() - T.width()) : M) > 0 ? 0 : M, M = Math.abs(c) > z / 10 ? c <= 0 ? Math.floor(M / z) * z : Math.ceil(M / z) * z : c < 0 ? Math.ceil(M / z) * z : Math.floor(M / z) * z, M = (M = "vertical" === R ? M < 0 - (L.height() - T.height()) ? 0 - (L.height() - T.height()) : M : M < 0 - (L.width() - T.width()) ? 0 - (L.width() - T.width()) : M) > 0 ? 0 : M, "vertical" === R ? punchgs.TweenLite.to(L, .5, {
                                    ...
                                    t[r].dragStartedOverSlider = !1, t[r].dragStartedOverThumbs = !1, t[r].dragStartedOverTabs = !1
        ...
        h = function(e) {
            ...
            for (var r in i) i.hasOwnProperty(r) && p(t[e].navigation[i[r]]) && (u(t[e].navigation[i[r]].showCall), t[e].navigation[i[r]].showCall = setTimeout(function(i) {
                u(i.hideCall), i.hide_onleave && !t[e].cpar.hasClass("tp-mouseover") || (void 0 === i.tween ? i.tween = f(i) : i.tween.play())
            }, t[e].navigation[i[r]].hide_onleave && !t[e].cpar.hasClass("tp-mouseover") ? 0 : parseInt(t[e].navigation[i[r]].animDelay), t[e].navigation[i[r]]))
        },
        g = function(e, r) {
            var a = t[e].navigation.maintypes;
            for (var o in a) a.hasOwnProperty(o) && void 0 !== t[e].navigation[a[o]] && t[e].navigation[a[o]].hide_onleave && p(t[e].navigation[a[o]]) && (u(t[e].navigation[a[o]].hideCall), t[e].navigation[a[o]].hideCall = setTimeout(function(e) {
                u(e.showCall), e.tween && e.tween.reverse()
            }, i ? parseInt(t[e].navigation[a[o]].hide_delay_mobile, 0) : parseInt(t[e].navigation[a[o]].hide_delay, 0), t[e].navigation[a[o]]))
        },
        f = function(e) {
        ...
        m = function(e, i) {
            ...
            var r = t[i].c.find(".tp-leftarrow.tparrows"),
                a = t[i].c.find(".tp-rightarrow.tparrows");
            e.rtl ? (r.click(function() {
                ...
                "carousel" === t[i].sliderType && (t[i].ctNavElement = !0), t[i].sc_indicator = "arrow", t[i].sc_indicator_dir = 1, t[i].c.revprev()
            })), e.right.j = t[i].c.find(".tp-rightarrow.tparrows"), e.left.j = t[i].c.find(".tp-leftarrow.tparrows"), e.padding_top = parseInt(t[i].carousel.padding_top || 0, 0), e.padding_bottom = parseInt(t[i].carousel.padding_bottom || 0, 0), b(r, e.left, i), b(a, e.right, i), "outer-left" != e.position && "outer-right" != e.position || (t[i].outernav = !0)
        },
        v = function(e, i, r) {
            var a = e.outerHeight(!0),
                o = null == t[r] ? 0 : 0 == t[r].conh ? t[r].height : t[r].conh,
                s = "layergrid" == i.container ? "fullscreen" == t[r].sliderLayout ? t[r].height / 2 - t[r].gridheight[t[r].level] * t[r].bh / 2 : t[r].autoHeight || null != t[r].minHeight && t[r].minHeight > 0 ? o / 2 - t[r].gridheight[t[r].level] * t[r].bh / 2 : 0 : 0,
                n = "top" === i.v_align ? {
                    top: "0px",
                    y: Math.round(i.v_offset + s) + "px"
                } : "center" === i.v_align ? {
                    top: "50%",
                    y: Math.round(0 - a / 2 + i.v_offset) + "px"
                } : {
                    top: "100%",
                    y: Math.round(0 - (a + i.v_offset + s)) + "px"
                };
            e.hasClass("outer-bottom") || punchgs.TweenLite.set(e, n)
        },
        y = function(e, i, r) {
            var a = e.outerWidth(!0),
                o = "layergrid" === i.container ? t[r].width / 2 - t[r].gridwidth[t[r].level] * t[r].bw / 2 : 0,
                s = "left" === i.h_align ? {
                    left: "0px",
                    x: Math.round(i.h_offset + o) + "px"
                } : "center" === i.h_align ? {
                    left: "50%",
                    x: Math.round(0 - a / 2 + i.h_offset) + "px"
                } : {
                    left: "100%",
                    x: Math.round(0 - (a + i.h_offset + o)) + "px"
                };
            punchgs.TweenLite.set(e, s)
        },
        b = function(e, i, r) {
            var a = "fullwidth" == t[r].sliderLayout || "fullscreen" == t[r].sliderLayout,
                o = a ? t[r].c.width() : t[r].topc.width(),
                s = t[r].c.height();
            if (v(e, i, r), y(e, i, r), "outer-left" === i.position && a ? punchgs.TweenLite.set(e, {
                    left: 0 - e.outerWidth() + "px",
                    x: i.h_offset + "px"
                }) : "outer-right" === i.position && a && punchgs.TweenLite.set(e, {
                ...
                var n = e.data("wr_padding"),
                    ...
                    h = {},
                    g = {};
                l > o && "outer-left" !== i.position && "outer-right" !== i.position ? (h.left = "0px", h.x = 0, h.maxWidth = o - 2 * n + "px", g.maxWidth = o - 2 * n + "px") : (h.maxWidth = l, g.maxWidth = o + "px"), d + 2 * n > s && "outer-bottom" !== i.position && "outer-top" !== i.position ? (h.top = "0px", h.y = 0, h.maxHeight = p + u + (s - 2 * n) + "px", g.maxHeight = p + u + (s - 2 * n) + "px") : (h.maxHeight = d + "px", g.maxHeight = d + "px"), i.span ? ("layergrid" == i.container && "outer-left" !== i.position && "outer-right" !== i.position && (p = u = 0), "vertical" === i.direction ? (h.maxHeight = p + u + (s - 2 * n) + "px", h.height = p + u + (s - 2 * n) + "px", h.top = 0 - p, h.y = 0, g.maxHeight = p + u + Math.min(d, s - 2 * n) + "px", punchgs.TweenLite.set(e, h), punchgs.TweenLite.set(c, g), v(c, i, r)) : "horizontal" === i.direction && (h.maxWidth = "100%", h.width = o - 2 * n + "px", h.left = 0, h.x = 0, g.maxWidth = l >= o ? "100%" : Math.min(l, o) + "px", punchgs.TweenLite.set(e, h), punchgs.TweenLite.set(c, g), y(c, i, r))) : (punchgs.TweenLite.set(e, h), punchgs.TweenLite.set(c, g))
            }
        },
        w = function(e, i, r, a) {
            ...
            var o = e.find(".tp-bullets"),
                s = r.data("key"),
                n = i.tmp;
            void 0 !== t[a].thumbs[r.index()] && jQuery.each(t[a].thumbs[r.index()].params, function(e, t) {
            ...
            })), void 0 !== t[a].thumbs[r.index()] && l.find(".tp-bullet-image").css({
                backgroundImage: "url(" + t[a].thumbs[r.index()].src + ")"
            }), l.click(function() {
                t[a].sc_indicator = "bullet", e.revcallslidewithid(s), e.find(".tp-bullet").removeClass("selected"), jQuery(this).addClass("selected")
            }), l.removeClass("justaddedbullet"), i.padding_top = parseInt(t[a].carousel.padding_top || 0, 0), i.padding_bottom = parseInt(t[a].carousel.padding_bottom || 0, 0), "outer-left" != i.position && "outer-right" != i.position || (t[a].outernav = !0), o.addClass("nav-pos-hor-" + i.h_align), o.addClass("nav-pos-ver-" + i.v_align), o.addClass("nav-dir-" + i.direction), b(o, i, a)
        },
        _ = function(e, i, r, a, o) {
            var s = "tp-thumb" === a ? ".tp-thumbs" : ".tp-tabs",
                n = "tp-thumb" === a ? ".tp-thumb-mask" : ".tp-tab-mask",
                l = "tp-thumb" === a ? ".tp-thumbs-inner-wrapper" : ".tp-tabs-inner-wrapper",
                d = "tp-thumb" === a ? ".tp-thumb" : ".tp-tab",
                c = "tp-thumb" === a ? ".tp-thumb-image" : ".tp-tab-image",
                p = "tp-thumb" === a ? "rs-thumb" : "rs-tab";
            if (i.visibleAmount = i.visibleAmount > t[o].slideamount ? t[o].slideamount : i.visibleAmount, i.sliderLayout = t[o].sliderLayout, 0 === e.parent().find(s).length) {
                ...
                var u = "<" + p + 's style="opacity:0" class="' + a + "s " + (!0 === i.span ? "tp-span-wrapper" : "") + " " + i.position + " " + i.style + '"><rs-navmask class="' + a + '-mask"><' + p + 's-wrap class="' + a + 's-inner-wrapper" style="position:relative;"></' + p + "s-wrap></rs-navmask></" + p + "s>";
            ...
            var h = r.data("key"),
                ...
                w = i.tmp;
            void 0 !== t[o].thumbs[r.index()] && jQuery.each(t[o].thumbs[r.index()].params, function(e, t) {
                w = w.replace(t.from, t.to)
            }), m.append("<" + p + ' data-liindex="' + r.index() + '" data-key="' + h + '" class="justaddedthumb ' + a + '" style="width:' + i.width + "px;height:" + i.height + 'px;">' + w + "<" + p + ">");
            ...
            _.find(c).css({
                backgroundImage: "url(" + t[o].thumbs[r.index()].src + ")"
        ...
        x = function(e) {
            var i = t[e].cpar.find(".outer-top"),
                r = t[e].cpar.find(".outer-bottom");
            t[e].top_outer = i.hasClass("tp-forcenotvisible") ? 0 : i.outerHeight() || 0, t[e].bottom_outer = r.hasClass("tp-forcenotvisible") ? 0 : r.outerHeight() || 0
        },
        k = function(e, t, i, r) {
            t > i || i > r ? e.addClass("tp-forcenotvisible") : e.removeClass("tp-forcenotvisible")
        }
}(jQuery),
function(e) {
    "use strict";
    ...
    jQuery.extend(!0, t, {
        ...
        startPanZoom: function(e, i, r) {
            var a = e.data(),
                o = e.find("rs-sbg"),
                s = o.data("lazyload") || o.data("src"),
                n = (a.owidth, a.oheight, "carousel" === t[i].sliderType ? t[i].carousel.slide_width : t[i].canvas.width()),
                l = t[i].canvas.height();
            if (void 0 !== a.panzoom && null !== a.panzoom) {
                if (e.data("pztl") && e.data("pztl").kill(), r = r || 0, 0 == e.find(".rs-pzimg").length) {
                    var d = o.data("mediafilter");
                    d = void 0 === d ? "" : d, e.append('<rs-pzimg-wrap class="' + d + '" style="z-index:2;width:100%;height:100%;top:0px;left:0px;position:absolute;display:block"><img class="rs-pzimg" src="' + s + '" style="position:absolute;" width="' + a.owidth + '" height="' + a.oheight + '"></rs-pzimg-wrap>'), e.data("pzimg", e.find(".rs-pzimg"))
                }
                var c = function(e, t, i, r, a, o, s) {
                    var n = e * i,
                        l = t * i,
                        d = Math.abs(r - n),
                        c = Math.abs(a - l),
                ...
                var p = e.data("pzimg"),
                    u = p.parent(),
                    h = function(e, t, i) {
                        var r = void 0 === i.panvalues ? jQuery.extend(!0, {}, function(e) {
                            ...
                            s = {
                                start: {
                                    ...
                                    rotation: r.rotatestart + "deg",
                                    scale: r.scalestart,
                                    transformOrigin: i.bgposition
                                },
                                starto: {},
                                end: {
                                    rotation: r.rotateend + "deg",
                                    scale: r.scaleend
                                },
                                endo: {}
                            };
                        r.scalestart, i.owidth, i.oheight, r.scaleend, i.owidth, i.oheight;
                        if (s.start.height < t) {
                            var n = t / s.start.height;
                            s.start.height = t, s.start.width = s.start.width * n
                        }
                        var l = function(e, t, i, r) {
                            var a = e.bgposition.split(" ") || "center center",
                                o = "center" == a[0] ? "50%" : "left" == a[0] || "left" == a[1] ? "0%" : "right" == a[0] || "right" == a[1] ? "100%" : a[0],
                                s = "center" == a[1] ? "50%" : "top" == a[0] || "top" == a[1] ? "0%" : "bottom" == a[0] || "bottom" == a[1] ? "100%" : a[1];
                            o = parseInt(o, 0) / 100 || 0, s = parseInt(s, 0) / 100 || 0;
                            var n = new Object;
                            return n.start = c(r.start.width, r.start.height, r.start.scale, t, i, o, s), n.end = c(r.start.width, r.start.height, r.end.scale, t, i, o, s), n
                        }(i, e, t, s);
                        a[0] = parseFloat(a[0]) + l.start.l, o[0] = parseFloat(o[0]) + l.end.l, a[1] = parseFloat(a[1]) + l.start.t, o[1] = parseFloat(o[1]) + l.end.t;
                        var d = l.start.r - l.start.l,
                            p = l.start.b - l.start.t,
                            u = l.end.r - l.end.l,
                            h = l.end.b - l.end.t;
                        return a[0] = a[0] > 0 ? 0 : d + a[0] < e ? e - d : a[0], o[0] = o[0] > 0 ? 0 : u + o[0] < e ? e - u : o[0], a[1] = a[1] > 0 ? 0 : p + a[1] < t ? t - p : a[1], o[1] = o[1] > 0 ? 0 : h + o[1] < t ? t - h : o[1], s.starto.x = a[0] + "px", s.starto.y = a[1] + "px", s.endo.x = o[0] + "px", s.endo.y = o[1] + "px", s.end.ease = s.endo.ease = r.ease, s.end.force3D = s.endo.force3D = !0, s
                    }(n, l, a),
                    g = new punchgs.TimelineLite;
                if (g.pause(), h.start.transformOrigin = "0% 0%", h.starto.transformOrigin = "0% 0%", a.panvalues.duration = NaN === a.panvalues.duration || void 0 === a.panvalues.duration ? 10 : a.panvalues.duration, g.add(punchgs.TweenLite.fromTo(p, a.panvalues.duration, h.start, h.end), 0), g.add(punchgs.TweenLite.fromTo(u, a.panvalues.duration, h.starto, h.endo), 0), void 0 !== a.panvalues.blurstart && void 0 !== a.panvalues.blurend && (0 !== a.panvalues.blurstart || 0 !== a.panvalues.blurend)) {
                    var f = {
                            a: a.panvalues.blurstart
                        },
                        m = {
                            a: a.panvalues.blurend,
                            ease: h.endo.ease
                        },
                        v = new punchgs.TweenLite(f, a.panvalues.duration, m);
                ...
                g.progress(r), g.play(), e.data("pztl", g)
            }
        }
    })
}(jQuery),
    ...
    jQuery.extend(!0, t, {
        checkForParallax: function(e) {
            ...
            if (!r.done) {
                ...
                if (("3D" == r.type || "3d" == r.type) && (punchgs.TweenLite.set(t[e].c, {
                        overflow: r.ddd_overflow
                    }), punchgs.TweenLite.set(t[e].canvas, {
                        overflow: r.ddd_overflow
                    }), "carousel" != t[e].sliderType && r.ddd_shadow)) {
                    var a = jQuery('<div class="dddwrappershadow"></div>');
                ...
                t[e].slides.each(function() {
                    n(jQuery(this))
                }), ("3D" == r.type || "3d" == r.type) && t[e].c.find("rs-static-layers").length > 0 && (punchgs.TweenLite.set(t[e].c.find("rs-static-layers"), {
                    top: 0,
                    left: 0,
                    width: "100%",
                    height: "100%"
                }), n(t[e].c.find("rs-static-layers"))), r.pcontainers = [], r.pcontainer_depths = [], r.bgcontainers = [], r.bgcontainer_depths = [], r.speed = void 0 === r.speed ? 0 : parseInt(r.speed, 0), r.speedbg = void 0 === r.speedbg ? 0 : parseInt(r.speedbg, 0), r.speedls = void 0 === r.speedls ? 0 : parseInt(r.speedls, 0), t[e].c.find("rs-slide rs-sbg-wrap, rs-slide rs-bgvideo").each(function() {
                    var i = jQuery(this),
                        a = i.data("parallax");
                ...
                for (var o = 1; o <= r.levels.length; o++) t[e].c.find(".rs-pxl-" + o).each(function() {
                    var e = jQuery(this),
                        t = this.className.indexOf("rs-pxmask") >= 0 ? e.closest("rs-px-mask") : e.closest(".rs-parallax-wrap");
                    t.data("parallaxlevel", r.levels[o - 1]), t.addClass("tp-parallax-container"), r.pcontainers.push(t), r.pcontainer_depths.push(r.levels[o - 1])
                });
                "mouse" != r.type && "mousescroll" != r.type && "3D" != r.type && "3d" != r.type || (t[e].c.mouseenter(function(i) {
                    var r = t[e].c.offset().top,
                        a = t[e].c.offset().left;
                    void 0 !== t[e].pr_active_key && (t.sA(t[e].slides[t[e].pr_active_key], "enterx", i.pageX - a), t.sA(t[e].slides[t[e].pr_active_key], "entery", i.pageY - r))
                }), t[e].c.on("mousemove.hoverdir, mouseleave.hoverdir, trigger3dpath", function(i, a) {
                    var o = a && a.li ? a.li : jQuery(t[e].slides[t[e].pr_active_key]);
                    if ("enterpoint" == r.origo) {
                        ...
                        var l = o.data("enterx") || i.pageX - n,
                            ...
                            p = d - (i.pageY - s),
                            u = r.speed / 1e3 || .4
                    } else s = t[e].c.offset().top, n = t[e].c.offset().left, c = t[e].conw / 2 - (i.pageX - n), p = t[e].conh / 2 - (i.pageY - s), u = r.speed / 1e3 || 3;
                    "mouseleave" == i.type && (c = r.ddd_lasth || 0, p = r.ddd_lastv || 0, u = 1.5);
                    for (var h = 0; h < r.pcontainers.length; h++) {
                        var g = r.pcontainers[h],
                            f = r.pcontainer_depths[h],
                            m = "3D" == r.type || "3d" == r.type ? f / 200 : f / 100,
                            v = c * m,
                            y = p * m;
                        "mousescroll" == r.type ? punchgs.TweenLite.to(g, u, {
                            force3D: "auto",
                            x: v,
                            ease: punchgs.Power3.easeOut,
                            overwrite: "all"
                    ...
                    if ("3D" == r.type || "3d" == r.type) {
                        ...
                        "carousel" === t[e].sliderType && (b = "rs-slide .dddwrapper, rs-slide .dddwrapper-layer, rs-static-layers .dddwrapper-layer"), t[e].c.find(b).each(function() {
                            var a = jQuery(this),
                                o = r.levels[r.levels.length - 1] / 200,
                                s = c * o,
                                n = p * o,
                                l = 0 == t[e].conw ? 0 : Math.round(c / t[e].conw * o * 100) || 0,
                                d = 0 == t[e].conh ? 0 : Math.round(p / t[e].conh * o * 100) || 0,
                                h = a.closest("rs-slide"),
                                g = 0,
                                f = !1;
                            a.hasClass("dddwrapper-layer") && (g = r.ddd_z_correction || 65, f = !0), a.hasClass("dddwrapper-layer") && (s = 0, n = 0), h.index() === t[e].pr_active_key || "carousel" != t[e].sliderType ? !r.ddd_bgfreeze || f ? punchgs.TweenLite.to(a, u, {
                                rotationX: d,
                                rotationY: -l,
                                x: s,
                                z: g,
                    ...
                    if (s.find(".tp-parallax-container").each(function(e) {
                        ...
                        "carousel" === t[e].sliderType && (g = "rs-slide .dddwrapper, rs-slide .dddwrapper-layer, rs-static-layers .dddwrapper-layer"), t[e].c.find(g).each(function() {
                            var a = jQuery(this),
                                ...
                                g = 0,
                                f = !1;
                            a.hasClass("dddwrapper-layer") && (g = r.ddd_z_correction || 65, f = !0), a.hasClass("dddwrapper-layer") && (s = 0, n = 0), h.hasClass("active-rs-slide") || "carousel" != t[e].sliderType ? !r.ddd_bgfreeze || f ? punchgs.TweenLite.to(a, u, {
                                rotationX: d,
                                rotationY: -l,
                                x: s,
                                z: g,
            ...
            function n(i) {
                if ("3D" == r.type || "3d" == r.type) {
                    i.find("rs-sbg-wrap").wrapAll('<div class="dddwrapper" style="width:100%;height:100%;position:absolute;top:0px;left:0px;overflow:hidden"></div>'), i.find(".rs-parallax-wrap").wrapAll('<div class="dddwrapper-layer" style="width:100%;height:100%;position:absolute;top:0px;left:0px;z-index:5;overflow:' + r.ddd_layer_overflow + ';"></div>'), i.find(".rs-pxl-tobggroup").closest(".rs-parallax-wrap").wrapAll('<div class="dddwrapper-layertobggroup" style="position:absolute;top:0px;left:0px;z-index:50;width:100%;height:100%"></div>');
                    var a = i.find(".dddwrapper"),
                        o = i.find(".dddwrapper-layer");
                    i.find(".dddwrapper-layertobggroup").appendTo(a), "carousel" == t[e].sliderType && (r.ddd_shadow && a.addClass("dddwrappershadow"), punchgs.TweenLite.set(a, {
        ...
        scrollHandling: function(e, r, a, o) {
            if (void 0 !== t[e]) {
                if (t[e].lastwindowheight = t[e].lastwindowheight || window.innerHeight, t[e].conh = 0 === t[e].conh || void 0 === t[e].conh ? t[e].infullscreenmode ? t[e].minHeight : t[e].c.height() : t[e].conh, t[e].lastscrolltop == window.scrollY && !t[e].duringslidechange && !r) return !1;
                ...
                if ("3d" != l.type && "3D" != l.type) {
                    ...
                    if (l.bgcontainers)
                        for (f = 0; f < l.bgcontainers.length; f++) {
                            ...
                            y = c * (-l.bgcontainer_depths[f] * t[e].conh) || 0, b = void 0 !== a ? a : l.speedbg / 1e3 || .015;
...
function(e) {
    ...
    var i = function(e, t) {
        ...
        r = function(e) {
            var r = e.id,
                o = "arrow" == t[r].sc_indicator ? void 0 === t[r].sc_indicator_dir ? t[r].sdir : t[r].sc_indicator_dir : t[r].sdir,
                s = !0 === e.recall ? jQuery.extend(!0, {}, t[r].lastSliderTransition) : function(e, i, r) {
                    var a = "Power1.easeIn",
                        o = "Power1.easeOut",
                        s = "Power1.easeInOut",
                        n = "Power2.easeIn",
                        ...
                        m = [
                            ...
                            ["parallaxcirclesup", 31, 0, 1, "horizontal", !0, !0, 51, d, a, 1500, 1],
                            ["parallaxcirclesdown", 32, 0, 1, "horizontal", !0, !0, 52, d, a, 1500, 1],
                            ["parallaxcirclesright", 33, 0, 1, "horizontal", !0, !0, 53, d, a, 1500, 1],
                            ["parallaxcirclesleft", 34, 0, 1, "horizontal", !0, !0, 54, d, a, 1500, 1],
                            ...
                            ["parallaxup", 14, 3, 1, "horizontal", !0, !0, 57, d, a, 1500, 1],
                            ["parallaxdown", 13, 3, 1, "horizontal", !0, !0, 58, d, a, 1500, 1],
                    ...
                    return t[e].duringslidechange = !0, jQuery.each(["parallaxcircles", "slidingoverlay", "slide", "slideover", "slideremove", "parallax", "parralaxto"], function(e, t) {
                        i == t + "horizontal" && (i = 1 != r ? t + "left" : t + "right"), i == t + "vertical" && (i = 1 != r ? t + "up" : t + "down")
            ...
            t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_active_bg.find("rs-sbg"), {
                ...
                opacity: c
            }), 0), t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_next_bg.find("rs-sbg"), {
                scale: 1,
                rotationX: 0,
                rotationY: 0,
                rotationZ: 0,
                ...
                clearProps: "filter, transform",
                opacity: p
            }), 0), t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_next_bg, {
                ...
                y: 0,
                clearProps: "filter, transform"
            }), 0), t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_active_bg, {
                transformOrigin: "50% 50% 0",
                transformPerspective: 600,
                scale: 1,
                rotationX: 0,
                ...
                y: 0,
                clearProps: "filter, transform"
            }), 0), t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_next_bg.parent(), {
                backgroundColor: "transparent"
            }), 0), t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_active_bg.parent(), {
                backgroundColor: "transparent"
            }), 0);
            ...
            if (u = "default" === u || "d" === u ? s.TR[8] || punchgs.Power2.easeInOut : u || s.TR[8] || punchgs.Power2.easeInOut, h = "default" === h || "d" === h ? s.TR[9] || punchgs.Power2.easeInOut : h || s.TR[9] || punchgs.Power2.easeInOut, 0 == n) {
                var g = Math.ceil(t[r].height / t[r].sloth),
                    f = 0;
                t[r].pr_next_bg.find(".slotslide").each(function(e) {
                    f = ++f === g ? 0 : f, t[r].rotate = 1 === s.trC ? 45 : t[r].rotate, t[r].mtl.add(punchgs.TweenLite.from(this, d / 2e3, {
                        opacity: 0,
                        transformStyle: "flat",
                        transformPerspective: 600,
                        scale: 0,
            ...
            } else if (1 == n) t[r].pr_next_bg.find(".slotslide").each(function(e) {
                t[r].mtl.add(punchgs.TweenLite.from(this, (Math.random() * d + 300) / 1e3, {
                    autoAlpha: 0,
                    force3D: "auto",
                    rotation: t[r].rotate,
                    ease: u
            ...
            else if (2 == n || 3 == n) t[r].pr_active_bg.find(".slotslide").each(function() {
                t[r].mtl.add(punchgs.TweenLite.to(this, d / 1e3, {
                    top: 3 === n ? t[r].sloth : 0,
                    left: 2 === n ? t[r].slotw : 0,
                    ease: u,
                    force3D: "auto",
                    rotation: 0 - t[r].rotate
                }), 0)
            }), t[r].pr_next_bg.find(".slotslide").each(function() {
                t[r].mtl.add(punchgs.TweenLite.from(this, d / 1e3, {
                    top: 3 == n ? 1 === o ? 0 - t[r].sloth : t[r].sloth : 0,
                    left: 2 == n ? 1 === o ? 0 - t[r].slotw : t[r].slotw : 0,
                    ease: u,
                    force3D: "auto",
                    rotation: t[r].rotate
                }), 0)
                ...
                var m = new punchgs.TimelineLite,
                    v = d / 1e3 - d / 1e3 / t[r].slots;
                t[r].slots -= t[r].slots % 2 == 1 ? 1 : 0, t[r].pr_active_bg.find(".slotslide").each(function(e) {
                    var i = 6 !== n ? e : e > t[r].slots / 2 ? t[r].slots - e : e;
                    m.add(punchgs.TweenLite.to(this, v, {
                        transformPerspective: 600,
                        force3D: "auto",
                        top: 1 !== o ? t[r].height : -t[r].height,
                        opacity: .75,
                        rotation: t[r].rotate,
                        ease: u,
                        delay: (5 !== n ? i : t[r].slots - i) * (v / t[r].slots) / (6 === n ? 1.3 : 1)
                    }), 0), t[r].mtl.add(m, 0)
                }), t[r].pr_next_bg.find(".slotslide").each(function(e) {
                    var i = 6 !== n ? e : e > t[r].slots / 2 ? t[r].slots - e : e;
            ...
            } else if (7 == n || 8 == n) d = Math.min(t[r].duration || d, d), t[r].pr_active_bg.find(".slotslide").each(function(e) {
                var i = e > t[r].slots / 2 ? t[r].slots - e : e;
                t[r].mtl.add(punchgs.TweenLite.to(this.getElementsByTagName("div"), d / 1e3, {
                    x: 8 === n && 0 === s.trC ? 0 : i * t[r].slotw / 3,
                    y: 8 === n && 0 === s.trC ? i * t[r].sloth / 3 : 0,
                    ease: u,
                    transformPerspective: 600,
                    force3D: "auto",
                    filter: "blur(2px)",
                ...
                var i = e > t[r].slots / 2 ? t[r].slots - e : e;
                t[r].mtl.add(punchgs.TweenLite.fromTo(this.getElementsByTagName("div"), d / 1e3, {
                    x: 8 === n && 0 === s.trC ? 0 : 0 - i * t[r].slotw / 3,
                    y: 8 === n && 0 === s.trC ? 0 - i * t[r].sloth / 3 : 0,
                    filter: "blur(2px)",
                    opacity: 0,
                    transformPerspective: 600,
                    scale: 1.2
                ...
                for (var y = t[r].pr_next_bg[0].getElementsByClassName("slotslide"), b = d - d / 1.8, w = 0; w < y.length; w++) t[r].mtl.add(punchgs.TweenLite.fromTo(y[w], (d - w * (b / t[r].slots)) / 1e3, {
                    opacity: 0,
                    force3D: "auto",
                    transformPerspective: 600
                }, {
                ...
                switch (s.trC) {
                    case 0:
                        t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_next_bg, d / 1e3, {
                            autoAlpha: 0
                        }, {
                            autoAlpha: 1,
                            force3D: "auto",
                    ...
                    case 1:
                        t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_next_bg, d / 1e3, {
                            ...
                            force3D: "auto",
                            ease: u
                        }), 0), t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_active_bg, d / 1e3, {
                            autoAlpha: 1
                        }, {
                            autoAlpha: 0,
                            force3D: "auto",
                    ...
                    case 3:
                    case 4:
                        t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_active_bg.parent(), {
                            backgroundColor: _,
                            force3D: "auto"
                        }), 0), t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_next_bg.parent(), {
                            backgroundColor: "transparent",
                            force3D: "auto"
                        }), 0), t[r].mtl.add(punchgs.TweenLite.to(t[r].pr_active_bg, d / 2e3, {
                            autoAlpha: 0,
                            force3D: "auto",
                            ease: u
                        }), 0), t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_next_bg, d / 2e3, {
                            autoAlpha: 0
                        }, {
                            autoAlpha: 1,
                            force3D: "auto",
                    ...
                    case 12:
                        ...
                        t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_next_bg, d / 1e3, {
                            ...
                            force3D: "auto",
                            ease: u
                        }), 0), jQuery.inArray(s.trC, [6, 8, 10]) >= 0 && t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_active_bg, d / 1e3, {
                            autoAlpha: 1,
                            filter: k,
                            "-webkit-filter": k
                        }, {
                ...
                t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_next_bg.find("rs-sbg"), {
                    autoAlpha: 1
                }), 0), t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_active_bg.find("rs-sbg"), {
                    autoAlpha: 1
                }), 0)
            } else if (12 == n || 13 == n || 14 == n || 15 == n) {
                var T = 3 == s.trC ? d / 1300 : d / 1e3,
                    L = d / 1e3,
                    R = 5 == s.trC || 6 == s.trC ? 0 : t[r].width,
                    I = 5 == s.trC || 6 == s.trC ? 0 : t[r].currentSlideHeight,
                    A = 12 == n ? R : 15 == n ? 0 - R : 0,
                    z = 13 == n ? 5 == s.trC || 6 == s.trC ? 0 : t[r].height : 14 == n ? 5 == s.trC || 6 == s.trC ? 0 : 0 - t[r].height : 0,
                    S = 1 == s.trC || 2 == s.trC || 5 == s.trC || 6 == s.trC ? 0 : 1,
                    M = 4 == s.trC || 5 == s.trC ? .6 : 6 == s.trC ? 1.4 : 1,
                    O = 5 == s.trC ? 1.4 : 6 == s.trC ? .6 : 1;
                if (7 != s.trC && 4 != s.trC || (R = 0, I = 0), 8 == s.trC ? (t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_active_slide, {
                        zIndex: 20
                    }), 0), t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_next_slide, {
                        zIndex: 15
                    }), 0), t[r].mtl.add(punchgs.TweenLite.to(t[r].pr_next_bg, .01, {
                        overflow: "hidden",
                        left: 0,
                        top: 0,
                        x: 0,
                        ...
                        immediateRender: !0,
                        force3D: "auto"
                    }), 0)) : (t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_active_slide, {
                        zIndex: 15
                    }), 0), t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_next_slide, {
                        zIndex: 20
                    }), 0), t[r].mtl.add(punchgs.TweenLite.from(t[r].pr_next_bg, T, {
                        left: A,
                        top: z,
                        overflow: "hidden",
                        scale: O,
                    ...
                    case 12:
                        t[r].mtl.add(punchgs.TweenLite.to(t[r].pr_active_bg, L, {
                            left: 0 - R + "px",
                            overflow: "hidden",
                            force3D: "auto",
                            scale: M,
                ...
                t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_active_slide, {
                    zIndex: 20
                }), 0), t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_next_slide, {
                    zIndex: 15
                }), 0), t[r].pr_active_bg.find(".slotslide").each(function(e) {
                    t[r].mtl.add(punchgs.TweenLite.fromTo(this, d / 1e3, {
                        left: 0,
                        rotationZ: 0,
                        opacity: 1,
                        top: 0,
                        ...
                        opacity: 1,
                        left: 1 === o ? 0 == e ? -t[r].width / 1.6 : -t[r].width / 1.8 : 0 === e ? t[r].width / 1.6 : t[r].width / 1.8,
                        ...
                        delay: 0,
                        ease: u
                    }), 0), t[r].mtl.add(punchgs.TweenLite.fromTo(this, d / 2e3, {
                        opacity: 1
                    }, {
                        opacity: 0,
                        delay: d / 2e3
                    }), 0)
                }), t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_next_bg, d / 1e3 - d / 7e3, {
            ...
            } else if (17 == n || 18 == n) t[r].pr_next_bg.find(".slotslide").each(function(e) {
                t[r].mtl.add(punchgs.TweenLite.fromTo(this, d / t[r].slots / 1e3, {
                    opacity: 0,
                    top: 0,
                    left: 0,
                    rotationY: 17 === n ? 0 : 90,
                ...
                C = 19 === n ? "center center -" + t[r].height / 2 : 22 === n ? "center center " + t[r].height / 2 : 23 === n ? "center center -" + t[r].width / 2 : "center center " + t[r].width / 2;
                punchgs.TweenLite.set(t[r].c, {
                    transformStyle: "flat",
                    backfaceVisibility: "hidden",
                    transformPerspective: 600
                }), t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_next_bg, d / 1e3, {
                ...
                }), 0), 22 !== n && 24 !== n || t[r].mtl.add(punchgs.TweenLite.fromTo([t[r].pr_active_bg, t[r].pr_next_bg], d / 2e3, {
                    z: -200
                }, {
                    z: 0,
                    ease: "Power2.easeIn",
                    delay: d / 2e3
                }), 0), t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_active_bg, d / 2e3, {
                    z: 0
                }, {
                    z: -200,
                    ease: "Power3.easeInOut",
                    delay: 0,
                    force3D: "auto"
                }), 0), 19 !== n && 23 !== n || t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_active_bg, d / 2e3, {
                    autoAlpha: 1
                }, {
                    autoAlpha: 0,
                ...
                C = 1 === o ? "20% " : "80% ";
                C += "60% -50%", t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_next_bg, d / 1e3, {
                    left: 1 === o ? -t[r].width : t[r].width,
                    rotationX: 20,
                    z: -t[r].width,
                    autoAlpha: 0,
                    top: 0,
                    ...
                    delay: 0,
                    ease: u
                }), 0), C = 1 != o ? "20% " : "80% ", C += "60% -50%", t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_active_bg, d / 1e3, {
                    autoAlpha: 1,
                    rotationX: 0,
                    top: 0,
                    z: 0,
                    ...
                    top: 0,
                    z: -t[r].width,
                    left: 1 != o ? -t[r].width / 1.2 : t[r].width / 1.2,
                    force3D: "auto",
                    rotationY: 1 === o ? -50 : 50,
                    delay: 0,
                ...
                var P = 25 === n ? t[r].rotate : 1 === o ? 90 : -90,
                    j = 25 === n ? 1 === o ? -90 : 90 : t[r].rotate;
                ...
                t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_next_bg, d / 1e3, {
                    ...
                    rotationY: 0,
                    ease: u
                }), 0), C = 1 === o ? 25 === n ? "center bottom 0" : "right center 0" : 25 === n ? "center top 0" : "left center 0", P = 25 !== n ? -P : P, j = 25 !== n ? j : -j, t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_active_bg, d / 1e3, {
                    rotationX: 0,
                    rotationY: 0,
                    transformStyle: "flat",
                    transformPerspective: 1200,
            ...
            } else if (26 == n) d = 0, t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_next_bg, .001, {
                autoAlpha: 0
            }, {
                autoAlpha: 1,
                force3D: "auto",
                ease: u
            }), 0), t[r].mtl.add(punchgs.TweenLite.to(t[r].pr_active_bg, .001, {
                autoAlpha: 0,
                force3D: "auto",
                ease: u
            }), 0), t[r].mtl.add(punchgs.TweenLite.set(t[r].pr_next_bg.find("rs-sbg"), {
                ...
                var Q = t[r].pr_next_bg.find(".slot"),
                    H = 27 == n || 29 == n ? "-100%" : "+100%",
                    N = 27 == n || 29 == n ? "+100%" : "-100%",
                    D = 27 == n || 29 == n ? "-80%" : "80%",
                    B = 27 == n || 29 == n ? "+80%" : "-80%",
                ...
                V[G] = "0px", Y[G] = H, F[G] = W, E[G] = "0%", X[G] = N, Z[G] = H, q[G] = D, U[G] = B, Q.append('<span style="background-color:rgba(0,0,0,0.6);width:100%;height:100%;position:absolute;top:0px;left:0px;display:block;z-index:2"></span>'), t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_active_bg, d / 1e3, V, Y), 0), t[r].mtl.add(punchgs.TweenLite.fromTo(t[r].pr_next_bg.find("rs-sbg"), d / 2e3, F, E), d / 2e3), t[r].mtl.add(punchgs.TweenLite.fromTo(Q, d / 1e3, X, Z), 0), t[r].mtl.add(punchgs.TweenLite.fromTo(Q.find(".slotslide div"), d / 1e3, q, U), 0)
            }
        },
        a = function(e, i, r, a) {
            var o = e.find("rs-sbg"),
            ...
            null != o.data("currotate") && (l = o.data("currotate")), null != o.data("curscale") && "box" == a ? n = 100 * o.data("curscale") : null != o.data("curscale") && (n = o.data("curscale")),
                function(e, i) {
...
function(e) {
    ...
    jQuery.extend(!0, t, {
        preLoadAudio: function(e, i) {
            t[i].videos = void 0 === t[i].videos ? {} : t[i].videos, e.find(".rs-layer-audio").each(function() {
                var e = jQuery(this),
                    r = t[i].videos[e[0].id] = void 0 === t[i].videos[e[0].id] ? y(e.data(), "audio") : t[i].videos[e[0].id],
                    a = {};
                0 === e.find("audio").length && (a.src = null != r.mp4 ? r.mp4 : "", a.pre = r.pload || "", this.id = void 0 === this.id || "" === this.id ? e.attr("audio-layer-" + Math.round(199999 * Math.random())) : this.id, a.id = this.id, a.status = "prepared", a.start = jQuery.now(), a.waittime = void 0 !== r.ploadwait ? 1e3 * r.ploadwait : 5e3, "auto" != a.pre && "canplaythrough" != a.pre && "canplay" != a.pre && "progress" != a.pre || (void 0 === t[i].audioqueue && (t[i].audioqueue = []), t[i].audioqueue.push(a), t.manageVideoLayer(e, i)))
            })
        },
        preLoadAudioDone: function(e, i, r) {
            var a = t[i].videos[e[0].id];
            t[i].audioqueue && t[i].audioqueue.length > 0 && jQuery.each(t[i].audioqueue, function(e, t) {
                a.mp4 !== t.src || t.pre !== r && "auto" !== t.pre || (t.status = "loaded")
            })
        },
        resetVideo: function(e, r, a, o) {
            var s = t[r].videos[e[0].id];
            switch (s.type) {
                case "youtube":
                    s.rwd && null != s.player && void 0 !== s.player.seekTo && (s.player.seekTo(-1 == s.ssec ? 0 : s.ssec), s.player.pauseVideo()), 0 != e.find("rs-poster").length || s.bgvideo || "preset" === a || punchgs.TweenLite.to(e.find("iframe"), .3, {
                        opacity: 1,
                        display: "block",
                        ease: punchgs.Power3.easeInOut
                    });
                    break;
                case "vimeo":
                    void 0 !== s.vimeoplayer && !o && s.rwd && (0 !== s.ssec && -1 !== s.ssec || s.bgvideo || e.find("rs-poster").length > 0) && (s.vimeoplayer.setCurrentTime(-1 == s.ssec ? 0 : s.ssec), s.vimeoplayer.pause()), 0 != e.find("rs-poster").length || s.bgvideo || "preset" === a || punchgs.TweenLite.to(e.find("iframe"), .3, {
                        opacity: 1,
                        display: "block",
                        ease: punchgs.Power3.easeInOut
                    });
                ...
                case "html5":
                    ...
                    punchgs.TweenLite.to(s.jvideo, .3, {
                        ...
                        display: "block",
                        ease: punchgs.Power3.easeInOut
                    }), s.rwd && !e.hasClass("videoisplaying") && (s.video.currentTime = -1 == s.ssec ? 0 : s.ssec), ("mute" == s.volume || t.lastToggleState(e.videomutetoggledby) || !0 === t[r].globalmute) && (s.video.muted = !0)
            }
        },
        Mute: function(e, i, r) {
            var a = !1,
            ...
            switch (o.type) {
                case "youtube":
                    o.player && (!0 === r && o.player.mute(), !1 === r && l(o, parseInt(o.volcache, 0)), a = o.player.isMuted());
                    break;
                case "vimeo":
                    o.volcachecheck || (o.volcache = o.volcache > 1 ? o.volcache / 100 : o.volcache, o.volcachecheck = !0), o.volume = !0 === r ? "mute" : !1 === r ? o.volcache : o.volume, void 0 !== r && null != o.vimeoplayer && n(o, !0 === r ? 0 : o.volcache), a = "mute" == o.volume || 0 === o.volume;
                    break;
                case "html5":
                    o.volcachecheck || (o.volcache = o.volcache > 1 ? o.volcache / 100 : o.volcache, o.volcachecheck = !0), o.video.volume = o.volcache, void 0 !== r && o.video && (o.video.muted = r), a = void 0 !== o.video ? o.video.muted : a
            }
        ...
        stopVideo: function(e, i) {
            if (void 0 !== t[i] && void 0 !== t[i]) {
                ...
                if (void 0 !== r) switch (t[i].leaveViewPortBasedStop || (t[i].lastplayedvideos = []), t[i].leaveViewPortBasedStop = !1, r.type) {
                    case "youtube":
                        if (void 0 === r.player || 2 === r.player.getPlayerState() || 5 === r.player.getPlayerState()) return;
                        r.player.pauseVideo(), r.youtubepausecalled = !0, setTimeout(function() {
                            r.youtubepausecalled = !1
                        }, 80);
                        break;
                    case "vimeo":
                        if (void 0 === r.vimeoplayer) return;
                        r.vimeoplayer.pause(), r.vimeopausecalled = !0, setTimeout(function() {
                            r.vimeopausecalled = !1
                        }, 80);
                        break;
                    case "html5":
        ...
        playVideo: function(e, i) {
            ...
            switch (clearTimeout(r.videoplaywait), r.type) {
                case "youtube":
                    if (0 == e.find("iframe").length) e.append(r.videomarkup), h(e, i, !0);
                    else if (null != r.player.playVideo) {
                        var o = r.player.getCurrentTime();
                        r.nseTriggered && (o = -1, r.nseTriggered = !1), -1 != r.ssec && r.ssec > o && r.player.seekTo(r.ssec), !0 !== r.youtubepausecalled && p(r)
                    } else r.videoplaywait = setTimeout(function() {
                        !0 !== r.youtubepausecalled && t.playVideo(e, i)
                    }, 50);
                    break;
                case "vimeo":
                    0 == e.find("iframe").length ? (delete r.vimeoplayer, e.append(r.videomarkup), h(e, i, !0)) : e.hasClass("rs-apiready") ? (r.vimeoplayer = null == r.vimeoplayer ? new Vimeo.Player(e.find("iframe").attr("id")) : r.vimeoplayer, r.vimeoplayer.getPaused() ? setTimeout(function() {
                        var a = void 0 === r.currenttime ? 0 : r.currenttime;
                        r.nseTriggered && (a = -1, r.nseTriggered = !1), -1 != r.ssec && r.ssec > a && r.vimeoplayer.setCurrentTime(r.ssec), ("mute" == r.volume || 0 === r.volume || t.lastToggleState(e.data("videomutetoggledby")) || !0 === t[i].globalmute) && (r.volumetoken = !0, r.vimeoplayer.setVolume(0)), c(r.vimeoplayer)
                    }, 510) : r.videoplaywait = setTimeout(function() {
                        !0 !== r.vimeopausecalled && t.playVideo(e, i)
                    }, 50)) : r.videoplaywait = setTimeout(function() {
                        !0 !== r.vimeopausecalled && t.playVideo(e, i)
                    }, 100);
                    break;
                case "html5":
                    if (r.metaloaded) {
                        d(r.video);
                        o = r.video.currentTime;
                        r.nseTriggered && (o = -1, r.nseTriggered = !1), -1 != r.ssec && r.ssec > o && (r.video.currentTime = r.ssec)
                    } else a(r.video, "loadedmetadata", function(e) {
                        t.resetVideo(e, i), r.video.play();
                        var a = r.video.currentTime;
                        r.nseTriggered && (a = -1, r.nseTriggered = !1), -1 != r.ssec && r.ssec > a && (r.video.currentTime = r.ssec)
                    }(e))
            }
        },
        ...
        prepareCoveredVideo: function(e, i) {
            var r = t[e].videos[i[0].id];
            if (t.updateDimensions(e), void 0 === r.vimeoid || void 0 !== r.vimeoplayerloaded) {
                if (r.ifr = i.find("iframe, video"), r.vd = r.ratio.split(":").length > 1 ? r.ratio.split(":")[0] / r.ratio.split(":")[1] : 1, 0 === t[e].conw || 0 === t[e].conh) return t.setSize(e), clearTimeout(r.resizelistener), void(r.resizelistener = setTimeout(function() {
                    t.prepareCoveredVideo(e, i)
                }, 100));
                var a = t[e].conw / t[e].conh,
                    o = a / r.vd * 100,
                    s = r.vd / a * 100;
                "html5" === r.type && "Edge" !== t.get_browser() && "IE" !== t.get_browser() && (s = 100, o = 100), "Edge" === t.get_browser() ? a > r.vd ? punchgs.TweenLite.set(r.ifr, {
                    minWidth: "100%",
                    height: o + "%",
                    x: "-50%",
                    y: "-50%",
                    ...
                    left: "50%",
                    position: "absolute"
                }) : a > r.vd ? punchgs.TweenLite.set(r.ifr, {
                    height: o + "%",
                    width: "100%",
                    top: -(o - 100) / 2 + "%",
                    left: "0px",
                    ...
                    top: "0px",
                    position: "absolute"
                }), r.ifr.hasClass("resizelistener") || (r.ifr.addClass("resizelistener"), jQuery(window).resize(function() {
                    t.prepareCoveredVideo(e, i), clearTimeout(r.resizelistener), r.resizelistener = setTimeout(function() {
                        t.prepareCoveredVideo(e, i)
                    }, 90)
                }))
            }
        ...
        checkVideoApis: function(e, i) {
            ...
            if (!t[i].youtubeapineeded && ((null != e.data("ytid") || e.find("iframe").length > 0 && e.find("iframe").attr("src").toLowerCase().indexOf("youtube") > 0) && (t[i].youtubeapineeded = !0), t[i].youtubeapineeded && !window.rs_addedyt)) {
                ...
                }), o && a.parentNode.insertBefore(r, a)
            }
            if (!t[i].vimeoapineeded && ((null != e.data("vimeoid") || e.find("iframe").length > 0 && e.find("iframe").attr("src").toLowerCase().indexOf("vimeo") > 0) && (t[i].vimeoapineeded = !0), t[i].vimeoapineeded && !window.rs_addedvim)) {
                ...
                a = document.getElementsByTagName("script")[0], o = !0;
        ...
        manageVideoLayer: function(e, r) {
            if (!0 === t.gA(e[0], "videoLayerManaged") || "true" === t.gA(e[0], "videoLayerManaged")) return !1;
            t[r].videos = void 0 === t[r].videos ? {} : t[r].videos;
            var o = t[r].videos[e[0].id] = void 0 === t[r].videos[e[0].id] ? y(e.data()) : t[r].videos[e[0].id];
            if (o.audio = void 0 !== o.audio && o.audio, i && o.opom) 0 == e.find("rs-poster").length && e.append('<rs-poster class="noSwipe" style="background-image:url(' + o.poster + ');"></rs-poster>');
                ...
                switch (o.id = e[0].id, o.pload = "auto" === o.pload || "canplay" === o.pload || "canplaythrough" === o.pload || "progress" === o.pload ? "auto" : o.pload, o.type = null != o.mp4 || null != o.webm ? "html5" : null != o.ytid && String(o.ytid).length > 1 ? "youtube" : null != o.vimeoid && String(o.vimeoid).length > 1 ? "vimeo" : "none", o.newtype = "html5" == o.type && 0 == e.find(o.audio ? "audio" : "video").length ? "html5" : "youtube" == o.type && 0 == e.find("iframe").length ? "youtube" : "vimeo" == o.type && 0 == e.find("iframe").length ? "vimeo" : "none", !o.audio && "1sttime" == o.aplay && o.pausetimer && o.bgvideo && e.closest("rs-slide").addClass("rs-pause-timer-once"), o.audio || !o.bgvideo || !o.pausetimer || 1 != o.aplay && "true" != o.aplay && "no1sttime" != o.aplay || e.closest("rs-slide").addClass("rs-pause-timer-always"), o.noInt && e.addClass("rs-nointeraction"), o.newtype) {
                    case "html5":
                        ...
                        "video" === o.tag && null != o.webm && "firefox" == t.get_browser().toLowerCase() && (n = n + '<source src="' + o.webm + '" type="video/webm" />'), null != o.mp4 && (n = n + '<source src="' + o.mp4 + '" type="' + ("video" === o.tag ? "video/mp4" : "audio/mpeg") + '" />'), null != o.ogv && (n = n + '<source src="' + o.mp4 + '" type="' + o.tag + '/ogg" />'), n += "</" + o.tag + ">", o.videomarkup = n, i && o.notonmobile || t.isIE(8) || e.append(n), e.find(o.tag).parent().hasClass("html5vid") || e.find(o.tag).wrap('<div class="html5vid" style="position:relative;top:0px;left:0px;width:100%;height:100%; overflow:hidden;"></div>'), o.jvideo = e.find(o.tag), o.video = o.jvideo[0], o.html5vid = o.jvideo.parent(), o.metaloaded || a(o.video, "loadedmetadata", function(e) {
                            m(e, r), t.resetVideo(e, r)
                        }(e));
                        break;
                    case "youtube":
                ...
                if (!(null != o.poster && o.poster.length > 2) || i && o.npom) {
                    ...
                    0 != e.find("iframe").length || "youtube" != o.type && "vimeo" != o.type || (delete o.vimeoplayer, e.append(o.videomarkup), h(e, r, !1))
    ...
    var a = function(e, t, i) {
        ...
        o = function(e, t, i) {
            var r = {};
            return r.video = e, r.type = t, r.settings = i, r
        },
        s = function(e, i) {
            var r = t[e].videos[i[0].id];
            (r.bgvideo || r.fcover) && (r.fcover && i.removeClass("rs-fsv").addClass("coverscreenvideo"), (void 0 === r.ratio || r.ratio.split(":").length <= 1) && (r.ratio = "16:9"), t.prepareCoveredVideo(e, i))
        },
        n = function(e, t) {
            var i = e.vimeoplayer;
            i.getPaused().then(function(r) {
                e.volumetoken = !0;
                var a = !r,
                    o = i.setVolume(t);
                void 0 !== o && o.then(function(t) {
                    i.getPaused().then(function(t) {
                        a === t && (e.volume = "mute", e.volumetoken = !0, i.setVolume(0), i.play())
                    }).catch(function(e) {
                        console.log("Get Paused Function Failed for Vimeo Volume Changes Inside the Promise")
                    })
                }).catch(function(t) {
                    a && (e.volume = "mute", e.volumetoken = !0, i.setVolume(0), i.play())
                })
            }).catch(function() {
        ...
        u = function(e, i, r) {
            e.vimeostarted = !0, e.nextslidecalled = !1, punchgs.TweenLite.to(i.find("rs-poster"), .3, {
                ...
                display: "block",
                ease: punchgs.Power3.easeInOut
            }), t[r].c.trigger("revolution.slide.onvideoplay", o(e.vimeoplayer, "vimeo", e)), t[r].stopByVideo = e.pausetimer, b(i, r), "mute" == e.volume || 0 === e.volume || t.lastToggleState(i.data("videomutetoggledby")) || !0 === t[r].globalmute ? (e.volumetoken = !0, e.vimeoplayer.setVolume(0)) : n(e, parseInt(e.volcache, 0) / 100 || .75), t.toggleState(e.videotoggledby)
        },
        h = function(e, r, a) {
            var n = t[r].videos[e[0].id],
                d = "iframe" + Math.round(1e5 * Math.random() + 1);
            if (n.ifr = e.find("iframe"), s(r, e), n.ifr.attr("id", d), n.startvideonow = a, n.videolistenerexist) {
                if (a) switch (n.type) {
                    case "youtube":
                        ...
                        events: {
                            onStateChange: function(i) {
                                i.data == YT.PlayerState.PLAYING ? (punchgs.TweenLite.to(e.find("rs-poster"), .3, {
                                    ...
                                    opacity: 0,
                                    ease: punchgs.Power3.easeInOut
                                })), -1 != i.data && 3 != i.data && (t[r].stopByVideo = !1, t[r].tonpause = !1, w(e, r), t[r].c.trigger("starttimer"), t[r].c.trigger("revolution.slide.onvideostop", o(n.player, "youtube", n)), null != t[r].videoIsPlaying && t[r].videoIsPlaying.attr("id") != e.attr("id") || t.unToggleState(n.videotoggledby)), 0 == i.data && n.nse ? (g(), n.nseTriggered = !0, t[r].c.revnext(), w(e, r)) : (w(e, r), t[r].stopByVideo = !1, 3 !== i.data && (-1 != n.lasteventdata && 3 != n.lasteventdata && void 0 !== n.lasteventdata || -1 != i.data && 3 != i.data) && t[r].c.trigger("starttimer"), t[r].c.trigger("revolution.slide.onvideostop", o(n.player, "youtube", n)), null != t[r].videoIsPlaying && t[r].videoIsPlaying.attr("id") != e.attr("id") || t.unToggleState(n.videotoggledby))), n.lasteventdata = i.data
                            },
                            onReady: function(r) {
                                var a, o = t.is_mobile(),
                                    s = e.hasClass("rs-layer-video");
                                !o && (!t.isSafari11() || o && s) || "RS-BGVIDEO" !== e[0].tagName && (!s || !0 !== n.aplay && "true" !== n.aplay) || (a = !0, n.player.setVolume(0), n.volume = "mute", n.player.mute(), clearTimeout(e.data("mobilevideotimr")), e.data("mobilevideotimr", setTimeout(function() {
                                    p(n)
                                }, 500))), a || "mute" != n.volume || (n.player.setVolume(0), n.player.mute()), e.addClass("rs-apiready"), null == n.speed && 1 === n.speed || r.target.setPlaybackRate(parseFloat(n.speed)), e.find("rs-poster").unbind("click"), e.find("rs-poster").click(function() {
                                    i || p(n)
                ...
                case "vimeo":
                    ...
                    n.vimeoplayer.on("play", function(t) {
                        n.vimeostarted || u(n, e, r)
                    }), n.vimeoplayer.on("loaded", function(t) {
                        var i = {};
                        n.vimeoplayer.getVideoWidth().then(function(t) {
                            i.width = t, void 0 !== i.width && void 0 !== i.height && (n.ratio = i.width + ":" + i.height, n.vimeoplayerloaded = !0, s(r, e))
                        }), n.vimeoplayer.getVideoHeight().then(function(t) {
                            i.height = t, void 0 !== i.width && void 0 !== i.height && (n.ratio = i.width + ":" + i.height, n.vimeoplayerloaded = !0, s(r, e))
                        ...
                        n.vimeostarted || u(n, e, r), n.pausetimer && "playing" == t[r].sliderstatus && (t[r].stopByVideo = !0, t[r].c.trigger("stoptimer")), n.currenttime = i.seconds, 0 != n.esec && -1 !== n.esec && n.esec < i.seconds && !0 !== n.nextslidecalled && (n.loop ? (c(n.vimeoplayer), n.vimeoplayer.setCurrentTime(-1 !== n.ssec ? n.ssec : 0)) : (n.nse && (n.nseTriggered = !0, n.nextslidecalled = !0, t[r].c.revnext()), n.vimeoplayer.pause()))
                    }), n.vimeoplayer.on("ended", function(i) {
                        n.vimeostarted = !1, w(e, r), t[r].stopByVideo = !1, t[r].c.trigger("starttimer"), t[r].c.trigger("revolution.slide.onvideostop", o(n.vimeoplayer, "vimeo", n)), n.nse && (n.nseTriggered = !0, t[r].c.revnext()), null != t[r].videoIsPlaying && t[r].videoIsPlaying.attr("id") != e.attr("id") || t.unToggleState(n.videotoggledby)
                        ...
                        n.vimeostarted = !1, (n.scop && e.find("rs-poster").length > 0 || n.bgvideo && e.find(".rs-fullvideo-cover").length > 0) && (n.bgvideo ? punchgs.TweenLite.to(e.find(".rs-fullvideo-cover"), .1, {
                            ...
                            opacity: 0,
                            ease: punchgs.Power3.easeInOut
                        })), t[r].stopByVideo = !1, t[r].tonpause = !1, w(e, r), t[r].c.trigger("starttimer"), t[r].c.trigger("revolution.slide.onvideostop", o(n.vimeoplayer, "vimeo", n)), null != t[r].videoIsPlaying && t[r].videoIsPlaying.attr("id") != e.attr("id") || t.unToggleState(n.videotoggledby)
        ...
        m = function(e, r, s) {
            ...
            n.metaloaded = !0, n.control && !n.audio || (0 != e.find(".tp-video-play-button").length || i || e.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><span class="tp-revstop">&nbsp;</span></div>'), e.find("video, rs-poster, .tp-video-play-button").click(function() {
            ...
            })), (n.fcover || e.hasClass("rs-fsv") || n.bgvideo) && (n.fcover || n.bgvideo ? (n.html5vid.addClass("fullcoveredvideo"), void 0 !== n.ratio && 1 != n.ratio.split(":").length || (n.ratio = "16:9"), t.prepareCoveredVideo(r, e)) : n.html5vid.addClass("rs-fsv")), a(n.video, "canplaythrough", function() {
                t.preLoadAudioDone(e, r, "canplaythrough")
            }), a(n.video, "canplay", function() {
                t.preLoadAudioDone(e, r, "canplay")
            }), a(n.video, "progress", function() {
                t.preLoadAudioDone(e, r, "progress")
            }), a(n.video, "timeupdate", function(e) {
                0 != n.esec && -1 != n.esec && n.esec < n.video.currentTime && !n.nextslidecalled && (n.loop ? (n.video.play(), n.video.currentTime = -1 === n.ssec ? 0 : n.ssec) : (n.nse && (n.nseTriggered = !0, n.nextslidecalled = !0, t[r].jcnah = !0, t[r].c.revnext(), setTimeout(function() {
                    t[r].jcnah = !1
                }, 1e3)), n.video.pause()))
                ...
                !f() && e.find("rs-poster").length > 0 && n.scop && (punchgs.TweenLite.to(e.find("rs-poster"), .3, {
                    ...
                    opacity: 0,
                    ease: punchgs.Power3.easeInOut
                })), e.removeClass("videoisplaying"), t[r].stopByVideo = !1, w(e, r), "audio" != n.tag && t[r].c.trigger("starttimer"), t[r].c.trigger("revolution.slide.onvideostop", o(n.video, "html5", n)), null != t[r].videoIsPlaying && t[r].videoIsPlaying.attr("id") != e.attr("id") || t.unToggleState(n.videotoggledby)
            }), a(n.video, "ended", function() {
                g(), w(e, r), t[r].stopByVideo = !1, w(e, r), "audio" != n.tag && t[r].c.trigger("starttimer"), t[r].c.trigger("revolution.slide.onvideostop", o(n.video, "html5", e.data())), n.nse && n.video.currentTime > 0 && (1 == !t[r].jcnah && (n.nseTriggered = !0, t[r].c.revnext(), t[r].jcnah = !0), setTimeout(function() {
                    t[r].jcnah = !1
                ...
                if (i.hasOwnProperty(o)) {
                    ...
                    switch (s[0]) {
                        ...
                        case "nomo":
                            ...
                            break;
                        case "sta":
                            a.start = s[1] + (void 0 !== s[2] ? ":" + s[2] : "");
                            break;
                        case "end":
                            a.end = s[1] + (void 0 !== s[2] ? ":" + s[2] : "");
                            break;
                        case "do":
                            a.doverlay = s[1];
                            break;
        ...
        b = function(e, i) {
            if (t[i].playingvideos = void 0 === t[i].playingvideos ? new Array : t[i].playingvideos, t[i].videos[e[0].id].stopAV && void 0 !== t[i].playingvideos && t[i].playingvideos.length > 0)
                for (var r in t[i].lastplayedvideos = jQuery.extend(!0, [], t[i].playingvideos), t[i].playingvideos) t[i].playingvideos.hasOwnProperty(r) && t.stopVideo(t[i].playingvideos[r], i);
